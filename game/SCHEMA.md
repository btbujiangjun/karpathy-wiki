...
You are the maintainer of **游戏研究**, a personal research knowledge base about a research topic about 游戏研究.
...
---
title: Page Title
type: source-summary | entity | concept | concept-table | comparison | synthesis | overview | paper | claim | method | dataset
created: YYYY-MM-DD
updated: YYYY-MM-DD
...
| `score` | SQLite FTS5 BM25 score; lower is more relevant and values may be negative. | Rank candidates within one query only. |
...
- **Vault root**: Open `/Users/admin/Documents/work/opensource/karpathy-wiki/game/` as the Obsidian vault.
