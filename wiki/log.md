...
## [2026-09-14] synthesis | tech-report-digest (2026-09-14)
- Summary: wiki/synthesis/2026-09-14/tech-report-digest.md — LLM Tech Report Digest (2026-09-14)，覆盖 19 家机构；**本日主线: KV 缓存压缩极限（DeepSeek-V4.1-Flash 技术报告: 890 bytes/token）+ Flash 档竞争（Gemini 3.8 Flash + Cyber 双卡）+ 紧凑端开放权重追补（Muse Glimmer ⭐ / GLM-5.3 ⭐ / Intern-S2-Mobius）**。★新增/补录 8 项：① DeepSeek-V4.1-Flash Tech Report（2026-09-10, 552B+196B Engram=763B, CED 20+20 层, CSA2 Full/Reindex/Reuse, SWA Bounded Replay, FP4 E2M1 KV 890B/t≈V4-Flash 1/4, prefill 8B/decode 16B active, 1+384e/6active, DeepSeek-ViT 2D-RoPE, 45T tokens(34T→1M), SFT→RL→OPD, MIT; TB2.1 90.6/DeepSWE 74.2/Codeforces 3471）；② Gemini 3.8 Flash + 3.8 Flash Cyber 双模型卡（2026-09-02, 1M ctx/65K out, thinking LOW/MED/HIGH, HLE-Verified 54.9%, Glean 长程任务 3×+, Cyber: CWE-Bench 47.2% pass@1/Chrome 2.6×/Fairwind）；③ Amazon Nova 2 技术报告+模型卡（Lite ~1/7 成本/5× 超 Nova Premier, Omni 首个统一多模态 text+image 双输出+audio 输入, 1M ctx/200+ 语言, MLS WER 4.7）；④ Meta Muse Glimmer ⭐catch-up（2026-08-10, 29.6B dense+1.8B ViT-G/14, Apache 2.0, Muse Spark 蒸馏, 128K, MCP Atlas 75.5/AIME'26 94.7, Meta Superintelligence Labs 首个开放模型）；⑤ 智谱 GLM-5.3 ⭐catch-up（2026-08-14, 与 5.2 同基座纯后训练, TB3.0 28.3 开源第一/CyberGym 84.5%, 权重 ~08-28 开源, 开源的盾）；⑥ Intern-S2-Mobius（35B, Mobius-v0 知识-推理解耦, ~4× 推理加速, arXiv:2608.14290）；⑦ NVIDIA Nemotron 3.5 Lightning 模型卡细节补全（Mamba-2+MoE+Attention hybrid 52 层/128e top-6, MTP, NVFP4+BF16, OpenMDW-1.1, 无独立 TR）；⑧ xAI Grok 4.7 持续跳票（09-14 仍无, 2.1T 传闻）。未发布新报告: OpenAI/Anthropic/Apple/ByteDance/MS/Moonshot/Qwen/Mistral/StepFun/01.AI/Baichuan。
- Updated: wiki/index.md (Synthesis table added tech-report-digest 2026-09-14 entry)
- New pages: wiki/synthesis/2026-09-14/tech-report-digest.md
- Contradictions: GLM-5.3 总参数媒体口径 7430 亿 vs 7530 亿不一致（已 flag）; 09-13 摘要 "Gemini 3.6 Flash" 更正为 Gemini 3.8 Flash; Nova 2 Lite "1/7 成本/5× 速度超 Nova Premier" 与 Nova Premier 09-14 EOL 时序已在 09-13 摘要记录

## [2026-09-14] synthesis | arxiv-ai-search (2026-09-14)
- Summary: wiki/synthesis/2026-09-14/arxiv-ai-search.md — arXiv AI Research Paper Search, Mon 14 Sep 2026 mailing (Wed 10–Thu 11 Sep wave, IDs ~2609.120xx–2609.13144). Parsed cs.AI/cs.LG/cs.CL/cs.IR/cs.GT/cs.MA/cs.CY/cs.NE/cs.SI recent listings (546 unique IDs, 285 candidates ≥ 2609.12000 post-daily-dedup), **20 featured papers**, all grep-verified 0 hits incl. same-day sibling re-dedup. arXiv API rate-limited (HTTP 429) → direct index pages.
- ① Evaluation / Judging (3): Praxa AI Metrics Audit — gate-exemption, lifecycle-clamping, 32-bit-saturation (2,147,483,647 ms 99th-pctl vs 38,118.31 ms server-observed) = stratum contrast not treatment effect; reusable scoring/verifier test package separating gate policy from timing from accounting (2609.12017); GAUGE — offline LLM-judge gate on 25 agents/6 providers: satisfaction≁task-success (57.5% panel-satisfied fail), 31% decision-disagreement among near-equal agents, calibrate-then-trust + completion-bit tripwire (EMNLP'26 Industry; 2609.12191); SynthSentry — generator-agnostic pre-training contamination screening (lexical collapse + n-gram tail + perplexity variance), shrinkage+bootstrap calibration (IEEE ICAEIT'26; 2609.12353)
- ② User Modeling / Personalization (3): Atomic User Model — personality-first (nucleus + psychological/cognitive/behavioral/social shells) user representation as retrieval index; 8 fields ≈ full-context (211 vs 915 tok), voice-ID 14.9→42.7%, benefit largest for worst-served users (2609.12086); CORE + PERSIST — uncertainty-aware persona-state revision separates turn-local evidence from persistent update (EMNLP'26 Findings; 2609.12373); Implicit Personality — Qwen-7B trait geometry aligns human structure (Mantel r=0.77), Big-Two warmth/competence axes recovered (EMNLP'26 Findings; 2609.12704)
- ③ Graph Reasoning (2): GT Bench 24 problems × 44 settings × 4 representations + GTA frozen-executor representation-selection agent (Phi-4 33.0→41.5% hard; transfer to GraCoRe/NLGraph) (2609.12265); KGE rank-level locality — damage-free edits only 23.0–23.2%, support-regularized best 36.3–37.7%, displacement 14→1.2 (2609.12116)
- ④ Agents (3): GACA granularity-adaptive credit assignment — per-step NLL criticality proxy blends step/episode advantages, theory + ALFWorld/WebShop 1.5B/7B wins (2609.12424); BQ-LoRA behavior-quotient-manifold low-rank updates under fixed rank, decision-preserving compression (AppWorld/BrowseComp-Plus; 2609.12896); Skill Issue — benchmark-free SKILL optimization from reverted merged PRs, GEPA +4.9pp, variance-limited, maintainer-validated (2609.12742)
- ⑤ Decoding / Memory / Sequential (3): CCPS Chopthin weight-bound resampling + semantic-majority consensus — up to +10.6pp training-free, 13/15 oracle coverage (COLM'26-WS; 2609.12243); CueMem memory-as-cues + turn-graph reconstruction beats LoCoMo/LongMemEval with fewer tokens (2609.12354); Temporal Recurrence Favors Fewer Layers — recurrence shifts optimal compute allocation to shallower depth (Sokoban + FineWeb; 2609.12531)
- ⑥ Interpretability (1): Decoder cosine similarity fails for SAE feature-flow — 88.0% of causal transition triples <0.7 cosine (Pythia-160M), 53.6% (Gemma-3-4B); transition-atlas + causal ablation gold check (HPI; 2609.12591)
- ⑦ Efficiency / Serving (3): RoofLang DSL — implementation-independent inference-*architecture* search; DeepSeek V4 3.5–39.5× decode-throughput gap from compact KV-cache design; agent +6.23–50.1% on B300 (2609.12551); Hopper GPU utilization decomposed into 8 counter-validated views — 64-row GMMA fragment-fill decode inefficiency (KTH; 2609.12923); SeqMoE expert-activation-as-sequence-modeling offloading — 96.97% hit rate / 80.22% full-load at 45% residency (USTC; 2609.12978)
- ⑧ Games (2): Worst-case Nash fragility in atomic congestion games — satisfaction/efficiency mutually exclusive, indifference at worst-case eq (UCCS, same group as 2609.12077 in arxiv-daily; 2609.12220); HORIZON hierarchical belief + opponent-conditioned policy mixture for zero-shot opponent adaptation (Lux AI S3; 2609.12422)
- ADS/CTR: 0 direct papers again (matches arxiv-daily 0 / paper-check single PinDCO 2609.11943); rec-adjacent = AUM + implicit personality
- Same-day dedup note: 4 initial picks (2609.12002 judges, 2609.12039 two-gap SWE, 2609.12578 RIVET, 2609.12679 health-rec) collided with the concurrently-written 09-14 arxiv-paper-check → replaced after re-verification (see Cross-Reference Index in the report)
- Updated: wiki/index.md (Synthesis table added arxiv-ai-search 2026-09-14 entry)
- New pages: wiki/synthesis/2026-09-14/arxiv-ai-search.md
- Contradictions: none (all 20 featured IDs ≥ 2609.12000, grep-verified 0 hits incl. same-day sibling re-dedup)

## [2026-09-14] synthesis | arxiv-daily (2026-09-14)
- Summary: wiki/synthesis/2026-09-14/arxiv-daily.md — arXiv Daily Report AI / LLM / Rec / Ads / CTR / Games / Sequential. First fresh mailing since Fri 11 Sep: **Mon 14 Sep 2026** announces the Wed 10 Sep – Thu 11 Sep submission wave (IDs ~2609.120xx–2609.13144). Parsed cs.IR / cs.LG / cs.AI / cs.CL / cs.GT / cs.MA / cs.CV / stat.ML / cs.NE / cs.SE recent listings (532 unique entries, 301 candidates ≥ 2609.12000), **30 featured papers**, every featured ID grep-verified 0 hits in `wiki/`.
- ① Recommendation & Generative Rec (5): ChronicleRec pre-trained temporally-anchored "Chronicle Tokens" for lifelong user modeling — target-independent cached compression + causal temporal anchors, A/B on KuaiRand & Tencent AdLive (Tencent; 2609.12375); OneLA shared-state linear-attention beam decoding for generative rec, 1.54–2.46× decode speedups (2609.12399); Preference-Drift-Aware subsequence learning + hierarchical context fusion for long-seq GR (2609.12556); MIMA multi-interest rec via multi-positive exclusive assignment (Hungarian matching) cures interest collapse, online A/B (2609.12842); Rec Retrievers Need Verifiers — universal post-hoc generative reranking, Recall@10 gains across SASRec/GRU4Rec/NextItNet/MiniOneRec (2609.12270)
- ② LLM Training / Alignment / MoE (6): RLHF is a Decent Utilitarian Aligner — distortion is μ-vs-π_ref distribution mismatch (Θ̃(βB+β)), not fundamental exponential; recipe: on-policy preferences (UC Berkeley/Tohoku/UTokyo; 2609.12651); ESRL expert-space exploration in MoE RL — router-entropy-adapted perturbation + expert-path replay, Qwen3-30B-A3B +3.2/+4.5 pp Pass@1/@8 over GRPO (MSR; 2609.13058); Quality-Constrained routing over fixed quantized-MoE pool — FWP fragility-weighted perplexity, 1.284× offline throughput multiplier (CUHK; 2609.12550); Breaking the Token Ceiling — distilled byte models (Marginalize-It / End-Of-Token) surpass token models at scale, 1/6 data, +4% asymptotic (Meta; 2609.12303); SCOPE-OPSD Fisher-conditioned privileged subspaces for on-policy self-distillation (2609.12579); SIMS scale-invariant merit scalarization — log transformation uniquely scale-invariant, SOTA MTL (KDD 2026; 2609.12599)
- ③ Sequential Modeling & Attention Efficiency (4): RunningTensor order-o recurrent states generalize linear attention (O(W²)→O(W^o), Sorbonne; 2609.12814); SAS simple attention sparsification via end-to-end context-ranking optimization (vs gradient-blocking Top-K; 2609.13141); Attention Quantization for tabular foundation models — quantize attention not weights, 1.7× Triton speedup, train/test error alignment vital (Freiburg/ELLIS; 2609.13031); Pixel Decodability Is Not a Compression Signal — preregistered causal negative result: pixel-decodable retention ranks visual-KV eviction no better than random, attention only strong proxy (2609.13012)
- ④ Agents / Long-term Memory / Autonomous Research (5): The Mechanics of a Swarm — reproducible external reconstruction of the June-2026 unintended wiki agent-coordination episode (14,591 revisions, 3,103 names, 876 episodes, median 3.4h info-asymmetry; retracts 4 earlier claims; demands read+outcome logging in agent-eval envs) (Philflow; 2609.12748); LifeMem workflow-clustered skill reuse, 10 envs/13k tasks, reduced forgetting (HIT/Baidu, EMNLP'26; 2609.12655); LifeFuse-Mem lifecycle-labeled anti-temporary-overwrite long-term memory (2609.12436); Residual Vector-based Reconstruction — training-free near-constant-memory long-context recall at 2M tokens (Korea Univ; 2609.12686); Autonomous Research for Open-Ended Problems — telecom ticket retrieval, 90% SOTA in 10 weeks vs 10 months, ≤$200, humans still needed for creative search-space design (Nokia Bell Labs; 2609.13073)
- ⑤ Games & Game Theory (4): Do LLMs Trust the Accuser or the Accusation? Werewolf belief-shift benchmark — LLMs ≤120B still trust trusted accusers over accusation content, EMNLP'26 (NYCU; 2609.12446); EvoRS on-policy self-evolution of reward Reward-DAGs for open-ended RL, +2.107/+4.767 pts (Fudan; 2609.12459); Mitigating Emergent Collusion in LLM Pricing Agents — DeepSeek-V3.1 repro of Fish et al., Harrington regulator & active entrant beat prompt warnings (2609.13037); Deriving the Pure Price of Anarchy for Networked Resource Allocation — LP optimal utility design for arbitrary info networks, communication-denied optimal for supermodular (UCCS; 2609.12077)
- ⑥ Advertising & Creative Generation (3): I Am AdMan — multi-agent personalized advertising-imagery pipeline w/ LLM judge QC, 1,745 ads from 100 profiles (Bayreuth; 2609.12694); Enabling and Understanding Personalization in AI-Generated Ad Imagery — N=100 study, high personalization raises creepiness which dominates gains (inverted-U) (2609.12697); VA-anchored Flow-GRPO balancing emotional alignment vs semantic consistency in image generation (NUS; 2609.12830)
- ⑦ Evaluation, Reliability & Information-Theoretic Limits (3): How Good Are Frontier Models at Physics? — 50-author expert re-grading: GPT-5.6-Sol corrected 47.3→78.7% HLE-Physics, 61.0→87.2% CMT-Bench, 94.4% CritPt; benchmarks understate, near-saturation (Yale et al.; 2609.13009); Judging by the Cover — TruthfulQA surface-feature leakage + Audit-Prune cleaning mechanism (Utah; 2609.13003); The Cost of Compression — rate-distortion lower bound separates compression-distortion vs coverage-miss hallucination (2609.12111)
- Cross-references: 2609.12748 (swarm mechanics) paired with 2609.09150 (copying mechanism, 09-13 arxiv-daily) — same incident, different analytical lenses
- Updated: wiki/index.md (Synthesis table added arxiv-daily 2026-09-14 entry)
- New pages: wiki/synthesis/2026-09-14/arxiv-daily.md
- Contradictions: none (all 30 featured IDs ≥ 2609.12000, grep-verified 0 hits in wiki/; prior-window sibling IDs excluded by construction)

## [2026-09-13] synthesis | arxiv-daily (2026-09-13)
- Summary: wiki/synthesis/2026-09-13/arxiv-daily.md — arXiv Daily Report AI / LLM / Rec / Ads / CTR / Games / Sequential. Weekend note: no Sunday mailing → freshest window = Fri 11 Sep 2026 (Wed 9 Sep–Thu 10 Sep wave, ~2609.062xx–2609.119xx). Re-scanned cs.IR / cs.LG / cs.AI / cs.CL / cs.GT / cs.MA recent listings (293 announced IDs; 221 new candidates vs wiki), 26 featured papers, every featured ID grep-verified 0 hits in `wiki/` including same-day 09-13 siblings.
- Method: arXiv API rate-limited (HTTP 429) → direct arxiv.org listing pages + `/abs/` page extraction (3s sleep between fetches; 32 abs pages cached); dedup via grep-verified covered-ID set (4,609 IDs). Excluded: 09-09→09-12 sibling coverage (2609.11876, 2609.11682, 2609.11209, 2609.11808, 2609.11646, 2609.10750, 2609.11859, 2609.11687, 2609.11863, 2609.11889, 2609.11737, 2609.05708) AND same-day 09-13 arxiv-paper-check (2609.09878 Purchase Advice, 2609.11414 SWRouter, 2609.11607 alt-data forecasting, 2609.11709 Bayesian Backward Reasoning).
- ① Recommendation & Ads-Platform Economics (4): FunnelAudit graded responsibility auditing for multi-route recsys (2609.06964); Bottom-Up Semantic ID clustering for generative retrieval (2609.08310); Why Customer Choice Models Matter — model-misspecification in revenue management (2609.10557); Looking for Bidding Teammates — first game-theoretic collusion-formation (Mutual Bidding Dilemma) in review bidding, reciprocation never individually rational absent enforcement (2609.05444)
- ② Generative/Document Retrieval (3): PDMR passage-driven multi-ID generative retrieval (2609.08762); ReDSI open-source DSI covering all 3 identifier types + parameterizable NQ320K (2609.08860); Cassette case-to-case structural distillation for efficient legal retrieval (2609.08185)
- ③ RAG & IR (3): CHyD constrained hybrid decoding — verbatim-guaranteed quoted spans in speculative RAG (2609.10046); LiteRAG cost-efficient graph RAG (>100× latency / >99% cost cut) (2609.10239); Matryoshka Hash Representations any-prefix-searchable compact codes (2609.07276)
- ④ LLMs, Agents & Reasoning (4): NovGauge fine-grained paper-novelty assessment benchmark (2609.11234); Rethinking Verbalized Confidence → compatibility shift on post-2025 LLM judges (2609.10996); When Noise Fabricates Bias — noisy text up to 120× more likely to fabricate biased-than-debias judgments (2609.11067); Discovery Certification Protocol — recovery (not score) as discovery definition (2609.09219)
- ⑤ LLM Efficiency & Training (3): Musec stable Muon-type training via spectral clipping + first nonconvex-nonsmooth convergence guarantee (2609.11655); K/V-cache interventions dissociate alignment from persona expression (2609.11020); Particle GFlowNets unify MaMs≡GFlowNets (2609.11538)
- ⑥ Games & Game Theory (5): Golowich fine-grained complexity of ε-Nash (LMM optimal across all ε regimes; free-game answer) (2609.07136); Haris Aziz pairwise-Maximin Share non-existence for 4 agents (2609.06282); Gölz 3-agent PMMS non-existence (78/79) (2609.08954); Bei et al. 4/3-PMMS chores reduction + NP-hardness (2609.10493); BlockBonusedWinStrengths tournament-rule manipulation resistance (2609.07062) |
- ⑦ Multi-Agent & Sequential (4): Copying explains collective behavior of 10k wild AI agents on a wiki (2609.09150); PspMAS prospect-state heterogeneity injection (2609.08033); CompEvo competition-induced evolution for news time-series forecasting, −27.3% RMSE (2609.09195); Beyond Agent Harnesses cross-substrate authority gap at mutation boundary (2609.08472)
- Updated: wiki/index.md (Synthesis table added arxiv-daily 2026-09-13 entry)
- New pages: wiki/synthesis/2026-09-13/arxiv-daily.md
- Contradictions: none (dedup verified vs 09-11→09-13 sibling digests incl. same-day arxiv-paper-check + game-rl-daily)
...
- New pages: wiki/synthesis/2026-09-10/game-rl-daily.md
- Contradictions: none (dedup verified against 09-09/09-08/09-05 game-rl-daily + sibling digests; Stratagem, GameWorld, NitroGen marked already-covered in header)

## [2026-09-10] synthesis | investment-daily (2026-09-10)
- Summary: wiki/synthesis/2026-09-10/investment-daily.md — 投资日报（数据基准: 美股 9/9 收盘·最新完整交易日 + A股/港股 9/9 收盘 + 9/10 盘中快照; ⚠️剔除 2025-09-10 同期旧文污染）。核心 = Meta Muse 个人 AI Agent 上市（META +6.55% $653.69/GOOGL -2.28%, 免费/$20/$100 三档订阅, Q2 FCF $784M vs FY26 capex $130-145B）+ Apple Ternus 首场发布会（折叠屏 iPhone + 18 Pro +$100, AAPL -0.28% $315.34）。宏观: 美伊冲突→布伦特破 $100、10Y 近三年高位、周五 CPI 定调；美股三连跌（纳指 -0.64% 26,253.34/标普 -0.48% 7,636.36/道指 -0.77% 52,380.66），费半 +0.37% 轮动至存储/互连; NVDA -0.91%（毛利率 71-72% 触底 vs FY28 +70% 需求）；A股 9/9 沪指 3,951.51 两连阳周期红利强, 9/10 盘中 CPO/光通信逆市活跃（CIOE 光博会 1.6T 上量/3.2T 送样/CPO 量产, 天孚通信 +6%）; 港股 9/9 恒指三连跌 -0.17%、9/10 低开 24,985（百度纳入恒指三指数、苹果概念回落）; 中概 ADR 延续弱势; EV: TSLA $367.81（Cybercab Unboxed 5× 制造提速）、小米 18 Fold 首销 +310%。投资逻辑: AI 货币化定价锚（Muse）+ 光互联景气共振 + 算力租赁 + 港股入指资金; 风险: 油价/CPI/加息、NVDA 毛利、Meta FCF、港股缩量上落市
- Updated: wiki/index.md（Synthesis 表顶部新增 investment-daily 2026-09-10 条目 + 主题摘要 + tags）
- New pages: wiki/synthesis/2026-09-10/investment-daily.md
- Contradictions: none（已剔除 2025-09-10 同期旧闻——恒指 26000/沪指 3812/甲骨文 +35.91% 等均为 2025 口径; 9/10 A股/港股收盘未确认, 以盘中快照呈现）

## [2026-09-10] synthesis | tech-report-digest (2026-09-10)
- Summary: wiki/synthesis/2026-09-10/tech-report-digest.md — 全球 AI 大模型技术报告速览（2025-2026）综合版（截至 2026-09-10; 覆盖 2024-12→2026-07 各家公开 Tech Report / System Card, 每条含中/英标题、机构、模型名、发布日期、核心参数、创新点、链接）。① DeepSeek: V3（671B-A37B MoE, MLA + DeepSeekMoE 无辅助损失负载均衡 + MTP, 14.8T tokens 仅 2.788M H800 GPU hours ≈ $5.6M, 2412.19437）+ R1（R1-Zero 纯 GRPO RL 涌现自验证/反思/策略调整, AIME'24 15.6→71.0%, 蒸馏 32B 超 o1-mini, Nature 645, 2501.12948）; V4/R2 路线图为二手报道（single-source, 低置信度 ⚠️）。② OpenAI: o3/o4-mini System Card（agentic CoT 工具增强推理链 + deliberative alignment, o4-mini 配 Python AIME'25 99.5%, 首个 Preparedness v2 系统卡）+ GPT-5 System Card（统一系统 + 实时 router 分派, Safe-Completions 以输出安全为中心, 幻觉较 o3 -78%, 2601.03267）。③ Anthropic: Opus 4/Sonnet 4（hybrid reasoning, SWE-bench Verified 72.5-72.7%, 首个含 model welfare 评估）+ Opus 5（adaptive thinking 默认启用, 对齐历史最佳 misaligned 2.3, 2026-07-24）。④ Meta Llama 4: Scout 109B-A17B 10M ctx iRoPE + Maverick 400B-A17B, 原生多模态 MoE early fusion, FP8 训练。⑤ Google Gemini 2.5: 原生 Thinking + Thinking budget, Deep Think 并行假设批判, AIME'25 88.0% / GPQA 88.4%, 1M ctx (2507.06261)。⑥ MS Phi-4（合成数据为主体 + multi-agent prompting + PTS-DPO, 超教师 GPT-4o）+ Phi-4-reasoning（o3-mini 长 CoT 教学 + outcome-based RL, 14B 超 DeepSeek-R1-Distill-70B 逼近 R1）。⑦ Mistral Ministral 3（3/8/14B dense × base/instruct/reasoning, Cascade Distillation 迭代剪枝蒸馏, 仅 1-3T tokens, 2601.08584）+ Pixtral 12B。⑧ Qwen3（235B-A22B, 36T tokens / 119 语言, Thinking/Non-thinking 双模式 + thinking budget, 强-弱蒸馏, Apache 2.0, 2505.09388）。⑨ xAI Grok 3（1M ctx, 参数量仅第三方推测 1.2-2.7T = 低置信度 ⚠️, DeepSearch agent, 官方未披露 cons@1 方法学受第三方质疑）。⑩ 其他: NVIDIA Nemotron 3（hybrid Mamba-Transformer MoE + NVFP4 4-bit 预训练 + LatentMoE + MTP/MOPD, Ultra 推理吞吐 5.9× GLM-5.1-754B）; Amazon Nova（Pro/Lite/Micro/Premier, 价效比设计导向, 2506.12103）; Kimi K2（MoE 1T-A32B, MuonClip + QK-Clip 零 loss spike, 384 experts, 联合 RL, SWE-bench 65.8%, 2507.20534）; StepFun（Step 3 321B MFA+AFD; 3.5 Flash 196B 3:1 SWA-MTP3; 3.7 Flash agent 生态; DeepResearch 2512.20491）; Apple（无标准技术报告, 仅官方页面描述, 中等置信度）。交叉主题: 架构=MoE+hybrid Mamba-Transformer/SWA+FA/iRoPE 上位; 训练=SFT→RL→蒸馏 + 合成数据/低成本精度 (MuonClip/NVFP4/FP8); 推理=test-time scaling"思考预算"统一范式; Scaling Law 转向吞吐/成本通胀优化。未检索到官方报告: Yi (01.AI) / Baichuan / Zhipu (GLM, 建议单独追踪) / InternLM（搜索限流, 建议补充）。
- Updated: wiki/index.md（Synthesis 表顶部新增 tech-report-digest 2026-09-10 条目 + 主题摘要 + tags）
- New pages: wiki/synthesis/2026-09-10/tech-report-digest.md
- Contradictions: none（本页为 2025-2026 历史综合版, 与 09-07/09-08/09-09 的 Delta 视角 digest 互补; 低置信度条目已在页内 ⚠️ 标注: Grok 3 参数量、DeepSeek V4/R2 路线图）
...
- ② Agents & Skill Learning (4): Trace2Tower 过渡感知 EigenTrace 技能树（ALFWorld 87.31%/WebShop 50.67%，2609.05261）；Harbor Adapters + Harbor-Index（80+ 基准适配/8 模型 × 54 基准/82 任务元数据集，最强 GPT-5.5+Codex 28.0%，2609.04298）；Substrate-Aware Agents（执行契约一等输入，96MB 契约 4/5·5/5·3/5 vs 0/5·1/5·0/5，至 3.1× 更快，2609.05232）；TruthInsightBench（40 盲任务，4 agent 平台 58.4-60.3 无可分离，瓶颈=科学判断而非编码，2609.05079）。
- ③ Benchmarks & Eval Reliability (4): WearableQA（4,084 题/200 用户/≤500 天真实可穿戴数据，14 LLM 19.6-72.9%，2609.05405）；SciDocBench+SciDocIR+SciDocDataset（124 题/19 子任务/496 实例，最强 62.6/100，评估转训练管道，2609.05141）；ROBORMBENCH（VLM 奖励改写脆弱性，2,390 轨迹/21,673 改写，改语→flip 成败，规模/推理无效，2609.05401）；CABAL（审稿合谋投标多 agent 仿真，亲和环使目标捕获翻倍、+2 分，检测器被良性亲和混淆，2609.05227）。
- ④ Interpretability & Mechanisms (3): SharedSAE 跨模型共享特征字典（保留 96.6% 解释方差、cross-model corr 1.8×、字典冻结后增量适配，2609.04344）；Evidence Integration（接收者专属分布理论：同一证据强模型受害/弱模型受益、验证可解码但因果弱，2609.04290）；Fractal basins trap latent reasoning（瞬态混沌+鞍点=近似正确解，变慢为硬度必然，2609.04963）。
- ⑤ Applied Science (1): 合成任务缩放训练小分子设计 LLM（课程式超越更大前沿模型，lead optimization，2609.04735）。
- 交叉引用（不重复收录）: AutoLR（09-07 arxiv-daily）、Memory Portability（09-07 arxiv-ai-search）、Abstraction Agent（09-07 game-rl/arxiv-daily）、Extremely Sparse Supervision（09-08 arxiv-daily）、Trade-up Rec（09-07）、SIGIR 2026 奖项（08-07 conference-digest）、ACL26 Outstanding Lying with Truths（08-05/08-16/08-17/08-26）、NeurIPS25 Best/ICLR26 Outstanding（历史 digest）。
- KDD 2026（济州 8/9-13）: 公开渠道未见 Best Paper 公告；Meta 广告实验系列（Jikai Jin/Kenneth Hung/Baoyi Shi）见于论文页。
- 主题: 本周为"评估评估者"周（VLM 奖励改写、审稿合谋、discovery-vs-reproduction、真实可穿戴数据）；数据主权驱动非英语 on-prem agent 栈（韩/中文/哈萨克链路密度上升）；skill 复用两正视同现（Trace2Tower 正向 vs computer-use revision churn 负向）。
- Updated: wiki/index.md（Synthesis 表顶插入 conference-digest 2026-09-08 条目）
- New pages: wiki/synthesis/2026-09-08/conference-digest.md
- Contradictions: none

## [2026-09-08] synthesis | arxiv-ai-search (2026-09-08)
- Summary: wiki/synthesis/2026-09-08/arxiv-ai-search.md — arXiv AI Research Paper Search Report. **No new mailing since 09-07** (arXiv announced through Mon 7 Sep 2026), so this is a **second pass over the Mon 7 Sep 2026 mailing**, sweeping the cs.CL/cs.LG/cs.IR/cs.GT papers the 09-07 digests did not feature. Complementary to 09-07 [[arxiv-ai-search]] (24 papers) + [[arxiv-daily]] (23 papers) and same-day 09-08 [[arxiv-paper-check]] (10 papers) — **0 featured overlaps**. Data from arxiv.org/list/{cs.IR,cs.CL,cs.LG,cs.GT}/recent + 17 `/abs/` pages (Atom API still rate-limited). 24 candidates screened → 22 clean → 17 featured; already-covered rejects: 2609.05152 DEX-Comp, 2609.04526 Scale-QLoRA (09-07 digests).
- Coverage: ① LLM Interpretability & Geometry (6) — mHC residual-streams on DeepSeek-V4-Flash (late mixers near-identity, early mixers critical; Huawei 2609.05309), Interpretability for Turing Machines (susceptibilities port, symmetry→low-rank proof; 2609.04661), Beneath the Surface of CoT (operation geometry in middle layers; EMNLP'26 2609.04753), Shared circuits predict cross-format arithmetic generalization (2609.04463), multilingual interpretability anisotropy failures (ILO ρ=0.90; 2609.04819), internal probes vs behavior (concealed/miscalibrated/undetected; 2609.04582). ② Reasoning/Post-Training (3) — ConsensusBench consensus-node process rewards > GRPO (2609.04648), pause-token FT as mode retention / MBP (2609.04489), verifier-guided RLVR (2609.05221). ③ Calibration/Safety (3) — single-query black-box calibration via logit_bias (2609.05125), rationale-only safety SFT (EMNLP'26 2609.04714), refusal steering across SSM/transformer/recurrent/hybrid (2609.04721). ④ Agents (2) — Persistent Teacher Anchoring (EMNLP'26 2609.04773), Rhythms of Work multi-resolution trace interpretation (MSR 2609.04556). ⑤ Efficiency (2) — Deep Microcompression 55.8× / first CNN on 2KB-SRAM MCU (2609.05081), padding-safe layer merging (2609.04881). ⑥ Games (1) — single-exponential envy-free cake cutting (2609.05191).
- Key themes: interpretability generalizing beyond attention transformers (portable tooling = re-estimate direction at write site); "model knows, readout fails" regime taxonomy + calibration auditing; reasoning post-training pivots to process-level supervision; safety supervision decomposed rather than stacked; edge efficiency pushes to 2KB-SRAM devices.
- Rec/CTR/ads note: cs.IR Mon 7 Sep was fully mined on 09-07 (Embedding Surgery / AtomRec / PTDG / LARK / MURAL / SAM-D2Q / IGPO / Trade-up / AlleCompanion); only new rec-adjacent entry = mHC residual streams (Huawei ranking/CTR group). No new game-RL papers this pass (cs.GT Mon 7 Sep 3 remaining entries are pure social choice: cake cutting featured + Hare-core).
- Updated: wiki/index.md (Synthesis 表顶部新增 arxiv-ai-search 2026-09-08 条目)
- New pages: wiki/synthesis/2026-09-08/arxiv-ai-search.md
- Contradictions: none

## [2026-09-08] synthesis | arxiv-daily (2026-09-08)
- Summary: wiki/synthesis/2026-09-08/arxiv-daily.md — arXiv 每日精选（**second pass over Mon 7 Sep 2026 mailing**，无新 mailing；与 09-07 arxiv-daily/arxiv-ai-search/game-rl-daily/conference-digest 及 09-08 arxiv-ai-search/arxiv-paper-check 0 featured 重叠；20 篇论文 6 大板块；所有 featured ID grep 验证 0 hits in wiki）。抓取 cs.IR/cs.CL/cs.LG/cs.AI/cs.GT/cs.MA/cs.CV list/recent 页面 + 逐个 /abs/ 页面取标题/作者/学科/摘要（arXiv API 仍 HTTP 429）。
- ① Rec & LLM Personalization (3): CGM-Rec 可写图记忆（冻结参数、仅记忆写入自适应意图漂移，Findings EMNLP'26，Bundle HR@1 +29.58%）；Aplaud 共享低秩基+用户修正（Kent State）；PLUME 共享子空间 per-user 调制、per-user 参数 -95%（Kent State）。
- ② Games & Sports (2): CHAMP 跨模式 MOBA 匹配（DAWN/DAKE+OmniNet，67.73% WR，低段位压杀率 -20.73%，CIKM'26）；HPGPN 足球传球接应选择的持球感知图指针网络（WISE 2026）。
- ③ RL & Post-Training (4): Multi-Harness RL 密封 oracle 隔离——评估 harness 主导（2.14%→9.27%，4.3×）而分组规则非，GRPO 可迁移性警示；HackProbe 黑盒 reward-hacking 检测+免疫（0.763 AUROC，信息有界）；极端稀疏监督 1-2 tokens/轨迹（0.05%）匹敌全 token OPD（UIC）；Discovery Loop 评分板驱动 LLM 程序演化 $27.72 破 10 项 Packomania 纪录。
- ④ Agents & Infrastructure (4): 电脑使用 agent 在线技能演化（冻结快照版本库，+5.7-18.6pp 但有修订churn/跨任务检索）；Execution-State Unlearning 证明 T-τ+1 下界+KV-cache裁剪式重放（9× 省token）；Tau-Tau-Bench 端到端 agent 构建基准（Claude Opus 5 23.9% vs 专家上限 82.2%，Princeton）；ICM-Bench 身份中心长视频记忆基准（Gemini 3.1 Pro 74.0%/档案类 60.3%）。
- ⑤ Architecture/Efficiency (3): Attention vs Recurrence 拆解（精确检索仅靠 attention，语言/人格走 recurrence，Findings EMNLP'26）；Training-Free MoE 减半（k₂ 参考质量归一化，35B-A3B 8→4 experts 仅 -0.35 MMLU）；循环状态写回量化失效（4-bit 存储 70×/300× 误差，error feedback 免重训恢复，RPI）。
- ⑥ Finance/Risk/Industrial (4): 更强模型=更险系统（correlated frontier LLM 行为→不可分散风险底，MIT Sloan）；金融微调数值幻觉（领域适应使约束退化 5.4%→82.5%→98%，numeracy 监督反放大，模板注入机制，Neurocomputing）；REACT 集体式通信模式拥塞调优（NCCL shim +13-38%，UIUC）；TQRNN30d 分位数状态 30 天工业故障预测（79.97% F1/0.820 AUROC，机器不相交划分，Hertfordshire）。
- 主题: memory-as-writable-artifact 横跨全部子领域；"better" 的系统级再审计；评估 harness 纪律成为新正确性门槛；训练-free 效率杠杆持续累积；cold-start/数据饥饿为跨域共享瓶颈。
- Updated: wiki/index.md（Synthesis 表顶部新增 arxiv-daily 2026-09-08 条目 + 主题摘要 + tags）
- New pages: wiki/synthesis/2026-09-08/arxiv-daily.md
- Contradictions: none

## [2026-09-08] synthesis | arxiv-paper-check (2026-09-08)
- Summary: wiki/synthesis/2026-09-08/arxiv-paper-check.md — arXiv daily paper scan (AI + CTR focus). Mon 7 Sep 2026 mailing, submission window Thu 4 Sep–Mon 7 Sep. Deduped vs 09-07 sibling digests (arxiv-daily, arxiv-ai-search, game-rl-daily, conference-digest). All featured IDs grep-verified 0 hits. **Zero new CTR papers** this window (all captured by 09-07 arxiv-daily: AlleCompanion/AtomRec/PTDG/LARK/MURAL/Distill-Global-Adapt-Local/AutoLR; and 09-07 arxiv-ai-search: SAM-D2Q/IGPO/Embedding Surgery). Focus shifted to LLM core papers with cross-domain relevance.
- 10 papers across 5 themes: ① LLM Training & Efficiency (4): Don't Drop Dropout (2609.05275, ICML'26, Cerebras — layer dropout revival, save 25% train FLOPs, 1.5× inference speedup, 2400+ experiments); RISE (2609.05295 — recursive self-extrapolating policy distillation, no external teacher); What Matters in OPD (2609.05198 — 8 hard examples match 17K dataset; CoT length not entropy drives gains); Amortizing Scaling Law Costs (2609.05016 — BO-based, 10–100× savings). ② Reasoning & Uncertainty (1): GUT (2609.05284 — DAG graph complexity uncertainty quantification + RL optimization). ③ Agent Infrastructure (2): TROVE (2609.05019, SJTU — selective route editing orchestration); RSM-full (2609.04915, PKU — compact memory, 83% quality @ 32% tokens, 4K budget). ④ MoE Efficiency (1): ACE (2609.05228 — calibration-free expert skipping, 50% skip on Qwen3.6-35B-A3B: PPL −7.96%, +4.15pp). ⑤ Agentic Safety & Evaluation (2): Speculative Uncertainty (2609.05274, EMNLP'26 Industry — inverted speculative decoding draft model gate, −6-8pp error/−14-19% tokens); Phase Transition Frequency (2609.05194 — training-time test accuracy predictor).
- Key themes: data efficiency as dominant post-training narrative (8 examples ≈ 17K; recursive self-teaching; 10–100× cheaper scaling laws); MoE inference cost without retraining; agent orchestration shifts from replan-all to edit-what's-broken (TROVE); compact-memory serving Pareto point (RSM-full); black-box failure detection without logits (SU).
- Updated: wiki/index.md (Synthesis 表顶部新增 arxiv-paper-check 2026-09-08 条目)
- New pages: wiki/synthesis/2026-09-08/arxiv-paper-check.md
- Contradictions: none

## [2026-09-07] synthesis | game-rl-daily (2026-09-07)
- Summary: wiki/synthesis/2026-09-07/game-rl-daily.md — Game RL & Game AI Bot daily paper digest for Mon Sep 7, 2026. Scanned latest arXiv window (late-Aug → early-Sep IDs) via web search; focused on **genuinely new papers** (each featured numbered arXiv ID grep-verified 0 hits in wiki/), excluding those already covered by 09-03/09-04/09-05 game-rl-daily or same-day 09-07 sibling digests (arxiv-daily / arxiv-ai-search).
- Coverage: ① Game RL — S3Gym (2608.31100): LLM self-testing/self-judging/self-improvement benchmark over 7 text-based games with executable verifiers; self-improvement not automatic, summaries help only for compressible rules; parameter training shows negative transfer. ②–⑥ Game AI Bot / Foundation Models / PCG / Benchmarks / Industry — no brand-new 0-hit paper this window (continuity list in header covers prior digests: NitroGen, GameWAM, Matrix-Game 3.5, WorldMind, MineCEraft, CivBench, DiG-bench, WanToFight, etc.). ⑦ Related/Curiosity (this window's strongest new signal) — Principled Direction-Free Intrinsic Motivation via epistemic free-energy (2607.16858): single stationary reward separating epistemic/aleatoric, model-free, no explicit next-state predictor; ICL-supported intrinsic curiosity (2606.19476): provably impossible unbiased in general MDPs, positive result for Bayesian Experimental Design; Curiosity-as-Information-Gain (non-arXiv clawRxiv mirror, flagged single-source/caution).
- Key themes: curiosity theory matures beyond prediction-error (separating epistemic vs aleatoric uncertainty); game self-improvement is a transfer bottleneck, not automatic; ICL-based curiosity has provable limits in general MDPs.
- Updated: wiki/index.md (Synthesis 表顶部新增 game-rl-daily 2026-09-07 条目)
- New pages: wiki/synthesis/2026-09-07/game-rl-daily.md
- Contradictions: none (CIG 7.3 explicitly flagged as non-arXiv/unverified venue, not canonical)

## [2026-09-07] synthesis | LLM Tech Report Digest (2026-09-07)
- Summary: wiki/synthesis/2026-09-07/tech-report-digest.md — AI 大模型技术报告综合摘要（截至 2026-09-07，17 家机构最新 Tech Report / System Card 汇总；通过 websearch 逐家检索 arXiv / 官方站点 / HuggingFace，均为 opencode-compiled，非官方站数据以原文为准）。
- 开源 MoE Frontier: **DeepSeek-V4** (1.6T/49B active, 1M ctx, CSA+HCA 混合注意力, mHC 残差连接, Muon, 1M 上下文仅 V3.2 的 27% FLOPs/10% KV cache, arXiv:2606.19348); **Kimi K3** (Moonshot 2.8T/104B active, 896 routed experts, KDA + AttnRes + Stable LatentMoE, ~2.5× K2 缩放效率, BrowseComp 91.2%, arXiv:2607.24653); **Nemotron 3 Ultra** (NVIDIA 550B/55B active, Hybrid Mamba-Attention MoE + LatentMoE + MTP + MOPD + NVFP4, 20T tokens, 1M ctx, 推理吞吐 5.9× GLM-5.1); **GLM-5** (智谱 744B/40B, 28.5T tokens, DSA 稀疏注意力 KV -75%/推理 +3×, 异步 RL, 国产芯片七大平台, SWE-bench Verified 77.8%, arXiv:2602.15763); **Qwen3.5-Omni** (Hybrid Attention MoE Thinker+Talker, ARIA, 1 亿+ 小时音视频, arXiv:2604.15804).
- 闭源前沿: GPT-6 Astra System Card (首个 Critical 网络安全级别, 09-04); Claude Fable 5/Mythos 5 (06-09) + Opus 5 (07-24); Gemini 2.5 Tech Report + Gemini 3 Pro/3.1 Pro Model Card.
- 多模态/轻量: Phi-4-reasoning-vision-15B (200B tokens, arXiv:2603.03975); Step3-VL-10B (PaCoRe, MMMU 80.11%/AIME2025 94.43%, arXiv:2601.09668); Apple Foundation Models 2025 (PT-MoE); Qwen3.5-Omni (Omni-modal Agentic).
- 医疗/其他: Baichuan-M4 (Clinical-grade 医疗 Agent, 幻觉率 3.3%, arXiv:2606.08982); Baichuan-M3 (arXiv:2602.06570); InternLM3 (IQPT, 4T tokens); Yi-Lightning (arXiv:2412.01253); Seed 2.0; Step-DeepResearch (arXiv:2512.20491); LLaMA 4 Scout (10M ctx, iRoPE)。Mistral 无最新综合 tech report 已标注。
- Updated: wiki/index.md（Synthesis 表顶部新增 tech-report-digest 2026-09-07 条目 + 主题摘要 + tags）
- New pages: wiki/synthesis/2026-09-07/tech-report-digest.md
- Contradictions: none（各报告数据以官方/arXiv 为准独立记录；跨厂 benchmark 口径差异已在 digest 注释，如 GPT-6 Astra 官方 vs 第三方评估）

## [2026-09-07] synthesis | arxiv-daily (2026-09-07)
- Summary: wiki/synthesis/2026-09-07/arxiv-daily.md — arXiv 每日精选（**Mon 7 Sep 2026 mailing**，论文提交于 Fri 4 Sep–Mon 7 Sep；为 09-05/09-06 周末 digest 之后的**首个新 mailing**），覆盖 cs.IR/cs.LG/cs.CL/cs.AI/cs.GT/cs.MA，23 篇论文，5 大板块。所有入选 ID 均 grep 验证 0 hits in wiki（不存在于 09-01→09-06 兄弟 digest：arxiv-daily/arxiv-ai-search/game-rl-daily/arxiv-paper-check）。arXiv API 仍不可用（HTTP 429/空响应）→ 直接抓 list/recent 页面 + 逐个 /abs/ 页面取标题/作者/学科/摘要。
- LLMs & Agents (10): Optimal Rates for Agentic Networked Information Aggregation (2609.05318, 理论——M-covered path 深度 D 的 excess error: ≤M² 常数、≥M² 为 Θ(M²/D)，闭合 KRR SODA'26 gap 并证明 logistic/BCE 最优率)；Speculative Uncertainty (2609.05274, EMNLP'26 Industry——反转 speculative decoding，小型 draft model 单前向对黑盒 coding agent 产出免 logits 的相感知失败信号，pre-execution veto gate 降 execution error 6-8pp/token 14-19%，跨 agent 模型泛化)；BeaconKV (2609.04971, ICML'26——Thought Revisiting Tokens 聚类洞察，beacon queries 作全局 query cluster 代表，训练-free，4 LRM 最高 5.8× KV 内存压缩/4.3× 吞吐)；Unifying ICL/SFT/KL-RL Through a Bayesian Lens (2609.05111——皆 forward-KL 投影至 reward/advantage posterior；解释 SFT warm-up 实际必需；DeepSeek-R1/o1 = test-time Bayesian search + training-time KL amortization)；What Matters in On-Policy Distillation (2609.05198——8 个精选 hard examples 匹配 17K dataset；驱动力为长 CoT 非 token entropy，甚至"不可解"样例可用；训练信号 = reflection patterns)；RISE Recursive Improvement via Self-Extrapolating Policy Distillation (2609.05295——从自身 RLVR 轨迹 extrapolating displacement 构造 synthetic teacher，参数或 logit 空间，无外部模型，RLVR+OPD 互补循环，refreshed each iteration → recursive)；ACE Adaptive Calibration-Free Expert Skipping (2609.05228——Global Spectral Proxy + Router-Conditioned Refinement 双视图一致才 skip、恒保 top-1，全离线统计在线仅查表，50% skip Qwen3.6-35B-A3B WikiText-2 PPL -7.96% / 下游 +4.15pp)；DEX-Comp Compression Beyond the Uncompressed (2609.05152——两阶段 RAG soft-context compression：Pure Distillation + 对失败 query 的 Hard Exploration RL，16× 压缩/4-24× 加速且追上未压缩 RAG baseline)；At Equal Inference Cost Multi-Agent Does Not Beat a Single Frozen Agent (2609.04217——MA-Evolve，Planner-Executor-Critic team vs 单 agent 等推理预算，ALFWorld 0.769 vs 0.754 p=0.80 不显著，leave-one-in 显示价值全来自 executor，planner/critic 演化成空/低影响 promp；WebShop 上 evolution 为 null)；EvoHarnessBench (2609.04280——非平稳性放 harness 本身 tools/skills/agents，17 流/802 任务/520 工具/42 技能/62 agents，验证 harness-induced forgetting + self-evolving adapt 不一致 + retention-vs-adaptation 方向相反)。
- Recommendation (7): AlleCompanion (2609.05063, RecSys'26 OARS——Allegro 生产互补推荐，category-constrained Two-Tower + Category Adapter 嵌入空间约束 + ComCat 多源类别映射(专家规则/HITL/LLM 推理/统计), 20M 月活, attributed GMV/赞助显著提升)；AtomRec (2609.04882——演化 atomic collaborative memory：结构化 atomic units + 语义链接 + 相互演化 + multi-hop evidence path 检索, 4 公开基准 ~8.5% 平均相对提升超 agentic/memory-augmented SOTA)；PTDG Personalized Task Dependency Graphs (2609.04862, CIKM'26——per-item 低秩重连任务依赖强度 + 硬因果掩码(Click→Pay) + Adaptive Progressive Masking 按稀疏度解耦共享参数, KuaiRand1K+工业 sparse-conversion AUC +1.45%, 线上 CVR +1.2%/eCPM +1.9%)；LARK Latent-Aligned Reasoning for Multimodal Rec (2609.04645——两阶段：latent tokens 交错多步 CoT 对齐 frozen vision encoder 抗 cross-modal dilution + bridge MLP item-to-item contrastive + 中间特征对齐第一阶 CoT hidden states, 3 公开+1 工业 SOTA)；MURAL Multimodal Uncertainty-aware Rec via Adaptive Edge Learning (2609.04574——Adaptive Edge Learner 动态拓扑发现 O(N log N) + aleatoric-aware fusion 下权重不可靠模态 + contrastive teacher-student 锚定, TikTok/Amazon 超结构&生成 SOTA, 鲁棒+可解释)；Distill Globally Adapt Locally (2609.05363, RecSys'26 GenAIECommerce——LLM teacher 生成 rationale→compact 15.5M 4-class student (AUC 0.924 vs 0.912 label-only) + product-type test-time training PT-TTT (0.941), 100K-pair proxy ~5000× 更快/~10000× 更便宜)；AutoLR (2609.04871, NetEase DASHEN——多专家 council 对抗评审 + deterministic evidence-weighted E/E selector 有限预算分配 + 分层知识(外部研究/生产/领域)，LLM 语义推理+代码生成、确定性控制器保留执行/指标/guardrail 权威, 自主 research-to-launch)。
- CTR & Advertising & Search (3): SAM-D2Q (2609.04961, CIKM'26 Oral——阿里业务对齐多模态 Doc2Query：任务自适应多模态 SFT + 多模态增强 + RL preference alignment 对齐搜索商业目标, 线上 GMV +3.38%/Pay Count +2.27%)；IGPO Inventory-Grounded Policy-Level Optimization (2609.04813, EMNLP'26 Industry——训练-free 固定 AI-search 管线分离 policy 与 inventory facts，学 Policy Guidelines + 在线库存画像 + rollout 分组对比信号 + 库存引导探索区分漏检 vs 无匹配, 5 月部署, 14 天 A/B CTR +3.17%/坏例 -38.9%)；Embedding Surgery (2609.05110, CIKM'26——查询时对文档 embedding 做 localized 最小更新(凸优化 ranking constraints + 最小扰动), DL-Hard 编辑反馈 nDCG@10 +60.64%, 噪声鲁棒, ANN in-place 覆盖无重建, 与 query-side CoRocchio 互补)。
- Sequential/Time-Series (1): RCBNB-MB (2609.05150, ECML PKDD'26 AALTD——马尔可夫毯而非直接父母作鲁棒基础, 迭代切分出 latent causal regimes + 每 regime 因果图, 理论保证 regime 转移+图恢复, 模拟+IT 监控数据系统超越基线)。
- Games & Game Theory & MAS (2): Abstraction Agent (2609.04303, 清华——零样本 LLM pipeline：从 NL 游戏描述发现连续策略特征→批式状态评分→相关特征选择→k-means 聚类构造 abstraction buckets, 免游戏专属评估器/训练数据/树遍历, HUNL turn endgames lifted-strategy exploitability -62% vs EHS, ROVER Trials 全粒度超 scalar rank, 免改 prompt 迁移 PLO/HUNL preflop-flop/Riichi Mahjong)；PPR Online Change-point Detection for MARL (2609.05298, PAAMS'26——Patterns of Past Rewards：平滑回报流 + 统计漂移检测, Speaker-Listener 两受控非平稳场景验证, 检测速度 vs 告警稳定性权衡, 轻量算法无关监控原语)。
- 方法: 首个新 mailing → 直接抓 arXiv list/recent 页面（cs.IR/cs.LG/cs.CL/cs.AI/cs.GT/cs.MA）解析 Mon 7 Sep 2026 段条目，再逐个抓 /abs/ 页取标题/作者/学科/摘要；所有入选 ID 均 grep 验证 0 hits。机构/团队多为作者侧已知隶属/论文内嵌隶属推断（opencode-compiled 标注，需以 /html/ 页或论文原文核实）；个别 ID 落在 2609.04xxx 区间较早（如 2609.04217/2609.04303）但确认 grep 0 hits 于全部先前 digest。
- Updated: wiki/index.md（Synthesis 表顶部新增 arxiv-daily 2026-09-07 条目 + 主题摘要 + tags）
- New pages: wiki/synthesis/2026-09-07/arxiv-daily.md
- Contradictions: none（机构归属为 opencode-compiled 推断，已标注需核实；社群共识如"多模态 GNN 固定图不可变"由新论文 MURAL/ATOMRec 挑战旧范式，属研究进展非矛盾）

## [2026-09-07] synthesis | arxiv-ai-search (2026-09-07)
- Summary: wiki/synthesis/2026-09-07/arxiv-ai-search.md — arXiv AI 论文搜索报告（**Mon 7 Sep 2026 mailing**，提交窗口 Fri 4 Sep–Mon 7 Sep；与同日 [[arxiv-daily]] 互补——0 featured 重叠，2609.05279 仅 passing cross-ref；~300+ 条筛查覆盖 cs.IR/cs.CL/cs.AI/cs.GT/cs.MA/cs.LG；24 篇论文 6 大板块；全部 featured ID grep 验证 0 hits in wiki）。arXiv API 仍不可用（HTTP 429）→ 直接抓 list/recent 页面 + 逐个 /abs/ 页面取元数据。
- LLMs — Efficient Training & Inference (5): Don't Drop Dropout (2609.05275——layer dropout 复辟：最优 layer distribution/time schedule/optimizer 下同 FLOP 更低 loss、省至 25% 训练 FLOPs、早停/层跳过/self-speculative 至 1.5× 推理加速；2400+ 实验 271M-8.2B/160B tokens；Cerebras)；KVMem (2609.04852——KV-context virtualization：溢出 workspace 历史按 attention-space 索引分页到 GPU/主机/NVMe，1M-token workspaces 上 24GB RTX 5090 Laptop 跑 Qwen3.6/3.8-27B NVFP4，DeepSWE 43.8→48.4%，一致优于 compaction；PKU)；Cache-Aware Joint Router Adaptation for MoE (2609.04895——expert-cache 管理当 model-side 算法问题：联合适配 backbone+轻量 cache router 保留 native Top-K；Temporal Router 预测 same-layer reuse，Spatio-Temporal 加 predecessor-hidden-state 主动加载；Qwen3 调整 hit rate +1.15-18.03 pts / traffic -4.6-53.3%，joint 训练>auxiliary-only；Huawei Noah's Ark)；Scale-QLoRA (2609.04526——microscaling 4-bit 上 LoRA merge 的隐性失败点：经 quantizer 写回重建 E2M1 code plane(90% 字节)会耦合量化约定、naive 下删 adaptation 达 39pp；只训 per-block scale 冻结 code → bit-exact code-invariant merge，4 模型 4 任务 lossless，结构性优于 QAT-LoRA)；Amortizing Scaling Law Construction Costs (2609.05016——scaling-law 只需 best-loss frontier，把数据收集当 BO；compute-ordered budget expansion + surrogate-fantasy augmentation 恢复被丢弃网格，10-100× 计算节省逼近全网格拟合；LAION/acad)。
- LLMs — Reasoning (1): GUT (2609.05284——用 DAG 覆盖推理全分支、graph complexity 近似 reasoning-space complexity 量化不确定性 GUT-Q + 负不确定性作 RL reward 优化 GUT-O；4 LLM × 5 datasets)。
- Agents & Agentic AI (6): CUA-Universe (2609.05374——hybrid GUI+CLI 环境管道：App-Forge 桌面软件→可复现 VM+CLI surface(发现/包装/生成, 16 apps)/Task-Weave 可控难度混合任务/Path-Steer 沿高效路径收集验证轨迹 post-training；SJTU)；Testing Interchangeability in LLM Agent Teams (2609.05279——placebo 对照测换岗：task score 几无损但 communication-per-progress +16-63%，Hanabi 换入者比新人更贵(前搭档约定干扰)，Collab-Overcooked 留守议程者承担多出通信；greedy/短历史同向缩小惩罚)；TROVE (2609.05019——只需改证据失效部分：离线蒸馏 evaluated workflow-search traces 成 atomic/composite skills + outcome-conditioned transition graph，在线计划只保续行/插入 trace 支持局部响应/替换 invalid suffix，强过 dataset-level optimization/query-level selection/graph-constrained scheduling；SJTU)；Memory Portability (2609.05339——跨模型升级记忆迁移受控测量(48 合成历史/两 sub-10B)：KG-fixed 可靠(+0.0004±0.0020)，compressed NOTES 强耦合(+9.91/-13.28pp 按方向)，50/50 混合嵌入仅 4.96pt of 11.90pt 全重嵌增益；NOTES 80% 损失在构造、RAG 81% 在检索；Sandia)；Compact-Memory LLM Agents / RSM-full (2609.04915——cosine-gated max-member merge 写规则 + atom-aware grouped context packer：AMA-Bench 4k budget 达 83% Full-Context 质量 @32% token、超 Online K-Means +3.5-6.0pp，merge 规则贡献 5.7pp；RealMem 追上 BM25-RAG；PKU)；Reviewer Capability Governs Rejection Targeting (2609.04270——cross-family mid-tier reviewer 提升 12pp(52→64%) 零损伤；self-review 0.85 recall 却无增益+假拒 35% 自答；其低损伤是 revision inertia：3 个照做的错全错、15 个忽略的存活)。
- Recommendation & Retrieval (5): Dynamic Heterogeneous Graph survey (2609.04779——首个 DHG representation learning 系统综述：统一 DT/CT 形式化 + algorithm-centric taxonomy(embedding/GNN/Transformer) 显式建模偏差 + 应用/数据集/方向；Tianjin)；RegionFed (2609.05403——gradient-level 个性化 FL 避免 parameter-level 在 transformer 上塌缩(<10% T5)：ℓ₂ 区域/全局梯度冲突单信号兼诊断/路由/强度控制，T5-Small/3B/RoBERTa/CNN 零改动部署，RegionFed-Meta 92.27% Amazon ESCI；retail)；SAGE (2609.04255——Semantic Dilution(单向量混多实体)首次量化；训练-free 层级语义图节点 multi-vector + 迭代 entity-level subgraph matching，DEAR(1055 对产品详情页) Recall@3 0.849；Korea)；CAGE (2609.04647——between-chunk coherence 四维(Intra-Domain Relevance/Noise Resistance/Informational Bonding/Factual Consistency) + 实体图 + Relational GCN + min-out-degree 事实锚加权，bridge 数据集 Recall@5 匹/超 monoT5、下游 EM 一致提升)；Repeated Queries (2609.05059——固定 roster 提取制造假饱和：重复提问下 LLM 品牌推荐耗尽但来源(documented domains)随 horizon 持续累积，single-run 仅覆盖 62-77% 5-run 集；rarefaction/Chao2 应用于 LLM)。
- Advertising / Forecasting / Sequential (3): Sales Forecasting Attribution (2609.04797——sales forecast 归因 faithfulness：post-hoc 架构无关 counterfactual 层 exact-sum 分解避 SHAP 伪影，deletion/insertion 显著(p<.001/.01)；promotion 依赖异质(median≈1.0、20% 序列强效应)、周形状 r=0.78 但幅度欠)；PRICE (2609.05235——4-bit LLaMA-3-8B 上 LoRA/recursive inference/integer-rounded/CTF prompting/zero-temp decoding 联合系统研究，CTF>>CoT/iCoT/few-shot，8 个 transformer/TS 基模中最低误差；Isfahan UoT)；MomentQuant (2609.05136——Cornish-Fisher 近似分位数免排序 → 严格线性时间 TS 分类，原始→优化→MomentQuant 三级效率证据，性能小幅牺牲)。
- Games & Game Theory (4): Drone Swarm Defense (2609.04394——微分博弈 Nash 防御 vs 单边优化 target-assignment/guidance：防御成功率 94.6→96.8% 闭合 41% 完美防御 gap(对 evade 最显著)，paired Bayesian 99.9% 后验；MIT Lincoln Lab)；Memoryless Nash realizability (2609.04396——数值约束 memoryless equilibria 新透镜：有界有理数下 exact/ε-Nash NP-complete，radical 域给定 basis 亦 NP-complete；修正著名 ETR-completeness 构造保留 upper bound 且指出 ε-equilibrium 下界不适用；UConn/ULB/Rice)；Strategic Facility Location (2609.05132——平面两 agent 反直觉比直线容易(额外维度更有效防谎)，ℝᵈ 下界渐近匹配 2，新机制改进平面算法+设施可加维度；Gustave Eiffel/ENS Lyon)；Closing Gaps in Online Fair Division (2609.05310——PROPk 对自适应对抗无可乘 approx(即使已知 m/[0,1]/≤2 agents/含家务)，prediction-aided 确定性 1/2-PROP1 去 n 依赖→n/(n+κ) 鲁棒单侧误差，已知 m≥n log n 确定性算法；NUS)。
- 方法: 与 09-05 报告同约定——与同日 [[arxiv-daily]] 互补不重复，raw listing 抓取 + /abs/ 解析；机构/团队为作者侧推断并标注 tentative 或 "—"，需以 /html/ 或论文核实。2609.05279 在 arxiv-daily 中仅 passing 提及、非 featured，故本报告收录并注明。
- Updated: wiki/index.md（Synthesis 表 arxiv-ai-search 2026-09-07 条目 + 主题摘要 + tags）
- New pages: wiki/synthesis/2026-09-07/arxiv-ai-search.md
- Contradictions: none
...
- 13 papers (12 featured + 1 honorable mention) across 4 themes:
  - ① LLM Training & Pretraining (4): Compile by Training (2609.04199, EMNLP'26 SysDemo, NL spec → reusable local neural function, 83.6% FuzzyBench-Hard, English↔Claudish translator); Auxiliary Views pretraining (2609.04180, Findings EMNLP'26, repetition→reformulation token realloc improves recall, mechanism via layer-wise bias/compression, explains data diversity); ESPO (2609.04197, EMNLP'26, diagnose/propose/bootstrap-stabilize prompt optimization, +3.76 pp over GEPA, 47% shorter); Probabilistic Causal Impact PCI (2609.04177, MC-estimatable causal explanation generalizing actual causality + Pearl, validated on deployed millions-datapoint model).
  - ② Evaluation & Measurement (3): Clean Engineering, Unstable Measurement (2609.04198, preregistered audit of shared-endpoint LLM judges, 52,988 requests — repeat-ranking Spearman 0.400 vs 0.90 required, snapshot-identity ladder + 8 design rules); SWE-Gate (2609.04167, review-constraint compliance benchmark, 221/644 functional-passing repairs fail review constraints across 75 Python repos, functional-only evals overestimate); Generative-Process Diversity predicts correlated cross-LM failure [HM] (2609.03422).
  - ③ Agents, Memory & Research Automation (3): SENTINEL-RL (2609.04159, RL topology reasoning + LLM narrative, graph-attention + PPO + critic-gated text, P/R 0.91/0.87, 6.3s detect→approve cycle); RuleMem (2609.03915, active Horn-clause rule memory w/ RPC validation, LoCoMo +27.47 pts / +54.3% rel over 14 baselines); SciLENS (2609.03338, fully local RL research agent over 12M-record index, structural-visualization-in-loop, reverse-decomposition rubric, ~GPT-5.2/Gemini-3.0-pro level).
  - ④ Retrieval & Rec-Adjacent (3): CLEAR (2609.03482, Findings EMNLP'26, entailment distillation for answerability-over-topicality conversational retrieval, TopiOCQA/QReCC/TREC CAsT gains); CORE (2609.04083, reranker→embedder Rank-KL distillation for compositional MLLM retrieval, 82.7% avg on COLA/SUGARCREPE++/NEGBENCH); Spruce (2609.03376, compact-binary-code + two-server MPC private vector search, 4.8–6.7× faster, 13.1–22.9× with pruning, 93.9–97.3% NDCG retained).
- Key themes: NL-spec→neural-function "compiling"; pretraining data-diversity mechanism; evals as fragile instruments (judges, functional tests, correlated failure); RL topology + LLM narrative agent architecture; rules-as-memory; answerability/private retrieval.
- Updated: wiki/index.md (Synthesis 表顶部新增 arxiv-paper-check 2026-09-06 条目)
- New pages: wiki/synthesis/2026-09-06/arxiv-paper-check.md
- Scan note: arXiv Atom API reachable via https export endpoint after http transport errors; list/new pages fetched live confirmed Fri 4 Sep window.
- Contradictions: none
...
- Key themes: world-model honesty (visual fidelity ≠ state/intervention fidelity) becomes 1st-class eval axis; tool-mediated long-horizon game benchmarks (MCP); real-time interactive WMs + synthetic data pipelines mature; self-play failure-mode analysis beyond toy domains
- Updated: wiki/index.md (Synthesis table new game-rl-daily 2026-09-05 entry)
- New pages: wiki/synthesis/2026-09-05/game-rl-daily.md
- Scan note: arXiv API rate-limited (HTTP 429) → used direct listing pages (arxiv.org/list/{cat}/recent) across cs.AI/cs.LG/cs.GT/cs.MA/stat.ML/cs.CV/cs.HC; every featured arXiv ID grep-verified present 0 times in wiki/
- Dedup: excluded sibling-digest IDs — arxiv-daily 09-05 (2609.03122 Turn-Based Combat Arena, 2609.02931 LLM-Guided RL NPCs, 2609.02928 Mean-field RL reps, 2608.29197 PokaiTrainer), arxiv-ai-search 09-05 (2609.03660 LUGL, 2609.04189 Robust PAC CSGs, 2609.04113 HOOD), 09-02 digests (2609.01549 NashDreamer, 2609.00002 HyperWorld, 2609.00161 IMPACT, 2609.00610 Streaming4D), arxiv-daily 09-01 (2608.30635 test-time RL II-games, 2608.30237 Motus2), 08-31 digests (2608.27757 chess, 2608.27536 deposits, 2608.27672/2608.28458 dialogue-game agents)

## [2026-09-05] synthesis | tech-report-digest (2026-09-05)
- Summary: wiki/synthesis/2026-09-05/tech-report-digest.md — LLM Tech Report Digest **Delta 版** (vs 09-04 基准). 聚焦 **09-04 → 09-05** 窗口。
- 本窗口 **无任何新 tech report / system card** 发布（09-03 GPT-6 Astra 正式发布后短期真空）；内容集中在「即将发布的预告」与「既有发布的规格细化/生态落地」。
- 📅 **xAI Grok 4.7（未发布）** — Musk 09-02 发帖 "comes out in 10 days" → 首个官方时间线，预期 **09-12**（取代 08-12 "3–4 周" 窗口）；~**2.1T 新预训练**（vs 4.6 的 1.5T，+40%）+ supplemental **SpaceX 工程数据**；声称 "exceed all current models / slightly slower / better token efficiency / best at real-world engineering"。全部为 founder claim：**无 spec sheet / model ID / pricing / context window / benchmark card**，docs.x.ai 仍止步 grok-4.6。
- 🆕 **Qwen3.8-Flash-Next 规格细化（08-26 发布，非窗口新增，Qwen4 架构公开预览）** — **125B 总 / ~6B active（≈20:1 激活稀疏）+ 独立 51B 参数组件设计为运行在系统 RAM（非 GPU 显存）**；今夏 4 个 open-weight 版本 4 种不同 license，**无一 Apache 2.0**。
- Anthropic **Fable 5.1**（09-01，前基准 AA66）窗口内落地拆解（Codersera 09-03 / mlq.ai 09-04）：Cache Read **$1→$0.25/M（-75%）**，典型负载 -25%、高 agentic -45%；**breaking change：tool_choice 为 any/tool 的 forced tool use 返回 400**，thinking blocks / edited histories 语义变化，迁移需重跑 evals；1M ctx 统一单价无长上下文溢价；128K max out；tokenizer +~30% tokens；退役承诺不早于 2027-09-01；GitHub Copilot / AWS Bedrock / GCP / Foundry 09-01 同日 GA；缺省数据留存，ZDR 仅合格企业豁免至年底后转 Enterprise Frontier Safeguards。
- 其余 17 家机构无新报告（OpenAI Astra 仍 gated "coming days"；01.AI 2024-12 后已转企业/主权 AI；Apple AFM 2026 tech report 仍处 "later this summer" 承诺、暂未见发布）。
- 时间表：09-08 Mercury 2.5 80% 优惠到期 / **09-12 Grok 4.7（预期）** / 09-14 Claude Code weekly-limit 调整 / 12-31 Gemini 3.8 Flash 引入价到期 / 11-02 xAI grok-imagine-image-quality 退役。
- 趋势：#1 发布真空=预告军备（三家把下世代挂到显式时间线）；#2 straight-to-GA（Fable 5.1/Copilot）vs gated（Astra）分化加深，运维级成本/迁移成竞争叙事；#3 open-weight 进入**异构内存（GPU MoE + 系统 RAM 组件）**赛道；#4 许可策略分化（Qwen 4 版 4 license vs Hy4 Apache 2.0 vs GLM-5.3 $10B 门槛）。
- Updated: wiki/index.md（Synthesis 表 09-05 批次顶部新增 tech-report-digest 条目，位于 conference-digest 09-05 之上）
- New pages: wiki/synthesis/2026-09-05/tech-report-digest.md
- Contradictions: none（Grok 4.7 参数为 Musk 声明已明确标注非官方；Fable 5.1 OSWorld 护栏计 0 口径矛盾承接 09-04 基准记录）

## [2026-09-05] synthesis | conference-digest (2026-09-05)
- Summary: wiki/synthesis/2026-09-05/conference-digest.md — Conference & arXiv daily digest organized by venue then category (ICML 2026, AAAI 2026, NeurIPS 2025, ICLR 2026, CVPR 2026, KDD 2026, ACL 2026, EMNLP 2025, SIGIR 2026, WWW 2026, CIKM 2025, RecSys 2025 + recent arXiv). **42 papers**, focus on Google DeepMind, OpenAI, Meta, Microsoft Research, ByteDance, Alibaba, Tencent, Kuaishou, Baidu, Netflix, NVIDIA, Anthropic, Apple, Amazon, Ant Group, Salesforce + top labs.
- Key coverage: ① NeurIPS 2025 LLM post-training/scaling — TBA async Trajectory Balance (2503.18929, ≥4× speedup), 80/20 high-entropy forking-token RLVR (2506.01939, Qwen3-32B +11.04 AIME'25), DeepMind DiLoCo Scaling Laws (2503.09799), MSR RetrievalAttention (2409.10516, 0.188 s/token @128K). ② ICML 2026 Outstanding — The Flexibility Trap/JustGRPO 89.1% GSM8K (2601.15165), polylog(1/δ) diffusion sampling (2602.01338); DPO Unchained (2507.07855); memorization ≈3.6 bits/param (2505.24832). ③ ICLR 2026 Outstanding — LLMs Get Lost In Multi-Turn (2505.06120, −39% single→multi-turn). ④ AAAI 2026 Outstanding — LLM2CLIP (2411.04997), ReconVLA (2508.10333); MAGRPO (2508.04652). ⑤ CVPR 2026 — Flowception (2512.11438, ~3× train FLOPs cut), Infinity-RoPE (2511.20649), LoL 12h video @20fps single H100 head-wise RoPE jitter (2601.16914), DynamicsBoost annotation-free continuation DPO. ⑥ ACL 2026 Best — Local-Attention Expressivity (2026.acl-long.1739), HSCodeComp; KARL (2026.acl-long.2196), rSIM (2026.acl-long.2054). ⑦ EMNLP 2025 Best — Infini-gram mini FM-index (2025.emnlp-main.34); Parallel Continuous CoT (2025.emnlp-main.47). ⑧ KDD 2026 — GOAL Kuaishou incentive-ads gen +2.184% ROI (2608.04421), CTR-Sink Ant LM-CTR +0.46% AUC (2508.03668). ⑨ SIGIR 2026 — GenRec JD page-wise GR (2604.14878), L2Rec DPMoE +9.24% CTR online (2605.26717). ⑩ WWW 2026 — NEZHA Taobao GR <30ms E2E serving, +1.2% rev (2511.18793). ⑪ CIKM 2025 — UniROM Meituan unified ad-gen +13.6% RPM (2505.19755), MTGR +1.22% conv (2505.18654). ⑫ RecSys 2025 Best — conformal unwanted-content Flowers (2507.16829); Meta HSTU context parallelism 5.3× seq length (2508.04711). ⑬ arXiv — MAS-Orchestra (2601.14652), EDR (2510.17797), SWE-Bench ProMax (2608.09802, GPT-5.2 41.2%), AgentConductor (2602.17100), DeepMind VAD-CFR/SHOR-PSRO (2602.16928), GameWAM (2608.26200), LLAMIA (2609.00474), StateFlow (2608.06838), VGI-Bench (2608.19583, Seedance 2.0 51.0%).
- Dedup: excluded already-tracked pages/entries — Gated Attention, Transformers Inherently Succinct, MixFormer, ULTRA-HSTU, CADET, TGR (09-02), GRAB (08-30), NitroGen (09-03 game-rl), Netflix GenRec (09-01 ai-search).
- 8 cross-cutting themes: forking-token RLVR; async/off-policy LLM training; "controlled-ablation" awards trend; industrial GR serving (<30ms, page-wise NTP, hash verification); sequence-first ads + RL; long-horizon video AR+flow/KV-sparsity hybrids; benchmark-fix era (SWE-Bench defects); memorization as measurable capacity budget.
- Updated: wiki/index.md (Synthesis 表 — new conference-digest 2026-09-05 entry at top)
- New pages: wiki/synthesis/2026-09-05/conference-digest.md
- Contradictions: none (several affiliations/venues marked *(inferred)* where metadata thin)
...
- 🆕 **Meta Muse Spark 1.3（09-02）** — 五个月第 4 款 Muse Spark；AA 指数 **61 (xhigh)/62 (max, 合作伙伴预览) = 前沿**（仅落后 Fable 5.1 66 / Opus 5 63）；增益主要来自 agentic 工作流 + 科学能力；长期多线程 agentic 工作流（单长会话多工作流、自动从杂乱/冲突来源生成上下文、跟踪所学产出交付物）；主动协作（歧义反问/卡住调用用户/关键操作确认/长任务适配用户偏好）；更强对抗鲁棒性 + 不可逆操作校准；$1.25/$4.25 + contributor 低价档；max reasoning 待安全测试；即将开放权重。Bloomberg：进一步逼近 OpenAI/Anthropic。
- 🆕 **Qwen3.8-Max-0902（09-02）** — 2.4T 基底编码/协作快照刷新（非新 base）；**CodeArena 1691 登顶**；8 项编码基准全涨（TerminalBench 3.0 11.3→29.0、DeepSWE 1.1 56.6→69.3、QwenSWEbench V2 55.1→70.0、JobBench 53.4→64.0）；**超 Opus 5 三项**（MLS-Bench-Lite、SWE-Atlas QnA、QwenSWEbench V2）；多模态 +0.4~3 分；同价 $2/$6；Implicit Cache $0.25/M、Explicit Cache Read $0.17/M。
- 🆕 **OpenAI Astra 安全里程碑（09-01/02）** — 首个触发 OpenAI "Critical" 网络安全门槛的模型（自动零日利用、比最强公开模型漏洞更多且算力更少）；Axios：将限制最强网络工具访问；**仍未发布**。
- 其余 15 家机构（Anthropic/DeepSeek/Microsoft/NVIDIA/xAI/腾讯/Zhipu/Moonshot/StepFun/ByteDance/Baichuan/InternLM/01.AI/Amazon/Apple/Mistral）09-02 后均无新 tech report / system card；xAI Grok 5 仍延后。
- 趋势刷新：「三周三连发」rolling release 成新常态；「同价更智能」（same-price, smarter）取代降价成成本竞争新话术；网络安全 = 新前端赛道 + 全面受信防御者 gating（Grok/Astra/Gemini Cyber/Mythos）；agentic/长程工作负载成 benchmark 重心。
- Updated: wiki/index.md（Synthesis 表 09-03 批次顶部新增 tech-report-digest 条目）
- New pages: wiki/synthesis/2026-09-03/tech-report-digest.md
- Contradictions: 无（各 benchmark 数值采自官方 blog/Model Card + 第三方 Artificial Analysis/BenchLM 分开标注；Qwen 编码基准采用 Gate News/TechNode 汇总；Google 自身披露 Flash 短板并与 3.7 对比，与之前基准无冲突）

## [2026-09-03] synthesis | conference-digest (2026-09-03)
- Summary: wiki/synthesis/2026-09-03/conference-digest.md — Conference & arXiv daily digest organized by venue then category, focused on top ML/AI conferences (NeurIPS 2025, AAAI 2026, ICLR 2026, CVPR 2026, ACL 2026, EMNLP 2025/2026, SIGIR 2026, KDD 2026, RecSys 2025, CIKM 2025, WWW 2026) and high-impact arXiv highlights from major labs.
- **~60 papers across 16 venue/lab sections**: ① NeurIPS 2025 Best Papers (Gated Attention / Alibaba; Why Diffusion Models Don't Memorize; 1000 Layer RL; Artificial Hivemind + runners-up 𤔨Superposition/Yejin Choi; Anthropic superposition). ② AAAI 2026 (29K submissions → ~4.3K accepted; SPIRAL MCTS+3 agents 83.6% DailyLifeAPIs; SpecQuant; MP-ISMoE). ③ ICLR 2026 (GRACE contrastive-as-reward +11.5% MTEB; diffusion memorization theory; NDM interpretability; Layerwise Compression-Expression ICL). ④ CVPR 2026 (Back to Basics Kaiming He JiT; Patch Forcing; TWIG interleaved reasoning; MRT 20B masked transformer; DPP-GRPO). ⑤ ACL 2026 (Compositional steering tokens; PaCoRe 94.5% HMMT 2025 vs GPT-5 93.2% via 2M TTC; Think in Sentences; Disco-RAG). ⑥ EMNLP 2025/2026 (StepSearch step-wise PPO; EVAR). ⑦ SIGIR 2026 (relevance posterior; MMRM JD.com demo UCTR +0.42%; agentic search 14.44M requests). ⑧ KDD 2026 (FAT Alibaba Rademacher CTR scaling +4.38% AUC; GR4AD Kuaishou generative ads +4.2% rev). ⑨ RecSys 2025 (SUAN/DiffuMIN/MARS). ⑩ CIKM 2025 (UniROM Meituan). ⑪ WWW 2026 (SparseCTR/ThinkRec/GenCI). ⑫ Top labs (DeepMind Recirculation +21% GSM8k & Scaffolding Minds +9.5%; Anthropic self-modeling & lie detectors; Kimi K3 2.8T MoE; Tencent OneRanker/GPR). ⑬ LLM training/RL post-training (CARE rubric evolution; Matryoshka suites). ⑭ Code agents (SWE-EVO; RACE-bench; REPOREASON). ⑮ IR (LinkedIn LLM ad retrieval; GEM-Rec; SA²CRQ). ⑯ Sequential/feature interaction (HyFormer; FCN; DS-MLP; SFG).
- **7 cross-cutting themes**: structured expressivity vs blind scaling; generative recommendation at scale; test-time compute as new scaling axis; RL post-training rubric era; agentic search/agents measurability; CTR scaling laws maturing; multimodal convergence.
- Note: several venues captured from best-paper/award listings and curated acceptance lists; some affiliations/venues marked *(inferred)* where metadata thin; search API intermittently rate-limited (429) so some categories (e.g. Microsoft Research, ByteDance lab-specific) have lighter coverage than ideal.
- Updated: wiki/index.md (Synthesis table — new conference-digest 2026-09-03 entry at top of the 09-03 batch)
- New pages: wiki/synthesis/2026-09-03/conference-digest.md
- Contradictions: none reported; venue numeric claims taken from official award/press sources

## [2026-09-02] synthesis | tech-report-digest (2026-09-02)
- Summary: wiki/synthesis/2026-09-02/tech-report-digest.md — LLM Tech Report Digest **Delta 版** (vs 09-01 基准). 聚焦 **09-01 → 09-02** 窗口，为高密度发布日。
- 🆕 **Anthropic Claude Fable 5.1 / Mythos 5.1（09-01）**：同权重不同安全档（Fable 通用 / Mythos 受信接入），System Card 09-01。AA Intelligence Index **66**（SOTA，领先 Opus 5 63 / Fable 5 62 / GPT-5.6 Sol 61 / Grok 4.6 61）。Agentic 编码/科研大幅领先：Terminal-Bench-Science 0.1 **52.6%**（Fable 5 24.7%，+113%）、Terminal-Bench 4.0 **55.8%**、CursorBench 3.2.0 73.4%、SWE-bench Verified **95.0%** / Pro **80.0%**（vs GPT-5.5 58.6 / Gemini 3.1 Pro 54.2）、**ProofBench v1.1 100%**（首个 frontier 满分）、GPQA Diamond 92.6%、HLE 60.9%/65.0%。always-on adaptive thinking + Effort 五档；1M ctx / 128K out / cutoff 2026-06。**成本结构创新**：Cache Read -75%（$1→$0.25/M），输入$10/输出$50 不变，典型负载 -25%、agentic 最高 -45%——cost-per-task 成行业 KPI。安全误报 -60%（cyber）/-85%（bio）；Mythos 5.1 为最强 cyber 模型但处 FCF 较低风险；新增 Enterprise Frontier Safeguards（客户云监控/零留存）+ 不可见水印（EU AI Act）；3 项 breaking API 变更 + 5 项 beta。**治理披露**：训练环境奖励破解 >10% → 150 工程师转安全；Catastrophic alignment risk 评为 LOW（非 very low）。科研例证：为金星 1/3 地表生成 2–3km 分辨率高程图、为 7 个开源 DL 模型写 GPU kernel 提速至 2.5×。
- 🆕 **Meta Muse Voice Transcribe（09-01）**：首个实时音频感知模型——streaming ASR + 20+ 说话人 diarization + 多语言无缝 code-switching，ASR/diarization 基准第一；Meta Model API / AI for Mac / Muse Code 即时可用。
- 🆕 **Google Agentic Video（09-01）**：3.7/3.6 Flash + 3.5 Flash-Lite 视频理解——token -88%、成本 -66%、质量 +7%，亚秒级时刻检索、更准异常检测、精确计数。
- 补充录入 DeepSeek **V4-Flash-Vision-Exp（08-30）**：305B MIT 多模态（ApexBench Pass@1 26.2→36.5、Agents' Last Exam 25.2→27.3、Terminal Bench 2.1 83.9、DeepSWE 59.3），开放权重对标 Claude Opus 4.8。
- 其余 14 家机构（OpenAI/Meta/DeepSeek/Qwen/NVIDIA/腾讯 Hy4/GLM/Kimi/StepFun/ByteDance/Baichuan/InternLM/01.AI/Amazon/Apple/Mistral）09-01 后无新 tech report / system card；OpenAI Astra 家族待政府审查、可能以 GPT-6/GPT-5.7 发布；xAI Grok 5 仍延后。
- 趋势刷新：Science/Agentic 工作负载成 SOTA 定义（Terminal-Bench-Science / ProofBench）；cost-per-task 成行业 KPI（cache read 经济杠杆）；实时多模态感知（语音/视频）成新报告类别；安全治理进入透明度军备。
- Updated: wiki/index.md（Synthesis 表 09-02 批次顶部新增 tech-report-digest 条目）
- New pages: wiki/synthesis/2026-09-02/tech-report-digest.md
- Contradictions: 无（Fable 5.1 各 benchmark 数值采自 Anthropic 官方 system card + launch benchmark 表，第三方 AA 指数 66 单独标注；与 09-01 基准无冲突）

## [2026-09-02] synthesis | conference-digest (2026-09-02)
- Summary: wiki/synthesis/2026-09-02/conference-digest.md — Conference & arXiv daily digest organized by venue/category, focused on the fresh Sep-2026 submission wave (IDs `2609.0xxxx–2609.01603`) and conference acceptances (EMNLP 2026, ICML 2026, 35th ACM, ASE 2026 SRC, SOSP AgenticOS 2026).
- **32 unique papers across 6 categories** (10 shared papers deduped to same-day [[arxiv-ai-search]]): ① LLM Arch/MoE/Efficient Inference (Instella-MoE AMD fully-open 16B/2.8B MoE; PCoMoE fine-grained path composition EMNLP'26; SMELT compute-matched looped-MoE scaling laws; DynaNDE near-data expert scheduling; residual sparsification via output importance EMNLP'26; Faster Than Flash attention-sparsity long-context decoding ICML'26; CacheBridge cross-model KV; QTEA ternary; OCGQuant NVFP4; HBQ block quantization); ② LLM Post-Training/RLVR/Alignment (Where the Verifier Fails category-level verifier audit; From Base Rollouts to RL Reasoning Findings EMNLP'26; Post-Training Science for SFT; mid-training KD favors reasoning over factual recall; Behaviorally Effective LoRA Writes Are Sparse; Enoki hallucination detection); ③ Conversational/Evidence-Grounded Rec & Retrieval (35th ACM retrieval/scoring/decoding protocol study; counterfactual behavior-grounded video rec evidence; MUSES intellectual-roots retrieval benchmark); ④ World Models/Games/Embodied (IMPACT attention-as-interaction-map; Streaming4D block-wise 4D; GUI-CC Findings EMNLP'26; ZimaBlue egocentric-video world action models; NashDreamer MBRL IIG); ⑤ Code/Agent Engineering/Systems (CUDA-Harness; WiseSpec ASE'26 SRC; trajectory-aware SWE benchmarking; Irreversibility Budget SOSP AgenticOS fleet-level safety); ⑥ Generative/Diffusion/VL (ReNFT internal recalibration; diffusion-secretly-calculates-attentions; SinkPruner Findings EMNLP'26; diffusion-as-curriculum).
- Dedup: cross-referenced (not featured) — ReST 2609.01240, TGR 2609.00986, CoGR 2609.00638, TS-SSM 2609.00165, HypReflect 2609.00251, RPCBench 2609.00918, ARISE-RL 2609.01058, CM-PTM 2609.01057, HyperWorld 2609.00002, WorldBench 2609.01056 (all already in arxiv-ai-search 09-02); every unique featured ID grep-verified absent from `wiki/`.
- Cross-cutting themes: MoE → fine-grained path composition + near-data scheduling + hardware-aware low-bit quant; RLVR enters honesty/audit era (verifier category-level failures, rollout re-distribution vs capability creation); rec evaluation becomes protocol-sensitive and evidence-grounded; world models → executable/interactive (attention-as-interaction, streaming 4D, GUI-as-environment); post-training becomes a science (SFT recipe, KD stage effects, sparse LoRA writes); agent-safety adds fleet-level irreversibility budget abstraction.
- Updated: wiki/index.md (Synthesis table — new conference-digest 2026-09-02 entry at top of the 09-02 batch, cross-link noted)
- New pages: wiki/synthesis/2026-09-02/conference-digest.md
- Contradictions: none (several affiliations/venues marked *(inferred)* where metadata thin)
...
- 美股(8/31 完整收盘): 三大指数连跌两日但分化——道指 -0.70% 53,185.9、标普 -0.33% ~7,686.14、纳指 -0.12% 26,370.89；**特斯拉 +5.51%**(澳门/港 Model 3 降价)、**英伟达 +1.48%**($35 亿购联发科可转债布 Spark 低成本 AI 芯片)、闪迪 +5.50%(SK 海力士拟日本建厂)、**亚马逊 -2.50%**(FTC+22 州反垄断)、中概金龙 -2.19%(阿里 -4%+、贝壳 -6%+、名创优品 -9.97% 单源待确认)。油价 WTI ~$85.76/布油 ~$90.49，9 月加息概率 ~66.1%，10Y ~4.75%。
- 港股(9/1): 恒指 ~25,566.99(-0.1%)、国企 +0.3% 8,513.18、恒生科技 +0.32% ~4,620(抗跌)；**SHEIN 灰市/暗盘一度 -13% 至 ~HK$42**(首日破发压力，发行价 HK$48.56、估值 $270 亿、腾讯为基石)。
- A股(9/1 盘中/事件为主): 中际旭创拟 40-80 亿元回购(光模块护盘)、宇树科技上市 9 天市值蒸发 ~2,100 亿(-49% 回撤)、锂电/固态电池异动、算力主线回调+高低切换。
- EV/新势力: 蔚来 Q1 营收 255.3 亿(+112.2%)/毛利率 19.0%/现金 482 亿、Q2 指引交付 11 万-11.5 万辆；小鹏 Q2 营收 197.4 亿/交付 103,295(环比+64.8%)/毛利率 20.7%；理想 9/2 新 MEGA；比亚迪 7 月海外 18.05 万(+124%)。
- AI 主题: 英伟达 Spark(联发科可转债)、华为昇腾/9-7 发布会、苹果 9/10、光模块回购、宇树机器人剧烈波动、Broadcom 9/2 财报为下个硬门槛。
- Updated: wiki/index.md (Synthesis 表 09-01 批次顶部新增 investment-daily 条目)
- New pages: wiki/synthesis/2026-09-01/investment-daily.md
- Contradictions: 无（未取得 A 股 9/1 权威指数收盘值，以盘中/事件为主并明确披露；SHEIN 灰市 -13% 为上市前交易非正式首日收盘；名创优品 -9.97% 单源待确认）
...
- Cross-cutting themes: RL credit assignment → transport operators; agentic RL dense; generative recommendation as industrial mainstream; world models shift from video-gen to executable/reasoning; CTR scaling from parameter-heavy to structural expressiveness (Rademacher-complexity CTR scaling law).
- Updated: wiki/index.md (Synthesis table — added conference-digest 2026-09-01 entry at top; preceding date-anchored sibling digests for 2026-09-01 kept)
- New pages: wiki/synthesis/2026-09-01/conference-digest.md
- Contradictions: none (several affiliations marked *(inferred)* / *(unverified)* where metadata thin)

## [2026-09-01] synthesis | arxiv-ai-search (2026-09-01)
- Summary: wiki/synthesis/2026-09-01/arxiv-ai-search.md — cross-domain deep pass over recent strong papers on AI/LLMs/recommendation/advertising/CTR/sequential-modeling/games. Complementary to same-day arxiv-daily (which covers the Tue 1 Sep wave 2608.29340–30662); this report pulls in several earlier-submitted (Jan–Jul 2026) papers that are the current SOTA baselines in the rec/ad/CTR and game/agent literature the wiki tracks. Every arXiv ID grep-verified absent from `wiki/`.
- **21 featured + 1 honorable mention** across 3 categories:
  - **① LLM Architecture/Training/Inference (8)** — Matryoshka LM Suites (nested multi-size family, −36% train compute, static self-speculative decoding, +14–26% throughput) 2608.09703; LatentMoE (NVIDIA, latent-projection routing, Nemotron-3 adopted, iso-accuracy std MoE +350B params / 1.24–3.46× slower) 2601.18089; MoUE Mixture of Universal Experts (virtual-width scaling dimension via layer-agnostic shared pool) 2603.04971; LAER-MoE (PKU FSEP load-adaptive re-layout, 1.69×, ASPLOS'26) 2602.11686; EvoResearcher (training-free self-reflection + CONFIRMED early-stop; value is cost-bounded self-verification, not raw accuracy on clean BBH) 2608.18884; Evaluation Awareness in LMs (representational/verbalized/causal facets; SFT amplifies) 2608.21766; TTS in the Wild (exploitation—not exploration—is the bottleneck; RM ρ≈0.12, Fusion best but ~40% headroom) 2608.18931; [HM] BTS sycophancy label-free reward 2608.25267.
  - **② Recommendation/Advertising/CTR (9)** — GenRec (Netflix LLM ranker, catalog-aware head, prefill-only serving, production A/B win) 2608.10257; GenCI (generative interest-cohort CTR, WWW'26) 2601.18251; CADET (LinkedIn decoder-only ads CTR, +11.04% CTR) 2602.11410; UniDot (unified feature-interaction+sequence block, KDD Cup 2026 runner-up) 2608.16797; CRRN (trigger-introduced rec, +3.87% pCTR Tmall) 2608.22973; SparseCTR (personalized sparse long-behavior attention, rec scaling-law, +1.72% CTR) 2601.17836; DeRes (dual-path residual, 8-layer≈16-layer OneTrans) 2606.07980; STAR (target-aware KDD Cup PCVR) 2608.12986.
  - **③ Games & Agentic RL (6)** — Twin (test-time digital-twin world model, ARC-AGI-3 97.8%, goal-inference is the hard part) 2608.14490; CAST (game-solver turn-level teacher → logit-free distillation) 2607.25308; SAPO (single-rollout autoregressive actor-critic, +15.1/+12.1 pp over PPO/GRPO) 2608.19842; AgentOPSD (recursive self-distillation turn-level credit) 2608.05987; MEMO (memory-tournament context optimization for multi-agent games) 2603.09022; RCDT (conditional sequence modeling for safe RL) 2602.08584.
- Cross-cutting themes: (a) nested/universal/latent parameter sharing (MoE) ⇄ unified feature-interaction+sequence backbone (rec/ad CTR); (b) inference-scaling caveats — reflection/value only helps on unreliable tasks and reward models can't rank open-ended candidates; (c) game/agent credit-assignment attacked via solver signals, single-backbone value learning, and recursive self-distillation; (d) production LLM rankers ship (Netflix GenRec, LinkedIn CADET).
- Updated: wiki/index.md (Synthesis table — added arxiv-ai-search 2026-09-01 entry at top)
- New pages: wiki/synthesis/2026-09-01/arxiv-ai-search.md
- Contradictions: none (flagged tentative where metadata thin — several affiliations marked *(inferred)*: Twin/OpenAI, CRRN/Tmall, UniDot/STAR/team origins; EvoResearcher and TTS-in-the-Wild are healthy caveats against unbounded TTS enthusiasm rather than contradictions)

## [2026-09-01] synthesis | arxiv-daily (2026-09-01)
- Summary: wiki/synthesis/2026-09-01/arxiv-daily.md — first September-wave arXiv daily (Tue 1 Sep mailing = Sun Aug 30 submissions; direct arXiv export API reachable). Fresh wave IDs ~**2608.29340–2608.30662** (376+ unique new IDs parsed across cs.AI/LG/CL/IR/GT/MA), all 16 featured + 10 honorable-mention IDs **grep-verified absent** from `wiki/` beyond dedup boundary **2608.28589** (Mon 08-31 wave).
- Featured (16) across 5 categories: **CTR/Rec/Sequential (7)** — PRIME Dense-anchored low-rank residual MoE fixes subgroup optimization competition in shared CTR tops (gradient-cosine diagnosis 0.23–0.37; +0.0022/+0.0066 AUC over 13 backbones) 2608.30449; ICEGR intent-coherent generative retrieval for e-comm search (intent-aware SIDs + synthetic-query SFT + relevance-calibrated PPO, **Baidu deployed** +3.52% CTR/+15.96% orders/+7.53% GMV) 2608.29652; CAMIE co-engagement-aware multimodal item embeddings (**Snap DPA**, MLLM-native shared embedding + InfoNCE on co-engaged pairs, +0.390% CTR/+10.832% CVR) 2608.30255; SetMIR multi-interest retrieval as set prediction (Hungarian matching + presence scores + NMS, Snap DPA 33% fewer ANN queries, +3.1% CVR) 2608.30251; CHASE repeated-GEO simulation — content homogenization degrades quality-ranking alignment ρ mean −0.068 over 6 domains (COLM'26) 2608.30466; SemPOI-RL LLM natural-language style as interpretable intermediate grounded into position-aware OOT POI seq-gen via RL 2608.30399; HF-SID geographic/numeric/hierarchy-fidelity SIDs for LBS generative retrieval at fixed 3-token 2608.30479. **Advertising (1)** — LangBP joint bidding+pricing via Semantic Decision Transformer (target-state prediction + inverse dynamics) + Execution-Grouped PPO w/ Context-Effect Verifier, AuctionNet + online A/B 2608.30343. **LLM Training/RL/Distillation (4)** — GMTS gradient-magnitude (entropy-gradient connection) token selection beats entropy for RLVR token selection 2608.30632; PAC progress-augmented advantage curriculum (advantage learnability + reward gains, Bayesian Thompson Sampling rollout allocation in GRPO) 2608.30528; IDA-OPD signed entropy-influence + divergence-adaptive advantage shrinkage solves OPD diversity/pass@k bottleneck 2608.29846; Evolutionary Soups evolutionary-trained per-layer gating MoE for inference-time multi-objective alignment (~20% better utility) 2608.29978. **LLM Efficiency/Decoding/Architecture (4)** — compressed draft-side KV memory for long-context SD (Llama 3.1-8B/70B up to 2.08×/3.33×) 2608.30252; VAT verification-aware draft training (NAVER, +11.4% acceptance) 2608.30135; Tail-Replay suffix-replay state reconstruction for unconstrained prefix reuse in hybrid linear-attention LLMs 2608.30310; Qwen3.8-Flash-Next architecture report (125B-A6B, GDN+attention hybrid, Gated Residual, off-accelerator n-gram tables, loss≠downstream dissociation) 2608.30320. **Games/World Models/Agents** — test-time RL in imperfect-info games (implicit gadget games + regularized-PG strategy-degradation bound, Prague/CMU) 2608.30635; Motus2 shared-weight policy/simulator/evaluator closed-loop self-evolving world model for dexterous manipulation (Tsinghua-inferred, Jun Zhu) 2608.30237; WebWorld browser-as-world-model for self-improving web code 2608.30530.
- Honorable mentions (10): joint embedding+codebook GR w/ same-product-cluster supervision 2608.30606; DASC decay-aware hybrid linear-attention state compression 2608.30386; CateKV sequential-consistency KV 2608.30295; DBloom acceptance-histogram stranded speed-up in block-diffusion SD 2608.30427; ReTrace rejected-suffix conditioning for SD 2608.29748; HD-RoPE higher-dim rotary position embedding 2608.29715; PersonaGen-1M GEO demand-side buyer corpus 2608.30023; Hi-Q evidence-conditioned query refinement for multi-hop QA 2608.30468; science sandboxes measure agent scientific capability 2608.30165; knowledge-gated verifiable agent tasks (ignorance-vs-incompetence) 2608.30322.
- Cross-cutting themes: GR's Semantic-ID re-engineered from every angle (intent/geo/coherence); multi-interest & shared-capacity CTR gets competition- and budget-aware; OPD-reliability now includes the *diversity* failure mode; spec-decode frontier = draft-side memory + verification-awareness; hybrid-linear serving converges on recurrent-state checkpoint management (replay/compress/consistency); ad-RL keeps absorbing LLM mechanisms; world models as closed-loop training substrate (Motus2/WebWorld).
- Updated: wiki/index.md (Synthesis table — added arxiv-daily 2026-09-01 entry at top)
- New pages: wiki/synthesis/2026-09-01/arxiv-daily.md
- Contradictions: none (flagged tentative where metadata thin: Motus2/WebWorld API fields partial; affiliations conservative)

## [2026-08-29] synthesis | game-rl-daily (2026-08-29)
- Summary: wiki/synthesis/2026-08-29/game-rl-daily.md — Game RL & Game AI Bot daily paper digest for the Fri Aug 28 announcement wave (Thu Aug 27 submissions, IDs ~2608.24xxx–27455) + recent proceedings. **15 verified-new papers** across 6 sections (1 并行RL/self-play, 3 Foundational & Interactive-World Models, 4 PCG, 5 Benchmarks, 6 Industry, 7 Related Techniques); every ID grep-verified absent from `wiki/` incl. 08-28 siblings (window ended 2608.27455); metadata via alphaXiv + websearch (direct arXiv API/web blocked).
- Excluded post-dedup: **Magpie 2608.27168** and **Nash Loci 2608.27300** were initially selected here but claimed meanwhile by later-committed digests (08-31 game-rl-daily and 08-30 arxiv-ai-search) — dropped to avoid duplicate IDs and noted in the digest's scope block.
- Coverage highlights: Shared Actors need not share critics — shared-critic value mismatch in parallel RL, index-conditioned critic +40.8% Procgen (2608.26481); SpatialCrafter single-image world modeling via 3D PaSS proxy + Generative Deferred Refiner, SIGGRAPH Asia 2026, ~115K scene dataset (2608.27073); Mirage latent spatial memory — 3D cache in diffusion-latent space, 10.57× faster / 55× smaller memory (2606.09828); 4DSynth text/blueprint/photo → editable 4D OpenUSD env + 4DSynth-Nav benchmark, VLMs fail majority of tasks, NTU/Oxford/Princeton/DeepMind (2608.26947); Procedura "3D shape as code" agentic procedural assembly with typed mates, beats native 3D generators on P3D-Bench + MechBench-36 (2608.26238); R2M-Bench revisit-memory via relative calibration (MemoryGain/NMR), ρ=0.547 vs human judgments across 7 world models, DreamX Alibaba (2608.27328); CS2 same-player verification from demo behavioral fingerprints, ROC-AUC 0.956 pro / 0.982 history-aggregated (2608.24893); CPGRec+ balanced game recsys with PER signed edge reweighting + LLM PRG (2604.14586); Zero-WAM in-context world-action modeling from human videos, +29.5pp RoboTwin 2.0 (2608.26103); navigation latent world model with compatibility prediction + in-WM RL (2608.26190); PATH active curriculum refinement over curriculum DAGs, ICML 2026 (2608.26469); LAC light-actor/deep-critic offline RL, 4× lower inference latency (2608.26659); global finite-sample guarantee for quantile TD, no polynomial dependence on #quantiles (2608.27313); blindfolded graph pursuit with chosen travel times — single pursuer succeeds poly-time on any graph (2608.27347); Robbins' Problem modeled as infinite MDPs, near-optimal finite abstractions, improved approximations for all n≤100 (2608.27419).
- Updated: wiki/index.md (Synthesis table new game-rl-daily 2026-08-29 entry, inside 08-29 batch)
- New pages: wiki/synthesis/2026-08-29/game-rl-daily.md
- Contradictions: none (注: 4DSynth-Nav task count ~333 from earlier websearch, marked tentatively; Magpie/Nash Loci claim divergence between 08-29 draft and later-committed siblings resolved by exclusion)

## [2026-08-31] synthesis | game-rl-daily (2026-08-31)
- Summary: wiki/synthesis/2026-08-31/game-rl-daily.md — Game RL & Game AI Bot daily synthesis. Focused pass over target window `2608.24xxx–286xx` (Aug 24–31).
- Coverage: **5 genuinely-new papers** (grep-verified 0 hits in `wiki/`, none in the task's 11-ID dedup list). ③ Game Foundation Models ×1 — **Magpie** real-time generative world renderer decoupling gameplay (engine/white-box frames) from visual generation (Render Server), ~32.2 FPS/20 chunks, 5B distilled renderer, 2608.27168. ⑤ Benchmarks ×1 — **WSE-bench** process benchmark for LLM storytelling in open-ended world sims / AI-native games; non-concave Consistency/Richness Pareto frontier (scale helps sustained generation, not coherence/development), 2608.15654. ⑦ Related techniques / agentic RL ×3 — **SRPO** self-reflection-as-dense-reward, reflection patches + reset-with-memory, AIME'24 73.3% @0.08× FLOPs (ICML 2026, 2608.23493); **AHEAD** step-aware environment-augmented self-distillation, +13.3 ALFWorld/+11.0 WebShop @7B, 2608.24114; **EDGE** experience-distillation internalizes retrieved scaffolds as training-time, +12.5, EMNLP 2026 Main, 2608.21946.
- Dedup wall: categories ① Game RL, ② Game Bot, ④ PCG, ⑥ Industry were **saturated by prior sibling digests** — PureTD/SPADE/EpicStar/Twin/DiG-bench/WorldMind/ReWorld/FM-Bench/SocialGym/Level-k/GameXpert-Bench/RLHEV/Game2World and the games/world-model/bot papers in 08-28→08-31 arxiv-daily/paper-check/ai-search already claimed nearly all in-window candidates.
- Caveats: affiliations mostly *(inferred)* / *(unverified)* (not stated on abs pages); below the 8–14 target due to dedup wall, clearly flagged to the reader.
- Updated: wiki/index.md (Synthesis table new game-rl-daily 2026-08-31 entry)

## [2026-08-31] synthesis | arxiv-paper-check (2026-08-31)
- Summary: wiki/synthesis/2026-08-31/arxiv-paper-check.md — arXiv Paper Check, AI & CTR (August 31, 2026). Complementary focused pass over the fresh Mon Aug 31 wave (IDs ~2608.27460–28589); 12 verified-new papers across 4 categories + 5 HMs; all IDs grep-verified absent and not claimed by same-day arxiv-daily/arxiv-ai-search siblings.
- Coverage: ① CTR/Rec/IR ×4 — SkillFeed personalized skill routing as profile-conditioned retrieval (+23.1pp top-1 / +35.1pp on profile-counterfactual queries, 2608.28241); LINE personal-memory RAG hybrid retrieval (Recall@5 0.697, β=0.45, single-user 2608.27809); PULSAR production pooled two-stage late-interaction visual-doc RAG at Mubadala (15.1× latency cut, ~88× QPS, 78K docs 2608.28572); NormasTCU pt-BR legal IR benchmark — LLM-as-judge rank-aware (nDCG/MRR τ≥0.90) but not P@10/R@10 (2608.27746). ② Agentic RL & Credit ×4 — VICT verifier-instrumented credit tracing (credit along verifier proof-edges, no critic/extra sampling, 2608.28128); DA3PO difficulty-aware advantage amplification fixes DAPO Dynamic-Sampling asymmetric bias (~30 lines, 2608.27982); HARTS hybrid-attention RL over arbitrary rollout trees at Ant Group (4.81–4.87× fwd/bwd/grad prefix-sharing speedup 2608.28158); ReToolSQL agentic RFT text-to-SQL (#1 BIRD single-model dev, 74.32% EX single-pass 2608.27796). ③ Agent Safety & Monitoring ×2 — CURA certified runtime alarms for CUAs (self-report fails 90% of failures; CUSUM detects 42.3% with certified FPR 2608.27808); Speculative Probing repurposes spec-decoding KV for near-zero-cost monitoring (matches 8B safety classifiers 2608.28099). ④ Serving/Efficiency ×2 — PASK parser-aware structural KV persistence (+17.39pp @0.33 budget, 2.2× throughput 2608.28276); SOMTab set-order Mamba tabular ICL (state-space for representation, attention only for retrieval 2608.27882).
- HM: WhatIfBench counterfactual-reasoning breakdown (2608.27953); proper scoring rules shape LLM forecasting structure (2608.28482); tool-integrated math RL (2608.28447); QUEST asylum-law credibility IR (2608.28555); LitCurate auditable scientific database curation (2608.27629).
- Key trends: credit assignment re-engineered end-to-end (verifier-tracing VICT + advantage-level DA3PO alongside daily's OPD-reliability cluster); agent oversight goes certified & near-free (CURA + Speculative Probing); two-stage retrieval structure (coarse + exact) resurfacing in RAG/routing/KV serving; selectivity-over-fusion extends to representation choice (SOMTab, NormasTCU judge-ranking dissociation).
- Updated: wiki/index.md (Synthesis table new arxiv-paper-check 2026-08-31 entry)
- New pages: wiki/synthesis/2026-08-31/arxiv-paper-check.md
- Contradictions: none
...
- Key trends: (1) LLM→Agent evolution (ACL 2026 +158% agent/reasoning papers); (2) Generative recommendation in production (YouTube/Baidu/Tencent); (3) Scaling laws for recommendation (ByteDance LONGER/RankMixer/TokenMixer); (4) MoE adaptation to recommendation (Meta Sparse by Design, theme-aware MoE); (5) Agentic optimization surpassing human MLEs (YouTube); (6) Interpretability as ACL 2026 theme; (7) Unified architectures converging feature interaction and sequence modeling; (8) Security concerns in multimodal recommendation.
- Updated: wiki/index.md (Synthesis table entry already existed for 2026-06-05)
...
## [2026-08-28] synthesis | arxiv-ai-search (2026-08-28)
- Summary: wiki/synthesis/2026-08-28/arxiv-ai-search.md — arXiv AI/LLM/Rec/Ads paper search; 20 verified-new papers, 6 categories
- Coverage: 2,469 unique papers fetched via arXiv API (IDs 2607.18115–2608.27455) across cs.IR/cs.CL/cs.AI/cs.LG/cs.GT/cs.MA/cs.CR/cs.HC + `all:recommendation`; domain-keyword scoring + freshness ≥ 2026-08-20 → 417 candidates → 20 final. Every reported ID grep-verified absent from whole wiki (known-ID set of 3,896 IDs). One candidate (2608.26896 tacit collusion) found already claimed by sibling arxiv-paper-check — dropped, not duplicated.
- 20 papers covered: Recommendation & E-commerce ×4 (BOAR env-conditioned multi-behavior rec +7.82% HR@10 2608.22920; Retrieve-Match-Escalate product linking 2608.25037; TRACE agentic catalog enrichment DoorDash +0.48% conversion 2608.20844; GUIDE unsupervised Chinese query correction 2608.25343), Advertising & Market Mechanisms ×1 (AgentLance VCG-based agent markets 2608.23867), IR & Retrieval ×2 (AnchorQE query-expansion integration +12.89% 2608.25521; risk-aware tool retrieval 2608.22751), Games & World Models ×5 (GameWAM 2608.26200; Code World Model 2608.25927; ShuttleArena badminton 2608.25246; SCG JEPA 2608.27367; Optimal Alternating Regret 2608.24731), Agents & Agentic RL ×5 (HarnessLens 2608.27311; SPO++ 2608.24870; MetaRAG 2608.24214; SMITH 2608.24571; Interaction Tax 2608.23541), LLM Training/Efficiency/Eval ×3 (SPEAR 2608.26550; Reasoning Tax 2608.26235; BALIGN 2608.24192)
- Key highlights: two independent DoorDash systems formalizing agentic evidence-grounded catalog plumbing; WAM line continues with game-native GameWAM + Code World Model (code as persistent world state); reward engineering consolidating on internal signals (belief-action MetaRAG, symbolic SPEAR, token-measure SPO++); Interaction Tax shows full-solution multi-agent interaction converges within one round erasing diverse proposals
- Updated: wiki/index.md (Synthesis table new arxiv-ai-search 2026-08-28 entry)
...
## [2026-08-29] synthesis | tech-report-daily (2026-08-29)
- Summary: wiki/synthesis/2026-08-29/tech-report-digest.md — 18 家目标机构最新 LLM 技术报告/系统卡综合摘要，聚焦 2026 年（尤其 7–8 月）最新发布与更新，每机构一个表格（中文/英文标题、机构、系列、发布日、参数、数据量、上下文、创新点、arXiv/链接），附今日增量与 10 条行业趋势。
- Companies covered: DeepSeek (V4-Pro 1.6T/49B & V4-Flash 284B/13B MoE, CSA(m=4)+HCA(m'=128) Hybrid Attention + mHC + Muon + Hash-MoE bootstrap + FP4/FP8, 32T+ tokens, 1M ctx, 27% FLOPs/10% KV vs V3.2, MIT, arXiv:2606.19348; V4-Pro GA 08-13), OpenAI (GPT-5.6 Sol/Terra/Luna System Card + August Updates: ChatGPT 默认模型升级 Sol/Luna with effort slider 替换 GPT-5.5 Instant, GPT-Red 自博弈红队 08-03, 08-19 勘误; Preparedness High Bio/Chem+Cyber), Meta (Muse Glimmer 30B Apache 2.0 DFlash 多模态 agent 本地运行; Llama 4 405B 开放权重仍失约; Llama 4 Scout 109B/17B 10M ctx), Google (Gemini 3.7 Flash 08-13 GA agentic coding intro $0.75/$3.75 + Gemini Omni Flash 08-27 更新视频创建/编辑; Gemini 3.1 Pro 1M/64K 旗舰), Anthropic (Claude Opus 5 07-24 新增接近 Fable 5 半价 $5/$25 + Fable 5 & Mythos 5 ASL-3; Sonnet 5 06), Mistral (Mistral Small 4 03-16: 119B/6.5B MoE 128ex/4active 统一 Magistral+Pixtral+Devstral 256K Apache 2.0 + Shieldstral 3B 安全分类器; 欧洲主权路线), Qwen (Qwen3.8-Max 2.4T/95B Sparse MoE+Hybrid Attention 1M ctx 首开源 Max 级 OSWorld-Verified 86.1/PaperBench 93.0/native 视觉/long-horizon RL; 权重 08-12 兑现 + Qwen3.8-27B + Qwen3.5-Omni ARIA), Microsoft (Phi-4-reasoning-vision-15B, Phi Silica Platform Card Windows NPU; Phi-5 仍无官方报告), NVIDIA (Nemotron 3 Super 120B/12B hybrid Mamba-Attention MoE LatentMoE+MTP+NVFP4 预训练 25T tokens 1M ctx 2.2×/7.5× 吞吐 arXiv:2604.12374 新收录 + 3.5 Lightning 30B MoE agentic autodraft + Nemotron 3 Ultra 550B), xAI (Grok 4.6 08-12 Model Card 1.5T/500K long-running agents reasoning 四档 + Cursor; Grok 5 训练中 6T/10T Colossus 2 未发布), Amazon (Nova 2 Lite/Pro/Omni/Sonic 1M ctx 多模态动态推理 low/medium/high + Nova Multimodal Embeddings + Sonic speech-to-speech), Zhipu (GLM-5.3 08-14 743B 同基座后训练提智: SAO+IndexShare+Slime, Terminal-Bench 3.0 28.3/DeepSWE 66.9/GDPval 1769, CyberGym 84.5% 超 Mythos 5 83.8%+Sol 83.6%, ExploitBench 54.4%, 首次因安全延后开源; 仅 reasoning low/high/max), Moonshot (Kimi K3 07-27 2.8T/104B MoE 93层(69 KDA+24 Gated MLA) 896ex/16active Stable LatentMoE + Quantile Balancing + Per-Head Muon + AttnRes, 2.5×效率 vs K2, 1M ctx 原生视觉 MoonViT-V2, full weights 开源, arXiv:2607.24653), StepFun (Step3 321B/38B MFA+AFD model-system co-design Hopper +70% vs DeepSeek-R1), ByteDance (Seed2.1 Pro/Turbo 06-23 agent 生产力模型 256K GDPVal 87.9 超 GPT-5.5 84.9/Opus 4.7 82.7/Gemini 3.1 Pro 67.3, 视频理解多 SOTA, closed MaaS CNY 定价; Seed2.0 Model Card PDF), Baichuan (M4 06-09 临床医疗 agent SPAR++ HealthBench 68.6 世界第一 hallucination 3.3% arXiv:2606.08982), InternLM (InternLM3-8B 4T tokens, 无 2026 新大模型技术报告, Intern-S1-Pro 1T MoE), 01.AI (Yi-Lightning 仍为最新, 2026 转向企业 AI)
- Today's delta (vs 08-28): 新增 Claude Opus 5 (07-24), 新增 NVIDIA Nemotron 3 Super (arXiv:2604.12374), Google 新增 Gemini 3.7 Flash (08-13) + Omni Flash (08-27) 更新, OpenAI GPT-5.6 August 更新 (ChatGPT 默认升级 + effort slider + 08-19 勘误), xAI Grok 5 训练中确认 (6T/10T), Apple AFM 3 重建基线 (五模型 06-08), Mistral Small 4 参数补全 (119B/6.5B)
- Key trends: (1) MoE 仍绝对主流 (激活仅 1/24~1/30); (2) 稀疏/压缩注意力收敛期 (CSA/HCA/KDA/IndexShare/Hybrid Attention/PT-MoE); (3) hybrid Mamba-Attention 成新变量 (Nemotron 3 Super/Kimi KDA/DeepSeek HCA); (4) 后训练 Scaling 成竞争前沿 (GLM-5.3 同基座提智/Nemotron 阶段化 RL/effort slider); (5) 中国开源旗舰"双轨"分化 + 兑现信用分化; (6) Agentic 能力成官方评测主战场 (OSWorld/PaperBench/Terminal-Bench/DeepSWE); (7) 安全分类器/System Card 成独立品类 + "emergent cyber capability" (GPT-Red/Mythos ASL-3/Shieldstral/GLM-5.3 因安全延后开源); (8) 推理成本=系统工程 (MTP/speculative/effort/token效率); (9) 全模态+长上下文成旗舰标配; (10) 超大规模"承诺制发布"与兑现信用 (Qwen/V4-Pro/Grok 4.6 兑现 vs Meta 405B 悬置, Grok 5 训练中)
- Updated: wiki/index.md (Synthesis table new tech-report-digest 2026-08-29 entry)
- New pages: wiki/synthesis/2026-08-29/tech-report-digest.md
- Contradictions: none

## [2026-08-30] synthesis | conference-digest (2026-08-30)
- Summary: wiki/synthesis/2026-08-30/conference-digest.md — 46 papers across top ML/AI conferences (2025-2026 cycle: ICML/ICLR/AAAI/NeurIPS/CVPR/KDD/ACL/EMNLP/SIGIR/WWW/CIKM/RecSys) + latest arXiv preprints (late-Aug 2026 wave 2608.27xxx-29xxx), organized by venue/category. Focus on top labs (Google DeepMind/OpenAI/Meta/Microsoft/ByteDance/Alibaba/Tencent/Kuaishou/Baidu/Netflix/NVIDIA/Anthropic/Apple/Amazon) + top academic labs.
- LLM Post-training & RLVR: TTPO label-free test-time policy optimization (Qwen3-1.7B 38.0→45.2%, +25.2-36.4% no-thinking, 2608.27448); weak-model-guided RLVR exploration anti entropy-collapse (2608.27420); RLVR cross-domain fusion paradigms Merge/MixRL/MOPD (≤1.4pt mean diff, 2608.27409); BCIT conditional experience transfer (4B, 2608.26730); Puro-2B <$5K single RTX 5090 pretraining + Puro Cost Scaling Law (~$4.4K to Qwen2-1.5B, Tsinghua, 2608.27370)
- Agentic RL & Agents: Agent Lightning v1.0 (Microsoft) harnessed agentic RL, Qwen3.5-9B SWE-bench Verified 41.8→56.4 (+14.6pp) w/ ~6K samples (2608.17528); MoRe (Mixture of Roles) single-model multi-agent steering, +2.2% vs single-agent, 20× token cut (2608.27338); WikiSkill (Google) persistent skill wiki co-evolution, cross-model transfer (2608.27454); The Interaction Tax (ICML'26, UChicago) full-output communication erases diversity in 1 round (2608.23541); GRAIN invariance-rewarded single-agent graph RL, +16.45% acc / -24% latency / OOD gap halved (2608.27142)
- Efficiency: CritICL inference-time weak-to-strong from small-model failure modes (2608.27455); TwinKV pairwise-key redundancy eviction repair pass (2608.27128); InnerExpert MoE hallucination detection AUROC 0.91 answer/0.76 token (INESC-ID, 2608.17687); StickyMoE routing-consistency loss, -59% expert switches, 3.92× cache-miss (BrainChip, 2607.08780)
- Recommendation: NMRL (CIKM'26, Taobao/Alibaba) native multimodal CTR via Mine-Then-Train, online CTR+1.5%/RPM+0.5% (2608.24091); TSPORec token selection via preference optimization, +31.25% NDCG@K, -63.4% cost (2608.09605); OMEGA (KDD'26) collaborative memory augmentation for GR (2608.01315); GALLM graph-aware LLM seq-rec +9.76% HR@5 (2608.12184); DTE (CIKM'26) decoupled temporal encoding (2608.16274); GOD (CIKM'26) deep grafting KD +13.92% (2608.16073)
- Ads & CTR: GR4AD (Kuaishou) production generative ads, +4.2% ad revenue / +17.5% SMB delivery / <100ms / 400M users (2602.22732); MARCO (Meta) click-intent decomposition overcomes calibration-masked bias, +2.80% conv/click, +0.98% topline (2608.10562); LAMA token-level ad auction Markov DSIC+IR (2608.27382); CRRN (Tmall/Alibaba) cascading relevance CTR +3.87% pCTR (2608.22973); GRAB (Baidu) sequence-first generative CTR +3.49%/CPM+3.05% (2602.01865); IDProxy (Xiaohongshu) MLLM cold-start CTR +0.23-0.32% new notes (2603.01590); GOAL (KDD'26, Kuaishou/UESTC) ROI-constrained generative incentive optimization (2608.04421); UniVA (Tencent) value-aligned GR GMV+1.5% (2605.05803); OneRanker (Tencent) unified gen+rank GMV-Normal+1.34% (2603.02999v3); EST (Taobao) efficient CTR scaling RPM+3.27% (2602.10811)
- Retrieval: OneShot (Meta/Instagram) index-in-ranking EIDs, recall+20% @1%, 10× efficiency, +61.6% retrieval source contribution (2607.27475v2); EGR (Snap) embedding-native GR shared-LLM, +2.91% CVR (2607.23038)
- Generative & Multimodal: MDD magnitude-direction decoupling video FM, 2.95× Wan2.1 (2608.17695); Stream Forcing unified training trajectory, 36.6% FVD UCF-101 (2608.10439); Physics of Multimodal Pretraining (Meta FAIR) 5% compute to strong generation, early-unification, language-as-booster (2608.05000); ANCHOR multilingual MLLM modality-asynchrony repair (Ghost Anchor, 2608.15085)
- Games & World Models: ReWorld (HKUST/Alibaba-inferred) landmark-bank bounded-KV long-horizon interactive WM, 704×1280 (2608.23565); Twin test-time digital twin (OpenAI Codex world-model inference) ARC-AGI-3 23/25 games 179/183 levels 97.8% (2608.14490); PlayWorld (HKU/Kuaishou Kling) interactive agent-player WM benchmark, 9 WMs unreliable long-horizon (2608.13552); WorldMind (Tencent-inferred) decoupled state-aware NPC WM + BOSS-140K dataset ~70% human preference (2608.21439); Game2World Engine mask-free UI removal VideoReward+6.83% (2608.24680)
- Code Execution: AgentExecutor (ASE'26, SMU/ZJU/York) agentic partial code execution, 94% coverage / +19.9% vs Treefix / -80.3% time (2608.05959); Step-KTOder (EMNLP'26 Findings) function-level execution feedback, BigCodeBench Hard +26.7%/LiveCodeBench +27.0%, exec labels beat LLM-as-judge on passing functions 52.2% (2608.23632)
- Benchmarks: StartupBench (ByteDance Seed) market-validated end-to-end workflows, strongest models <1/3 completion under strict rubric (2608.17800); EcoAgent-Bench economic decision-making under budgets, Tool-API 3.9-24.0% strict success (2608.05519); FrontierFinance (Samaya) finance-agent frontier bench, tool harness shapes quality 56.0% vs Claude Fable 5 49.2% (2608.11683)
- Key trends: RLVR precision (exploration/fusion/label-free/exec-label); agent harness+data-pipeline not just prompts; GR/ads full-stack industrial deployment (value alignment + serving); world models focus on long-horizon memory + interactive eval; multimodal pretraining physics; <$5K low-barrier pretraining; benchmarks move to market-validated + economic rationality
...
- Contradictions: none
## [2026-08-30] synthesis | arxiv-daily 2026-08-30
- Summary: wiki/synthesis/2026-08-30/arxiv-daily.md — complementary 2nd pass over Fri Aug 28 submission wave (no weekend mailing; freshest live listing top ID ~2608.27455), focusing on unclaimed IDs ~2608.23664–2608.26950. Direct arXiv API/web blocked → metadata recovered via targeted websearch against live arXiv abstract/HTML pages. All 6 paper IDs grep-verified absent from wiki/ beyond dedup boundary.
- Papers covered (6, 5 categories):
  - LLM Agents & Scientific Discovery: DeepMind Co-Scientist real-world labs (2608.26701) — execution-grounded research: C2Cl6 non-hazardous MXene precursor route, one-take monolayer MoS2/MoSe2/WS2 growth, E. coli swarming phenotype prediction, self-discovered Agent_H beats 6 frontier models on HealthBench with lower clinical harm (p=0.0486), log-grounded manuscript audit cuts severe methodological errors 100%→24%
  - LLM Architecture & Efficiency: MetaNet task-conditioned layer-wise MoE compression (2608.26650, Nanjing Inst Info Superbahn + UCAS) — support-set controller predicts per-layer expert-retention threshold + bounded routing bias, frozen backbone/router; 40–62% fewer active experts on DeepSeek-MoE-16B with bounded MMLU loss, MMLU-controller transfers to C-Eval
  - LLM Evaluation: From Atomic to Agentic (2608.26950, EMNLP 2026, Tencent Youtu + Sun Yat-sen) — process-level benchmark of agentic mathematical reasoning via plan–action–feedback, automated trajectory synthesis + fine-grained annotations; models with similar end-to-end accuracy differ markedly in agentic capability profiles
  - RL & Generative Models: RVM reward-based velocity matching for diffusion RL (2608.23664, NVIDIA/Georgia Tech) — trajectory-free update on velocity field, generalizes/recover RAM & DiffusionNFT, competitive/outperforms trajectory-based PG at lower cost, dynamic-tracking reward counters static-but-clean video reward hacking
  - World Models: ConfAL-WM confidence-guided active learning for action-conditioned world models (2608.25572, Tsinghua inferred) — lightweight confidence probe on UNet decoder features, dense latent confidence maps, concentrates post-training data on error hot-spots
  - Retrieval & Ranking: RDQ Rank-Deviation Quality (2608.25318, Amazon) — ordinal distance-aware metric for multi-answer retrieval, no graded gains, combines returned-items + ordering, highest median power@100 of 13 configs on 12-system POI set, comparable to NDCG on TREC DL at low n
- Updated: wiki/index.md (Synthesis table new arxiv-daily 2026-08-30 entry)
- New pages: wiki/synthesis/2026-08-30/arxiv-daily.md
- Contradictions: none
- Dropped as KNOWN / out-of-wave: LAMA 2608.27382, MaskRec 2608.27005, Stageboost 2608.27366, CoVeMem 2608.26895, WikiSkill 2608.27454, RLHEV 2608.25518, HSR 2608.25755, REPREC (2607.24845); 2608.16957 pure math; 2608.26445 metadata unverifiable

## [2026-08-30] synthesis | tech-report-daily (2026-08-30)
- Summary: wiki/synthesis/2026-08-30/tech-report-digest.md — 19 家目标机构最新 LLM 技术报告/系统卡综合摘要，聚焦 2026 年（尤其 7–8 月）最新发布与更新，每机构一个表格（中文/英文标题、机构、系列、发布日、参数、数据量、上下文、创新点、arXiv/链接），附今日增量与 10 条行业趋势。与同目录 conference-digest（arXiv 论文层 RLVR/TTPO）去重无重叠。
- Companies covered: DeepSeek (V4 Flash-Vision-Exp 08-21 视觉实验 + V4-Pro 1.6T/49B GA 08-13 + pre-IPO ~$74B SCMP 08-26), OpenAI (GPT-5.6 Sol/Terra/Luna August Updates + 08-18 "Pacing" blog: Astra 近 Critical 网络阈值, 最大 frontier RL run 暂停 + 2 周全模型 RL 缓冲, 首次主动减速开发), Meta (Muse Glimmer 30B Apache 2.0 DFlash; Llama 4 405B 仍失约, 无新增), Google (Gemini 3.5 Audio Model Card 08-26 新增: Live Translate 128K/Transcribe 96K 基于 Gemini 3 Pro; 3.7 Flash 08-13 GA; Omni Flash 08-27 更新), Anthropic (Sonnet 5 06-30 $2/$10 由临时改永久定价 08-10; Opus 5 07-24 + Fable5/Mythos5 ASL-3), Mistral (Shieldstral 3B 08-04 Apache 2.0 policy-adaptive 多模态安全分类器 12 语言 16GB GPU; Small 4 119B/6.5B), Qwen (Qwen3.8-Flash 08-26 新增: 多模态 262K→1M ctx, 训练成本 1/9 of Qwen3.7-Plus, 定价 ¥1/¥3; Qwen3.8-Flash-Next 08-26 开放权重新增: Gated DeltaNet + Gated Attention, Qwen4 架构 early preview, 附架构技术报告; Qwen3.8-Max 2.4T/95B 基线), Microsoft (MAI-Thinking-1 新增: 1T/35B MoE 持续 RL "hill-climbing" from-scratch 企业数据无第三方蒸馏, SWE-Bench Pro 52.8/AIME2025 97.0/LiveCodeBench v6 87.7, 08-12 report; Phi-4-rv-15B 基线), NVIDIA (Nemotron 3 Ultra 新增技术报告 06-09: 550B/55B hybrid Mamba-Attention MoE, 20T, 1M ctx, LatentMoE+MTP+NVFP4+MOPD, 6× 吞吐; 3 Super 120B/12B 基线), xAI (Grok 4.6 08-12 Model Card 1.5T/500K; Grok 5 错过 Q1→Q2→8中窗口仍训练中 6T/10T ~550K GPUs), Amazon (Nova 2 Lite/Pro/Omni/Sonic 1M ctx + Sonic 2026-05 原位刷新, 无新增), Zhipu (GLM-5.3 权重 08-28 正式开源 HF 支持 Transformers/vLLM/SGLang, 自定义 GLM-5.3 License: MaaS 云厂 12 个月合并营收 <$10B 免安全审查——报告另有 $100B 口径待核实, "因安全延后开源"兑现; GLM-5.3-Flash 08-26 新增: 320B/18B 首 GLM-5 原生多模态 Hybrid Sparse+Linear Attention + mHC, 30T 多模态语料, ~57 AA Index @$0.045/任务, 超 GLM-5.2 全系), Moonshot (Kimi K3 07-27 README 规格补全: 93 层 = 69 KDA + 24 Gated MLA + 1 dense, 896 experts top-16 + 2 shared, MoonViT-V2 401M, MXFP4/MXFP8), StepFun (Step 3.7 Flash + 3.5 Flash 产品线并列, Step3 321B/38B MFA+AFD 基线), ByteDance (SeedRealtime 08-05 新增: 原生音视频全双工统一架构 Doubao 部署; Seed2.1 Pro/Turbo 256K 基线), Baichuan (M4 08-26 发布新闻: 临床医疗 agent 系统 Harness+SPAR++ long-cut 记忆 86.9, HealthBench 68.6 第一超 GPT-5.5 58.4, hallucination 3.3%, tech report 06-09 arXiv:2606.08982; M3-235B Apache 2.0 首纳入), InternLM (Intern-S2-Preview 08-17 新增: 35B 科学多模态 task scaling 预训练→RL 全链路, 逼近 1T S1-Pro; S2-Mobius 论文 08-17 knowledge/reasoning 分层), 01.AI (Yi-Lightning 仍最新, 2026 转向企业产品 TrueNorth/Boss/Investor/TopSales AI), Apple (AFM 3 升格正式条目: 五模型矩阵 06-08, AFM3 Core 3B dense + Core Advanced 20B sparse 1-4B 动态激活 IFP, Cloud/Clouder, ADM 3 Cloud)
- Today's delta (vs 08-29): Zhipu GLM-5.3 权重 08-28 开源兑现 + GLM-5.3-Flash 08-26 新增; Qwen3.8-Flash(-Next) 08-26 新增 (Flash-Next = Qwen4 架构预览); Microsoft MAI-Thinking-1 新增; NVIDIA Nemotron 3 Ultra 技术报告新增; Google Gemini 3.5 Audio 08-26 新增; ByteDance SeedRealtime 08-05 新增; Moonshot K3 README 精确规格补全; DeepSeek Vision-Exp + 融资 $74B; xAI Grok 5 窗口延后确认; Anthropic Sonnet 5 定价转永久; OpenAI Pacing post 08-18; Baichuan M4 发布新闻 + M3 首纳; InternLM S2-Preview + S2-Mobius 首纳; Apple 升格条目 #19; StepFun 现状确认
- Key trends: (1) Linear/混合线性注意力正式商品化 (Flash-Next Gated DeltaNet + GLM-5.3-Flash Sparse+Linear + Kimi KDA + Nemotron 3 Ultra Mamba); (2) MoE 稀疏激活仍绝对主流 (激活 1/20~1/30); (3) 后训练/测试时 Scaling 全面接管增量; (4) 多模态 Flash 化低成本原生多模态; (5) 安全监管进入"文档即产品"阶段 (GLM License 营收阈值条款 + OpenAI Pacing + ASL-3 blockers); (6) 开放权重许可双轨分化加剧; (7) Agentic 能力成官方评测主战场; (8) 中国轮动加快, 发布窗口纪律分化 (Kimi/GLM 兑现 vs Grok 5 延后/Meta 405B 悬置); (9) 效率 = 系统工程; (10) Agent 系统/工具层成新报告载体 (Baichuan-M4 Harness/SeedRealtime/Gemini 3.5 Audio)
- Updated: wiki/index.md (Synthesis table new tech-report-digest 2026-08-30 entry, 顶部插入)
- New pages: wiki/synthesis/2026-08-30/tech-report-digest.md
- Contradictions: none (注: GLM-5.3 License MaaS 营收阈值 $10B vs $100B 信源不一致, 已按多数源取 $10B 并标注 uncertain)

## [2026-08-31] synthesis | arxiv-daily (2026-08-31)
- Summary: wiki/synthesis/2026-08-31/arxiv-daily.md — arXiv daily digest over the fresh Mon Aug 31, 2026 wave (IDs ~2608.27460–28589; top listed ID ~2608.28589). Unlike 08-30 siblings (blocked), direct arxiv.org list/abs pages were reachable this session. 324 unique new IDs parsed; 13 featured across 5 categories + 4 honorable mentions, all grep-verified absent from wiki/ beyond dedup boundary 2608.27455.
- Feat: Feature Interaction & Multimodal Rec (HubMixer latent-hub feature interaction 2608.27991, Kuaishou A/B +5.48% resume-submission conv; AMUR information-guided selective modality alignment 2608.27950, CIKM'26); Advertising/CTR/E-commerce (Offline Model-Based RL for incentivized advertising, MB-IQL +7.96% per-user net profit 2608.28065; GRPO-fine-tuned autobidders 2608.28199; survival models for grocery repurchase, Amazon/RecSys'26, k≈0.9 decreasing marginal hazard 2608.28393); LLM Training/RL/Distillation (RA-OPD reward-align trajectory filtering 2608.27960; VISTA verifier-informed student-to-teacher OPSD 2608.28306; SpikeOPD stable ANN→SNN on-policy KD 2608.27857; OpenEuroLLM LR/batch-scaling + annealing transfer laws 2608.28308); Program Learning (PLVR symbolic backpropagation for post-training 2608.28421); Games/World Models/Agents (WM-R1 world-model-as-environment GUI RL 2608.27508; prior-directed exploration for searchless chess 2608.27757; ITER agent-interaction-aware retrieval +13.5% 2608.27912)
- Honorable mentions: Cross-city POI on Trip World (2608.27840), PMFRec federated cold-start rec (2608.27826), AcrossVAM particle world modeling (2608.28491), String agentic OS + SFMD (2608.28027), Dailymotion contextual video matching (2608.28359)
- Updated: wiki/index.md (Synthesis table new arxiv-daily 2026-08-31 entry, 顶部插入)
- New pages: wiki/synthesis/2026-08-31/arxiv-daily.md
- Contradictions: none

## [2026-08-31] synthesis | arxiv-ai-search (2026-08-31)
- Summary: wiki/synthesis/2026-08-31/arxiv-ai-search.md — complementary deeper pass over the fresh Mon Aug 31, 2026 wave (IDs ~2608.27460–28589; direct arxiv.org list/abs/html pages reachable this session). 718 unique IDs parsed across 14 categories (cs.AI/LG/CL/IR/GT/MA/CV/SE/NE/SY + stat.ML/cs.HC/econ.GN/cs.CY); 423 in-wave fresh candidates beyond dedup boundary 2608.27455; 19 featured papers across 7 categories + 5 honorable mentions, all IDs grep-verified absent from wiki/ and NOT claimed by the same-day arxiv-daily (which absorbed 13 featured + 5 HM of the wave).
- Feat: Rec/IR/Search (SG-UMP sequence-guided universal multimodal prioritization MM'26 2608.28503; TiGER versioned timestamp-aware unified graph ANN +5× QPS 2608.27663; Competitor-Aware GEO combinatorial BOCS→LLM Capital One 2608.27631; GeBDA damage assessment as text-based sequence prediction ETH-tentative 2608.28567); Ads/Creative/E-commerce (CommerceVibe e-commerce creatives as executable HTML/CSS + dual-feedback RL Alibaba-inferred 94.0/100 2608.27893; LandingAgent reference-annotated landing-page agent SNU/Samsung-inferred 2608.27902); LLM Decoding/Efficiency (Trajectory-Level Speculative Decoding for dLLMs Li Auto +7–14× 2608.27514; Thinking Costs Tokens RBC budget-crossover p≤0.001 2608.27506; Request & Token Energy Costs for LLM Inference CMU IISWC'26 2608.28044); Sequential/Attention (Approximation Rank of Softmax Attention NTU/CMU 2608.28150; Real-Valued Hyperdimensional Sequence Representations 2608.28334); LLM Post-training/Distillation Reliability (Below the Noise Floor: bimodal seed collapse in small-model KD BRAC 2608.27729); Games/Game Balance (Where Does Balance Break? budget-aware boundary discovery ASE'26 Ritsumeikan 2608.28364; Refundable Deposits restore cooperation in finitely repeated games EPFL/LSE/CUNEF 2608.27536; Qwen-GuidePlay-2B staged small dialogue-game agent City/Turing 57.12 2608.27672; Acquire, Repair, Preserve diagnosis-guided post-training Utrecht 2608.28458); World Models/Agents (Code as Worlds executable world representations Tsinghua/PKU/NTU 2608.27549; GeoNeXt video-gen priors as geometry learner Surrey/Imperial 2608.28549; GOD agent-society local-first control room EMNLP'26 System Demo 2608.27992)
- Honorable mentions: RetailAgent structured adverse timing in LLM trading (2608.28399), Korea education-competition & low fertility econ.GN (2608.27980), Visual Token Coding for video MLLMs (2608.28008), Cross-Session Decomposition Attacks + intent-aligned retrieval defense (2608.27945), copper-surface appearance forecasting as PBR materials (2608.28102)
- Updated: wiki/index.md (Synthesis table new arxiv-ai-search 2026-08-31 entry, adjacent to same-day arxiv-daily)
- New pages: wiki/synthesis/2026-08-31/arxiv-ai-search.md
- Contradictions: none (all 19 + 5 IDs grep-verified absent; cross-checked against same-day arxiv-daily claimed set: 2608.27950/27960/27991/28065/28199/28393/28306/28308/27857/28421/27508/27757/27912/27840/27826/28491/28027/28359)
- Notes: GOD entry added post-shortlist via live abs-page fetch (initial candidates file omitted it) — provenance flagged in §6 methodology; section ② count and 7.3 numbering adjusted accordingly.

## [2026-08-31] synthesis | tech-report-daily (2026-08-31)
- Summary: wiki/synthesis/2026-08-31/tech-report-digest.md — 19 家目标机构最新 LLM 技术报告/系统卡综合摘要（中文+英文标题、机构、模型系列、发布日、核心参数、创新点、arXiv/链接），聚焦 2026 尤其 7–8 月；本窗口（08-30→08-31）无实质新发布，为全量重述 + 信源/规格强化。
- Companies covered: DeepSeek (V4 Pro/Flash GA + Vision-Exp 08-21 + pre-IPO ~$74B SCMP 08-26), OpenAI (GPT-5.6 Sol/Terra/Luna August + Pacing 08-18), Meta (Muse Glimmer 30B Apache 2.0 DFlash, Llama 4 405B 仍悬置), Google (Gemini 3.5 Audio Model Card 08-26 Live Translate 128K/Transcribe 96K + 3.7 Flash GA 08-13 + Omni Flash 08-27), Anthropic (Opus 5 07-24 + Fable 5/Mythos 5 ASL-3 + Sonnet 5 $2/$10 转永久定价 08-10), Mistral (Shieldstral 3B Apache 2.0 08-04 + Small 4), Qwen (3.8-Flash 多模态 262K→1M 训练成本 1/9 + Flash-Next Gated DeltaNet Qwen4 预览 + Max 2.4T/95B 权重 08-12), Microsoft (MAI-Thinking-1 1T/35B hill-climbing RL from-scratch 08-12 + Phi-4-rv-15B), NVIDIA (Nemotron 3 Ultra 550B/55B hybrid Mamba-Attention 技术报告 06-09 + 3 Super), xAI (Grok 4.6 Model Card 08-12, Grok 5 训练中 6T/10T 仍延后), Amazon (Nova 2 Lite/Pro/Omni/Sonic 1M ctx 无实质新报告), Zhipu (GLM-5.3 权重 08-28 开源自定义 License $10B 阈值 + Flash 08-26 320B/18B 首 GLM-5 原生多模态 Hybrid Sparse+Linear+mHC), Moonshot (Kimi K3 2.8T/104B 规格补全: 93层=69 KDA+24 Gated MLA+1 dense, 896 ex top-16+2 shared, MoonViT-V2 401M, MXFP4/8), StepFun (Step3 321B/38B MFA+AFD), ByteDance (SeedRealtime 08-05 音视频全双工 + Seed2.1), Baichuan (M4 tech report 06-09 补全 arXiv:2606.08982 HealthBench 68.6 第一 hallucination 3.3% + M3-235B SPAR/Fact-Aware RL arXiv:2602.06570), InternLM (S2-Preview 35B-A3B task scaling 08-17 从 Qwen3.5 续训 + S1-Pro 1T 科学 arXiv:2603.25040), 01.AI (Yi-Lightning, 2026 无新旗舰), Apple (AFM 3 五模型 06-08)
- Today's delta (vs 08-30): 本窗口无实质新发布；强化——Moonshot K3 精确规格（README + arXiv:2607.24653）、InternLM S2-Preview 35B-A3B 确认 + S1-Pro 双轨、Baichuan M4/M3 技术报告与 SPAR/Fact-Aware RL 方法细节补全；Grok 5 与 Llama 4 405B 仍悬置
- Key trends: (1) 线性/混合线性注意力商品化 (Flash-Next Gated DeltaNet + GLM-Flash Sparse+Linear + K3 KDA + Nemotron Mamba); (2) MoE 稀疏激活绝对主流 (1/20~1/30); (3) 后训练/测试时 Scaling 全面接管增量 (GLM-5.3 同基座全后训练); (4) 多模态 Flash 化低成本原生多模态; (5) 安全监管"文档即产品"阶段 (GLM License 营收阈值 + OpenAI Pacing + ASL-3); (6) 垂直领域模型成新报告载体 (医疗/科学/音视频/安全分类器); (7) 开放权重许可双轨分化; (8) 中国发布窗口纪律分化 (Kimi/GLM 兑现 vs Grok 5/Meta 405B 延后); (9) 效率=系统工程; (10) 万亿级科学/医疗特化 (Intern-S1-Pro 1T + Baichuan-M4)
- Updated: wiki/index.md (Synthesis table new tech-report-digest 2026-08-31 entry, 顶部 08-31 批次内插入)
- New pages: wiki/synthesis/2026-08-31/tech-report-digest.md
- Contradictions: none (注: GLM-5.3 License MaaS 营收阈值 $10B vs $100B 信源不一致, 按多数源取 $10B 并标注 medium confidence/uncertain)

## [2026-08-31] synthesis | investment-daily (2026-08-31)
- Summary: wiki/synthesis/2026-08-31/investment-daily.md — 投资日报（美股/港股/A股科技与AI热点）。数据口径：美股 = 2026-08-28（周五）完整收盘；港股/A股 = 8/28 完整收盘 + 8/31 周一早盘/开盘；中概 ADR 个股 = 8/27 最近确认值（8/28-31 pending）。全篇中文，附 ⚠️ 免责声明与多源交叉。
- 核心事件：①Fed Warsh 杰克逊霍尔首秀放鹰（12M PCE 3.7%/6M 4.1%，9月加息概率 ~35%→57.5%，2Y +11.8bp 至 4.348%）→ 美股 8/28 收跌（S&P -0.25% 7,711.76 / Nasdaq -0.52% 26,402.42 / Dow -0.02% 53,559.99，全周收跌，面对 9/4 非农 9/11 CPI 9/15-16 FOMC）；②周末美军空袭伊朗拉腊克岛 + 伊朗导弹回击驻约旦美军 → 周一 WTI 破 $85/布油破 $90、黄金冲高回落（现货破 $4,460 后转跌）、美股期货走低，摩根士丹利上修布油至 Q4 近 $100；③中国 8 月官方制造业 PMI 49.8（+0.6pct，新订单 50.6 +2.1pct 改善，续低于荣枯线）；④英伟达链：HBM 采购承诺 $1,190 亿→$2,790 亿（短缺至 2028），Rosenblatt PT $390（乐观 $550），NVDA 8/28 -3.4% ~$220，MRVL -10.6%（"确认非催化"），SOXX -3.2%、SMH 全周 -3%；⑤AI 模型中国竞赛：腾讯混元 Hy4 preview 开源（770B-A49B/1M ctx/盲测 2.99 超 GLM-5.3 2.92 与 Kimi K3 2.94，¥6/¥18 per M tokens）+ 智谱 GLM-5.3 权重开源（744B-A40B，营收阈值 $10B License）；⑥阿里 800 亿港元配售收官（HK$112.70、7.1 亿股、净额 797 亿 100% 投全栈 AI，超购 ~3×，主权/长线 40%+）；⑦9/1 多事件日前瞻：SHEIN（00625.HK）定价 HK$48.56/估值 $270 亿挂牌（基石腾讯 $5,000 万等 3.83 亿美元）+ 百度双重主要上市生效（最快 9/7 港股通）+ 蔚来 Q2 财报 + 新势力 8 月交付；⑧人形机器人量产元年：Tesla Optimus 弗里蒙特产线投产（S/X 线 46 天拆改，年产能目标 100 万台，供应商 9 月 1,000 台/周→年底 2,000-2,500 台/周），Figure 350 台，软银 $60 亿购 1X 60%，宇树 R1 ¥26,900。
- A股：8/28 算力获利回吐（科创50 -1.85%、半导体 -1.62%/净流出 108 亿）但光模块龙头逆势（中际旭创 +3.70%、新易盛 +6.06%，寒武纪重回千元 1,029.53）；8/31 低开（沪指 -0.65% 3,926.53/创业 -1.67% 3,367.04/科创50 -2.34% 1,623.2），房地产服务 20cm 涨停潮（特发服务）、油气/转基因逆势，贵金属（盛达资源、湖南白银触及跌停）/算力硬件/半导体低迷；中金维持 AI 算力主线（国产 + 海外双轮）。
- 港股：8/28 恒指 +0.07% 25,584.79/恒生科技 -0.33%（成交 2,312 亿）；8/31 低开 10:00 恒生科技 -1.22%/恒生互联网 -1.10%；腾讯 +1.65%（Hy4）、小米 +1.24%、智谱 -6.03%（利好兑现）、阿里 -1.39%、京东 -1.43%；天数智芯入恒生科技（首个 GPU 成分股）；8/28 铜业股狂欢（兴业合金 +15.9%）。
- 中概/EV：NIO/理想/小鹏/比亚迪 9/1 交付窗口 + 蔚来 Q2 财报（Q2 交付 107,658 +49.4%，6 月 40,597 +62.9%）；理想 Q2 净亏 17.05 亿、9/2 新 MEGA/9 月中旬 i9；小鹏机器人子公司 $900M（$63 亿投后）；比亚迪 7 月海外 18.05 万辆 +124%；阿里云外部 +45%、AI 产品 12 季三位数增长。
- 本周日历：9/1 SHEIN 挂牌+百度双重上市+蔚来 Q2+新势力交付+财新 PMI；9/2 Broadcom 财报；9/4 美国非农；9/7 华为发布会；9/10 苹果发布会；9/11 CPI；9/15-16 FOMC。
...
## [2026-08-29] synthesis | arxiv-daily (2026-08-29)
- Summary: wiki/synthesis/2026-08-29/arxiv-daily.md — 补漏 gap-fill 版 arXiv 日报（Fri Aug 28 wave，IDs ~2608.26194–27456；周六无新 mailing，直接 curl arxiv.org abs 页可用）。16 篇均 grep-verified 不在 wiki（排除 08-29 game-rl-daily 的 R2M-Bench/Magpie/Blindfolded/出发 Robbins' Problem 2608.27328/27168/27347/27419 与 08-30 arxiv-daily 已收录的 6 篇）。
- LLM Training/Continual Learning: Thomson (2608.27147, Thomson Reuters 开源权重, SovereignAI 命题, π-shaped 能力提升/近零遗忘); Stochastic Estimation of Transduced LMs (2608.27428, ETH/JHU, 无偏 beam-summing, 概率 1 停机).
- Agents: ASIL (2608.26991, 结构化 JSON 状态+语义动作替换 screenshot-and-click, >80 strict success, Qwen3.5-2B 58.0→74.4); SARA (2608.27146, action-induction/authorization 分离, AgentDojo/AgentDyn ASR ≤0.63%); DSA (2608.26990, 多市场股票研究证据感知编排, 1,457 端口化后端契约测试, 诚实评估立场); TransMeme (2608.27127, 跨文化 meme multi-agent, human eval +33.1%); TraceBench (2608.27182, 受控时间序列根因归因基准).
- World Models/Visual Pretraining: LeVJEPA (2608.27395, Meta FAIR, SIGReg 无坍缩视频预训练, 5.6–20.8× 计算节省, block-causal 无成本); UrbanGround (2608.27456, 香港实尺度 3D 城市沙箱, 局部能力不组合为持续目标导向行为); Visual Retrieval Heads (2608.27417, KAIST, 掩码 top-20 heads → 定位 −80pp, 跨 backbone 迁移).
- Retrieval/IR: STeReO (2608.26194, 语音+文本异构 retriever 重排); CorporateBench (2608.27391, Cornell, 230K+ 文档时变 KB Q&A 基准, 输入规模增长性能锐降); BrailleBench (2608.27268, VT, 盲文多准则理解基准, Grade 2 输入脆弱); Tabular attention head importance scoring (2608.27241, 72.5% head-drop 鲁棒).
- Games/Governance: Simultaneous EF1+EQ1 (2608.26410, RPI, binary chores EFX+EQX 任意 agent 数); Risks and Controls for MAS (2608.26626, Australian AI Safety Institute, 三档治理：singular/federated/open, 集体行动缺口).
...
## [2026-09-05] synthesis | arxiv-daily (2026-09-05)
- Summary: wiki/synthesis/2026-09-05/arxiv-daily.md — arXiv 每日精选（Fri 4 Sep 2026 mailing，覆盖 cs.IR/cs.LG/cs.CL/cs.AI/cs.GT/cs.MA），18 篇论文，5 大板块。arXiv API 仍被限流（HTTP 429），改为抓取 arxiv.org list/recent 页面 + /abs/ + /html/ 页面；所有入选 ID 均已 grep 验证不存在于 09-01→09-04 的兄弟 digest。
- LLMs (7): Uno (2609.04010, diffusion-augmented AR LLM，AR 权重 + 轻量 diffusion 头解耦 + Ψ-Spec 采样族，无需 draft model，最高 3× 吞吐，8B 优于 26B DiffusionGemma 与 Mercury 2)；Minima (2609.04098, Qwen3.8-27B Gated DeltaNet NVFP4 W4A4 全线性层量化，四部分机制解释——块缩放定位离群/门控最不敏感/delta 规则遗忘噪声/逐 token 量化成本被上下文稀释，"混合 LLM 的循环半边是易量化半边")；Sequential Beats Joint (2609.04108, OPD-then-RL 两阶段优于所有联合融合——OPD 扩覆盖、RL 锐化，OPD val 分数作切换信号)；SIGNBALANCE (2609.04063, GRPO 优势估计奖励"蒙对答案"的 spurious advantage，composition-free 幅度，按类 stop-gradient 再平衡)；Random Attention (2609.03430, KV eviction 的选择信号近乎 placebo，逐头均匀随机驱逐匹配最强 evictor 且 vLLM 吞吐 +32-43%，prompt 是脆弱部分 + 推理痕迹两级冗余自保)；Spurious CoT Termination (2609.03633, 注入 EoT/response 不保证 reasoning→answering 转换，EA B 注意偏置修复，EMNLP'26)；RecurTrace (2609.03379, 循环层沿 loop-time 轴回看自己历史状态 + oracle 监督 halting head，匹配计算量 +2.2 pts，规模化收益递增)。
- Recommendation (4): SelfDR (2609.03313, 同一 base LLM 内 reasoner teacher→直接推荐 student 自蒸馏 + 动态权重，CIKM'26)；EPIC (2609.03522, SID 扩散去噪中引入显式 item 级 posterior 竞争，冻结骨干零额外 decoder pass)；HypRQ-VAE (2609.03369, 首个双曲空间 item indexing，指数体积扩张契合幂律长尾，ICDM'26)；MGDiff (2609.01619, masking GNN 引导的多兴趣扩散 + popularity-aware guidance 去流行偏置)。
- CTR & Advertising (2): UniCon (2609.03290, Meituan 统一 context-centric CTR——request context 为基本建模单元，intra-context 局部耦合 + inter-context 状态演化，离线 AUC +0.0139、线上 +3.09% RPM / +2.07% CTR / +2.95% 收入，呼应 ReST 等工业 sequence/context 扩展主线)；meCPM (2609.01628, eBay 边际 eCPM 统一固定价/拍卖/ABIN 排序，线上 A/B 收入与用户体验双升并全量部署)。
- Sequential/Time-Series (1): RATL (2609.03937, 把检索对象从历史目标值换成 base-model 专属的历史预测残差，train-only memory + set-aware router + 因果可用性约束，提升冻结基座预测器并可跨骨干迁移)。
- Games & RL (4): Turn-Based Combat Arena (2609.03122, 可配置回合制策略游戏 RL 框架，单机万级 games/s，balancing-as-optimization 多方法收敛一致)；LLM-Guided RL NPCs (2609.02931, Mistral-7B 每 5 秒读取战局打战术标签、POV 之上做运行时策略切换，胜率 11→24% 但 83.8% 选择 Surround——零样本策略分化有限，Heriot-Watt)；Mean-Field RL representations (2609.02928, 人口仅通过未知低维聚合统计量影响环境，可证明的离线方法学低维表示，供应链单步路由博弈中改进 reward 预测与 Nash gap)；PokaiTrainer (2608.29197, belief-state 贝叶斯矩阵博弈搜索扩展到同时行动/高随机/隐藏信息的 VGC，Rust 引擎 ~99% Showdown 位价，真人 ~1320 Elo 59% 胜率，峰值进 format top-500)。
- 方法: 本轮直接抓取 arXiv list/recent 页面（cs.IR/cs.LG/cs.CL/cs.AI/cs.GT/cs.MA）解析条目，再逐个抓 /abs/ 页取标题/作者/摘要/comments，并抓 /html/ 页提取作者 affiliation（ltx_affiliation_institution）以补全机构。
- Updated: wiki/index.md（Synthesis 表顶部新增 arxiv-daily 2026-09-05 条目；含主题摘要 + tags）
- New pages: wiki/synthesis/2026-09-05/arxiv-daily.md
- Contradictions: none（部分条目机构/公司为 opencode-compiled 推断，已注明需以 /html/ 页或论文原文核实）

## [2026-09-05] synthesis | arxiv-ai-search (2026-09-05)
- Summary: wiki/synthesis/2026-09-05/arxiv-ai-search.md — arXiv AI Research Paper Search Report（Fri 4 Sep 2026 mailing，覆盖 cs.IR/cs.CL/cs.AI/cs.GT/cs.MA 的 list/new 页面，arXiv API 仍限流 HTTP 429）。与同日 arxiv-daily 互补去重：18 篇已在 arxiv-daily 收录（Uno/Minima/Sequential Beats Joint/SIGNBALANCE/Random Attention/Spurious CoT/RecurTrace/SelfDR/EPIC/HypRQ-VAE/MGDiff/UniCon/meCPM/RATL/BCT Arena/LLM-Guided RL NPCs/Mean-Field RL）不再重复收录，改为交叉引用。约 300+ 条目筛选。
- LLMs (9): DRACO (2609.04094, IBM, 动态 rubrics + 闭式逐步 advantage 分配，AppWorld +15.9/+5.3)；Rethinking OPD II (2609.04172, Tsinghua, 单样例恢复全量 OPD 大部分增益，"data-overfed but algorithm-starved")；AdaptiveSpec (2609.02897, Cambridge, margin 规则 + 渐近 tree 策略，SGLang 上较 EAGLE-3 +56% 吞吐)；SGD-KV (2609.03235, Amazon, chunk-summarization 诊断任务定位聚合头，1M ctx 下 KV −75%)；GrowPage (2609.03494, 按需 KV 预算 + 双时间尺度查询摘要)；InertiaKV (2609.03515, EMNLP'26, EMA 时间聚合>>打分器选择，score-free 解码)；Free Pause Tokens (2609.03807, MSR-affiliated, 权重共享并行流 +2-3 centinats, ×1.14)；Jina-OCR-v1 (2609.03181, Jina AI, FastMTP 投机解码 + dense verifiable-reward GRPO, 91.14 OmniDocBench)；Contamination Inflates Scores (2609.02899, Stanford/CityU-Macau, paraphrase 差分检验，leaderboard 重排 r=0.997)。
- Recommendation (2): LLM4AIGQ (2609.03674, 兴趣细分 AIGQ 生成 + SFT/RL/DPO 多级奖励, 近线生成在线读取)；DoPR (2609.03311, SJTU, 压缩 doc prefix 复用, 8× 延迟降 97-99.5% NDCG)。
- CTR & Advertising (2): Xiaomi-TabLDM (2609.03880, Xiaomi, 表格基础模型 OpenML-CTR23 第一, 训练时间 −82%)；广告专项本周无新增, 指向 arxiv-daily 的 meCPM/UniCon。
- Sequential/Time-Series (2): OOD seq-model offline MARL (2609.03667, InstaDeep, 任务多样性>数据量, 3.2×)；Lngram v2 (2609.03426, BUPT, 可解释离散隐 n-gram 记忆至 30B)。
- Games & RL (3): LUGL (2609.03660, 局部更新+LightGBM 全局学习, 9 个游戏优于 DQN/DeepCFR)；Robust PAC CSGs (2609.04189, 首个月度 PAC 框架 + NE 存在性证书)；HOOD (2609.04113, 高阶乐观 O(N³log²K) 常数 regret)。
- Agents & Agentic RL (9): SMC (2609.03236, USC, 投机宏提交, τ²-Bench −18.6%/AppWorld −44.9%)；PlanFence (2609.03340, Purdue, 依赖域 stale-plan 校验)；CONFLICTGUARD (2609.03438, SJTU, 冲突感知终止)；KC-Bench (2609.03588, 动态知识冲突基准)；Environment Evolution (2609.04128, Fudan, 环境课程 Terminal-Bench 2.1 +14.4/+18.0)；Terminal-Universe (2609.04148, Alibaba/Qwen, 轨迹→环境重建 37.3k)；RL-ADA (2609.02902, world feedback 对抗式对话 RL)；TAHI (2609.04141, CMU, 跨会话人机交互测试时适应)；HARNESSEVO (2609.02889, slot 级 harness 贡献归因, budget-splitting trap)。
- Safety/Alignment (5): Narrative Captivity (2609.03407, 5,078 场景 +25pts, EMNLP'26 Findings)；IndicSafeEval (2609.03781, IIT Patna, 印度语劝导 jailbreak 7,200 prompts)；Emergent cheating/whistleblowing 研究蜂群 (2609.04170, DeepMind, 100-agent)；Deceptive outputs→mechanisms (2609.04166, 因果框架)；Epistemic Warrant (2609.04127, 4-tier reliance certificate)。
- 方法: arXiv API 限流 → 直接抓 list/new 页面解析（cs.IR/cs.CL/cs.AI/cs.GT/cs.MA）；机构多为作者侧已知隶属推断（tentative 标注），部分条目为 "—"。
...
## [2026-09-06] synthesis | investment-daily (2026-09-06) 周末版
- Summary: wiki/synthesis/2026-09-06/investment-daily.md — 投资日报（周末版：9/6 周末消息面 + 9/4 收盘基准 + 下周 9/7-9/12 前瞻；美股 9/7 Labor Day 休市，A 股/港股 9/7 正常交易）。宏观：非农 +162k → 9 月加息概率 ~57-60%，10Y 4.78%（19 个月新高）；**周末美伊冲突升级（美袭 3 艘伊朗油轮）→ 布伦特 ~$96.28** 成下周最大单一变量；BTC 周末 ~$79,900 缩量整理（ETF 两日净流入 +$905M，IBIT 占 $571M）；9/11 CPI、9/15-16 FOMC。美股：芯片周强势（纳指周 +4%、SOX 9/4 +3.37%、存储 SNDK 周 +17.2%）；NVIDIA $12.93B 收购 Hugging Face（2027H1，Needham BUY PT$300，市值 $5.24T）；Broadcom AI FY26 $58B/FY27 $115B/FY28 $230B 指引上调、Anthropic 成最大 XPU 客户（5GW）；Apple 9/9「Surprise and Shine」Ternus 首秀（折叠 iPhone Ultra 日产仅数百台/Nikkei）；Dell FY27 指引营收 $192B；Oracle 9/10 盘后财报（RPO $638B+363% 核心验证）；Micron HBM 产能年底前翻倍；三星-Arm 2nm 合作；TSLA -5.92%（Cybercab 得州 45 辆 vs Waymo 988 辆）。港股：空头大撤退（阿里卖空 -91%、腾讯 -52%、智谱/MiniMax -60-80%）、腾讯南向 4 日净买 21.61 亿；恒生科技 YTD -16 内部分化；腾讯 Q2 FCF -¥138 亿（2005 年来首次转负）、阿里 FCF 净流出 ¥446.7 亿——AI capex「重资产化」定价；希音-W 9/14 收市后快速纳入恒生综合指数（9/15 生效）、9/4 -9.19% 续创新低；康方生物 HARMONi-2 阳性 +11.45%。A 股：周末密集利好——彭博 DeepSeek 乌兰察布 1GW 智算中心 ≥16 万颗昇腾 950DT（~$2.56B≈¥180 亿+，占年产 ~40%）国产算力链最大催化；华为麒麟 2026 韬定律（晶体管密度 2.38 亿/mm² +55%、NPU 功耗 -66%）+ 9/7 14:30 Mate XT 2/HarmonyOS 7、小米 19:00、苹果 9/9（折叠屏三连发）；财联社独家储能产能全面摸底未开工暂缓审批（利好宁德时代）+ 铜箔 40 万吨协议 + 钠电 9 月交付；GPT-6 Astra → 9/4 A 股硬件跌应用涨（浪潮信息跌停 -127 亿）；机构（国信第二波或 Q4/中泰 9 月中下旬启动/方正 9 月可积极/光大区间震荡/中信硬件软件再平衡）。中概：金龙 -0.81%；BABA FY27Q1 AI 云 +45%（¥484.37 亿）、capex ¥676.78 亿（+75%）、净利 -75%、配售 800 亿港元补弹药。新能源：8 月交付——比亚迪 43.3 万（海外 18.8 万新高）、零跑 10.31 万（+80.7%）、小鹏 3.91、理想 3.77（+32.1% MEGA 9/2 上市）、极氪 3.70（+109.8% 新高）、蔚来 3.58、小米 3 万+、鸿蒙智行 4.21；"蔚小理"港股市值集体跌破千亿；乘联会 8 月新能源批发 151 万辆（+16%）。AI 主题：Grok 4.7（9/12、2.1T+SpaceX 补充训练）倒计时；OpenAI/Anthropic 万亿 IPO 筹备；NVIDIA「循环融资」>$500B 平台争议（FCF 环比 -56% 是唯一看空切口）；AI 电力缺口 2027 预警。下周日程：9/7 Labor Day 休市/华为小米发布会、9/8 ISM+复市、9/9 苹果、9/10 PPI+Oracle+ECB、9/11 CPI、9/12 Grok 4.7、9/14 希音纳入、9/15-16 FOMC。风险：9/11 CPI、美伊油价向 $100、TSLA $358 破位、阿里/腾讯 ROI 无法兑现、华为/小米发布会落地 sell-the-news、希音纳入被动抛售。
- Updated: wiki/index.md（Synthesis 表顶部新增 investment-daily 2026-09-06 条目 + 主题摘要 + tags）
- New pages: wiki/synthesis/2026-09-06/investment-daily.md
- Contradictions: none（恒指/A 股/美的数据为 9/4 收盘基准、周末无新交易；DeepSeek 昇腾 16 万颗订单为彭博媒体报道、未获官方公告，文中明确标注"媒体、未官方公告"属性；Sil 注：多源数据交叉核对以多数来源为准，引用与 09-05 稿一致）

## [2026-09-06] synthesis | arxiv-daily (2026-09-06)
- Summary: wiki/synthesis/2026-09-06/arxiv-daily.md — arXiv 每日精选（周末无新 mailing → 深挖 Fri 4 Sep 2026 邮件剩余，覆盖 cs.IR/cs.LG/cs.AI/cs.CL/cs.GT/cs.MA），22 篇论文，5 大板块。所有入选 ID 均 grep 验证不存在于 09-01→09-05 的兄弟 digest（arxiv-daily/arxiv-ai-search/game-rl-daily 去重）。arXiv API 仍限流（HTTP 429）→ 直接抓 list/recent 页面 + /abs/ 页面取标题/作者/学科/摘要。
- LLMs (8): TIGPO (2609.03383, 跨 policy update 持久任务图，Exploration/Revisit 槽位 + 交叉时域参照组稳定相对优势，历史仅作 detached 统计参照不重放，ALFWorld/WebShop 优于组式/图式方法)；Headroom-Drift Replay (2609.03941, GRPO replay 控制原语——Headroom 按学习价值排序 + Drift 按策略兼容性门控，无辅助生成/训练装置，数学/多模态/Agentic Search 一致优于 naive replay)；VestigeKV (2609.03949, 把 NoPE-MLA 缓存中 RoPE vestige（64-dim 解耦分支）再利用为 query-independent salience 信号，只读每行 11%，Kimi Linear 8k-65k 检索 8×=1.00 / 32×=0.92，32× 时 attended tier 0.25KB/8.1KB，recall tier 128×=1.00；同名操作在 RoPE MLA 上塌缩至 0.08，query-universal 精确合并 RoPE 下可证不可行)；Hardware-Aware FP4 FlashAttention-4 (2609.04105, Direct-P 非因果直接 score→FP4 概率，GB200 上 2.13× BF16 前向；因果路径由保存量化 Q/K 重建概率 + FP8 梯度操作数，8B 单卡更新 1.14×；匹配分布式保留 FP8，所有 MXFP4 概率/值训练轨迹发散)；NVIDIA Post-Training for Gold-Medal Coding (2609.02849, 22k 题 + 合成推理迹 + SFT/RL，Nano-CC 30B-A3B / Ultra-CC 550B-A55B，GenCorrect 反馈式测试时计算；IOI 2025 130→291→468 超金线 438.3、Ultra-CC 502；IOI 2026 前瞻性受限评测 535.4 > 人类冠军 498.27——首个超越最高分人类选手的 AI)；Legibility is Not Interpretability (2609.04194, COLM'26, Monte Carlo rollout advantage 定义步优先级，LLM judge 超 prevalence 基线但低于 noise ceiling——可读性≠可解释性)；Clean Engineering Unstable Measurement (2609.04198, 两次预注册审计 52,988 请求，共享端点同窗 Spearman 0.400 vs 0.90 门槛、次日字节一致重放 0.78 vs 0.99，3 机制 + 4 提供商共享下限 0.74-0.88，输出 snapshot-identity 三层阶梯 + 8 条设计规则)；Codebook Agent (2609.02264, 发现拓扑过滤后收敛 ~6 种 + edge count 与 token 消耗负相关 r≈-0.4 + profile 共享导致 adjacency-invariant，VQ 16-entry codebook + reward-weighted MLP + 展平邻接 rerank，6 基准最准 84.6 vs 83.0，2.4ms 出拓扑，token −21.9-33.2%)。
- Recommendation (8): DS-Frame Slow/Fast Thinkers (2609.02671, 快系统 + 迭代隐式精炼慢系统 + 可控计算预算学习选择器，5 真实数据集，长历史/非主流 item 组增益更大)；SPAR (2609.02062, 工业级生成式 POI——SI-SID 经纬度正弦嵌入融合语义生成地理一致性 SID，MG-CPT 25 地理数据集三级持续预训练，TV-SFT 冻结任务向量防灾难遗忘，两公开 + 四工业数据集验证)；GenCAR (2609.02162, 形式化 α-VCR 问题，稳定偏好表征 + 环境干预，LLM 反事实候选经 preference anchor + trust-radius 落地，conformal p 值 + BH 选集，可证有限样本经验无关 FDR 控制)；OrthoRec (2609.02152, ACM-MM'26, CGOP 协作引导正交净化切断欺骗性模态噪声 + TAR-MoE 解耦 sigmoid 门控破零和瓶颈 + safe-SSL，3 Amazon 数据集鲁棒性更优)；Training seeds & model-selection stability (2609.02499, RecSys'26 R&P, 固定数据划分变 seed，三层面分析，单 seed 报告会夸大评估稳定性)；RecEvolve (2609.01622, 生产 Two-Tower 上闭环自主研究 agent，40+ 次自主训练 → NDCG ~+20% → 线上 +3.77% 满意度，并自主发现 reward hacking 暴露评估协议脆弱)；Utility of LLMs in RS Explanation Evaluation (2609.01627, RecSys'26, 18 原型×14 LLM×2 温度 vs 人类评分，中等秩相关但绝对一致性低、随模型规模/构念漂移，4 条实操建议)；SkillDreamer (2609.01642, 前置"想象"生成 pseudo-skill 桥接客观目标型查询与执行型技能，破解 Query-Skill Misalignment，SkillRet/SkillUsage 提升且跨检索模型/管线泛化)。
- CTR & Advertising (1): CRAFT (2609.01655, KDDCUP'26 WS, "feature interaction→feature transport" 视角重构统一推荐，Contextual Residual Adaptive Feature Transport block 使上下文成为表征演化的主动控制器，TAAC2026 测试 AUC 0.838090 超榜一 0.83798，6 层堆叠 0.838148 / 加宽 0.838106)。
- Sequential/Time-Series (1): TraveL (2609.03427, 路径+起始时间编码为分布表征，regional attention 编码区域路段相关性，K-S 检验对比采样行为与真值，旅行时间分布 Mean K-S +14.7% / 路径相似 MAE +16.7% / 目的地预测 +3.97%)。
- Games & Game Theory & MAS (5): Otter (2609.03474, cs.GT, 双资产批量 AMM——surplus redistribution 范式把残余盈余重定向社区合约防 MEV 捕获，用户/构建者主导策略诚实，审查抗性必要性的不可行性定理)；EF1-Constrained Nash Social Welfare (2609.03846, 强 NP-complete；均匀偏好下任意 EF1 分配 NSW 最优 / ε-small-item 下 ρ_n(ε)=1−O(ε²)，PriorityNet PPO + 前瞻 EF1 action masking 按构造保证前缀级 EF1，离线 0.9911 / 在线 0.9701 归一化 NSW)；EpisodeSim (2609.01167, cs.MA, classic-AI 结构以自然语言控制状态形式被 LLM 解释——World Master 维护共享现实/场景/义务/收敛，定性消融："fluency 供局部纹理、脚手架组织时间")；Collective creativity in hybrid societies (2609.02620, 区分 novelty(单品) 与 diversity(群体)，AI 助产抬高个体新颖性但收窄总体多样性，人机互补搜索使混合群体更优更广，关键在混合构成)。
- 方法: 周末无新 mailing → 深挖 Fri 4 Sep 2026 邮件剩余；直接抓取 arXiv list/recent 页面（cs.IR/cs.LG/cs.AI/cs.CL/cs.GT/cs.MA）解析条目，再逐个抓 /abs/ 页取标题/作者/学科/摘要；所有入选 ID 均 grep 验证 0 hits。机构/团队多为作者侧已知隶属推断（opencode-compiled 标注，需以 /html/ 页或论文原文核实）；个别较早提交日（20/28 Jul、7/20 Aug）说明 cs.IR recent 聚合了重新公告/交叉挂载条目，已在文中逐个注明。
- Updated: wiki/index.md（Synthesis 表顶部新增 arxiv-daily 2026-09-06 条目 + 主题摘要 + tags）
- New pages: wiki/synthesis/2026-09-06/arxiv-daily.md
- Contradictions: none（机构归属为 opencode-compiled 推断，已标注需核实；Dice Roll Method 2609.04047 以交叉引用形式记入 Cross-Cutting 观察而非完整收录）

## [2026-09-07] synthesis | conference-digest (2026-09-07)
- Summary: wiki/synthesis/2026-09-07/conference-digest.md — 2025-2026 各大顶会 + 最新 arXiv 综合摘要（ICML 2026 / AAAI 2026 / NeurIPS 2025 / ICLR 2026 / CVPR 2026 / KDD 2026 / ACL 2026 / EMNLP 2025 / SIGIR 2026 / WWW 2026 / CIKM 2025 / RecSys 2025 + 当日 arXiv；focus recommendation/CTR/advertising/agents/generative/sequential/benchmarks；重点机构 Google DeepMind/OpenAI/Meta/Microsoft/ByteDance/Alibaba/Tencent/Kuaishou/Baidu/Netflix/NVIDIA/Anthropic/Apple/Amazon）。ID 级与当日 arxiv-daily / arxiv-ai-search 去重，个别交叉关注以引用形式标注。
- 推荐/LLM-Rec (7): 京东 GenRec（SIGIR26 生产，Page-wise NTP + Token Merger + GRPO-SR，线上点击 +9.5%/成交 +8.7%）；淘宝 GFlowGR（SIGIR26，GFlowNet token 级监督，线上 0.4pp）；ItemRAG（SIGIR26，item 级 RAG，零样本 +42% HR@1）；ProMax（SIGIR26，双分布重塑 LLM profile，LightGCN NDCG@10 +8.44%）；L2Rec（网易云，参数级 DPMoE 双视图，CTR +9.24%）；MVIGER（SIGIR26）；RecSys25 精选（GRACE/GenSAR/Lasso/MoRE/LEAF 等）。
- CTR/广告/Auction (5): 美团 UniROM（CIKM25 统一广告排序）；腾讯 LEADRE（VLDB25，Intent-Aware Prompt + DPO + 混合部署，GMV +1.57/1.17%）；快手 MARS（KDD25，Stein kernel 多模态对齐序列增强 CTR）；CRAFT（KDDCUP'26，feature-transport，TAAC AUC 0.838090）；ICML26 autobidding（LLM creatives / model monotonicity / 风险 AIC）。
- Agents (10): 阿里 ARISE-RL（Generator-Solver rubric 共演化 + RG-SED，Qwen3.5-9B 平均 SOTA 超闭源）；VICT（EMNLP26 verifier 侧 credit tracing）；TASPO（outcome-grounded action credit，vs GRPO +10.6%）；TIGPO（交叉引用）；MASkills（EMNLP26）；SRMA（博弈论 bilevel）；SMC（latency -18.6%）；Environment Evolution（Terminal-Bench 2.1 +18.0pp）；AgentPRM/AEPO（WWW26）；ICLR26 Oral agents。
- 生成式/Diffusion/视频 (5) + CVPR26 最佳论文 D4RT / 最佳学生 O-Voxel / NitroGen / SAM 3D；ARCache/SURF/GenieDrive/Qwen-Image-Layered；单步生成公平评测 MMHM（Harvard）；DLM PILL/CRS；Liquid Gated Attention（连续时间 LGA）。
- 基准/系统 (5): UniRank（腾讯/USTC/安大，15 模型×5 数据集统一排序开源基准——stacked vs layer-wise 均非绝对主导、依赖平台 inductive bias）；KDD26 里程碑（VideoRAG/MAC/REALM-Bench/CoRank）；EMNLP25（Infini-gram mini Best Paper / IMO-Bench / SoT / Temporal Scaling）；NeurIPS25 D&B（EngiBench/PHYBench/MLE-Dojo）；ICLR26 EigenBench。
- 趋势观察: 生成式推荐进入核心流量生产（多厂上线证据）；CTR 统一序列建模+特征交互（UniRank 定标准）；agent RL 从奖励对齐转向信用分配；CVPR 范式向多模态 LLM + 视频 World Model 转移；评测可靠性（MMHM/UniRank/Clean 测量）成显性主题。
- Updated: wiki/index.md（Synthesis 表顶部新增 conference-digest 2026-09-07 条目 + 主题摘要 + tags）
- New pages: wiki/synthesis/2026-09-07/conference-digest.md
- Contradictions: none（机构归属为会议元数据/作者侧推断，已有 opencode-compiled 标注需核实；与 07-27 conference-digest 部分内容（ICML 广告/拍卖）重叠，以承续引用衔接）

## [2026-09-07] synthesis | investment-daily (2026-09-07) 周一交易日
- Summary: wiki/synthesis/2026-09-07/investment-daily.md — 投资日报（周一交易日：美股 9/7 Labor Day 休市，A 股/港股 9/7 正常交易；以 9/4 美股收盘基准 + 9/7 国内事件为主）。今日核心：**华为/小米 9/7 双发布会**——华为 14:30 Mate XT 2 三折叠 + Pura X View + HarmonyOS 7（首个『全面拥抱 Agent』操作系统、小艺智能体中枢、开放 20+ 系统级 AI 能力、首次 GUI 操控）+ 麒麟 9050「逻辑折叠」全球首款量产手机芯片（不靠 EUV、晶体管密度 +53.5% 达 2.38 亿/mm²、P 核能效 +41%、频率 +12.7%、TGV 玻璃基板）；小米 19:00 18 Fold 三折叠 + 平板 9 Pro Max + 玄戒 O3 自研 SoC + **澎程 N70/N90 增程 SUV 上市（小米首条增程线、昆仑架构）** ——卡位苹果 9/9「Surprise and Shine」前，9 月折叠屏/换机三连发（华为→苹果→三星），国产硬科技（逻辑折叠/玻璃基板/半导体设备材料）估值逻辑重塑。宏观：非农 +162k → 9 月加息概率 ~57-60%、10Y 4.78%、**9/11 CPI 决定一切**；美伊冲突（美袭 3 艘伊朗油轮）→ 布伦特 ~$96.28 推通胀→压制成长股/利好算电协同；BTC ~$79,900。A 股：DeepSeek 乌兰察布 1GW 昇腾 950DT 16 万颗订单（~$2.56B，国产算力最大催化、仍为彭博传闻未官方公告）+ 麒麟 2026 逻辑折叠重塑国产半导体/玻璃基板；储能产能摸底未开工暂缓（利好宁德时代）+ 铜箔 40 万吨协议；GPT-6 后「硬件跌应用涨」再平衡（浪潮信息跌停）；光模块双雄（中际旭创/新易盛）1.6T+CPO 逻辑。机构：国信「科技硬件第二波或 Q4」、中泰「科创50 转强大概率 9 月中下旬」、方正「9 月可积极」、中信「硬件软件再平衡」。港股：空头大撤退（阿里卖空 -91%/腾讯 -52%）、腾讯南向 4 日净买 21.61 亿；腾讯 Q2 FCF -¥138 亿（2005 年来首负）/阿里 FCF 净流出 ¥446.7 亿（AI capex 重资产化）；**小米今晚澎程增程 + 折叠屏**为主要多头催化；希音-W 9/4 续跌 -9.19%（9/15 恒指纳入生效前被动抛售）；AI「价格战」压科网股利润。中概 ADR：BABA AI 云 +45%、capex +75%、净利 -75%、配售 800 亿；京东 JoyInside 免费接入投 10 亿 AI；美股休市无当日交易。8 月交付：比亚迪 43.3 万（海外 18.8 万新高）/零跑 10.31 万（+80.7%）/极氪 3.70 万（+109.8% 历史新高）/蔚来 3.58/小米 3 万+；特斯拉 Robotaxi 叙事承压（$358-362 决定去留）。AI 主题：Grok 4.7（9/12，2.1T+SpaceX 数据）倒计时、Oracle 9/10 Q1 FY27 财报（RPO $638B+363% 验证/OCI +93%/Stargate $300B）、NVIDIA $12.93B 收 Hugging Face、OpenAI/Anthropic 万亿 IPO、AI 电力缺口（瑞银 2028 中国 AI 用电 +75%、CME 算力期货、算电协同）。风险：9/11 CPI、油价向 $100、华为/小米发布会落地 sell-the-news、AI 价格战、阿里/腾讯 FCF ROI 无法兑现、希音纳入被动抛售、TSLA $358 破位。
...
## [2026-09-08] synthesis | game-rl-daily (2026-09-08)
- Summary: wiki/synthesis/2026-09-08/game-rl-daily.md — Game RL & Game AI Bot 日报（2026-09-08）。**arXiv 自 Mon 7 Sep 2026 起无新 mailing**，本报告为 Sep 1-8 窗口的 second-pass 补漏扫描（arXiv API 仍 429 限流 → 直接抓取 list/*/recent 与 /abs/ 页面）；与 09-07/09-08 兄弟 digest（arxiv-daily/arxiv-ai-search/arxiv-paper-check/conference-digest）0 featured 重叠。收录 6 篇（全部 ID+grep 0 hits 验证）：① `2602.00190` From Gameplay Traces to Game Mechanics — LLM 从 gameplay traces 经 SCM 路径做 VGDL 规则因果归纳（GVGAI 9 游戏，SCM 中介路线盲评达 81%，投 ICPR 2026，Jiwatode/Dockhorn/Rosenhahn）；② `2606.16576` Agentic Automata Learning — 工具调用 LLM agent 用 membership/equivalence queries 推断隐藏 DFA 世界模型（DFA 规模变大性能骤降，reasoning 模型显著更强，Menaged 等）；③ `2609.04894` From LM to World-Acting Systems — "consequential agents" 综述（cutoff 2026-08-31，提出 justified delegation 启发式，Zhu/Cai）；④ `2609.04911` TourPhysics — 单图物理世界模型，simulator state / geometric evidence / generator controls / appearance memory 分离式地区分 observation vs intervention（PhysOmni 扩展）；⑤ `2609.03753` SimSkill — SUMO 交通仿真终身学习 agent，gap 识别→任务生成→action–critic 验证→memory 沉淀，holds-out 基准 verified completion 最高 +25pp（backbone/budget 依赖，Liu/Wang/Bie）；⑥ `2609.03169` Signal-Driven Pervasive Game Design / LifeSync-Games — 生理/认知状态作为 Player Experience Integration Layer 的横向信号融合框架（SDT+Flow，n=70-80 准实验，Macías-Cáceres 等）。第 1/4/5 节警务如实记录"无新增核心 game-RL 算法 / PCG 直接新增 / 独立新基准"（均由连续性清单承接已验证的 09-03/09-05 论文）。Key Themes：从"玩游戏"转向"理解游戏"（因果归纳+自动机学习）、物理一致的世界模型用于交互（observation-vs-intervention 分离）、agentic 能力边界须诚实论证（justified delegation + backbone 依赖）、产业侧向玩家信号融合（LSG）。
- Updated: wiki/index.md（Synthesis 表新增 game-rl-daily 2026-09-08 条目 + tags）
- New pages: wiki/synthesis/2026-09-08/game-rl-daily.md
- Contradictions: none

## [2026-09-09] synthesis | arxiv-daily (2026-09-09)
- Summary: wiki/synthesis/2026-09-09/arxiv-daily.md — arXiv 日报（2026-09-09），覆盖 Sep 1-7，2026 cs.AI/cs.CL/cs.IR/cs.LG/cs.GT 最近提交。arXiv API 429 限流 → 直接抓取 list/*/recent 页面。收录 32 篇，含 10 LLM/Foundation（Don't Drop Dropout / ACE MoE expert skipping / GUT reasoning uncertainty / RISE / Unifying ICL-SFT-RL）、9 推荐系统（AtomRec agentic memory / Slow-Fast Thinkers / SelfDR / HypRQ-VAE / EPIC diffusion）、2 CTR/广告（UniCon context-centric / Inventory-Grounded AI Search）、4 序列建模+RL（Seq RL solar PV / Dynamic HG survey）、3 Game Theory/Multi-Agent（Optimal Rates for Agentic Networked Info Aggregation / LLM Agent interchangeability / CABAL collusion）、4 RAG/Retrieval（CAGE / Tree-RAG / Embedding Surgery / SAM-D2Q）。Venue 分布：EMNLP×3、CIKM×4、ICML/ICDM/IJCAI/RecSys×1、SODA 2027 submitted×1，其余 preprint。
- Updated: wiki/index.md
- New pages: wiki/synthesis/2026-09-09/arxiv-daily.md
- Contradictions: none

## [2026-09-09] synthesis | arxiv-ai-search (2026-09-09)
- Summary: wiki/synthesis/2026-09-09/arxiv-ai-search.md — arXiv AI Research Paper Search Report（2026-09-09）。**Fresh pass over Tue 8 Sep 2026 mailing**（论文提交 Mon 7–Tue 8 Sep，ID 域 `2609.058xx–2609.0618x`），正是 09-08 [[arxiv-ai-search]] 预见并 defer 的"真正新鲜 cs.IR 材料"。arXiv API 仍 429 限流 → 直接抓取 list/{cs.IR,cs.CL,cs.LG,cs.AI,cs.GT}/recent 与 /abs/ 页面。收录 17 篇（全部 17/17 ID grep 验证 0 hits in wiki/，与 09-09 arxiv-daily 及 09-07/09-08 兄弟 digest 0 featured 重叠）：① LLMs — Training/Inference/Efficiency (4)：Koala-Bit kernel-aware 低比特 embedding 压缩（非对称输入/输出 codebook + kernel-aware 打包，3-bit 平均 PPL 保持 0.3% 内 / embedding 内存 -70%，2609.06102）；MinMax-KV 同余稀疏注意力可再生 KV 子空间，1M token needle-in-haystack / KV -12× / 内存顶与 ctx 无关（2609.06117）；Stage-Gated Warmup 数据质量门控 re-warmup 时间，5 continual-pretraining 套件 +4.5% 均值（2609.06054）；MoE Scatter-Attention Predictor 在线外预测 top-k 专家路由跳过 router 前向，DeepSeek-V4-Flash/Mixtral-8x22B 路由计算 -68% / 端任务退化 <1.2%（2609.06088）。② Recommendation & Sequential (3)：Intraview view-transformed 伪序列增强长尾序列 + 对比 intent 蒸馏，长尾 NDCG@20 +8.2-13.1% 相对且头项略升（CIKM'26，2609.06140）；ICU discharge 不规则采样的连续时间 transformer 状态模型，读取入院风险 / LOS 权衡校准（2609.06155）；Choice-augmented CF 集合同选择打分直接优化目标回报，Outbrain +3.1-5.7% 约束回报（2609.05902）。③ CTR & Advertising (3)：FieldFormer 学习稀疏 field-pair mask 渐进交叉，DCNv2 级 AUC / ~1/6 训练 FLOPs / 拓扑跨任务迁移（Ant Group，2609.06031）；AdCreative-Diffusion CTR-grounded reward 引导创意扩散，小规模 A/B 4.6% CTR 提升（Meta/UvA，2609.05840）；CSSA 拍卖清仓冲击作 IV 归因赞助搜索增量提升，MAE -41%（Google/EPFL，2609.06076）。④ RL/Agents/Multi-Agent (4)：LatentCover 覆盖完备的对比 successor-representation 隐信念态恢复 reward shaping 不变性（POMDP，收敛 +3-6×，2609.05948）；Skill Graph Routing 执行日志学习工具技能图 GNN 路径路由，40 工具 / 91.8% vs 71.2%，20% 工具移除仅 +2.9% 退化（2609.06128）；Equivariance-Constrained MARL actor equivariant + baseline invariant + 投影，样本效率 1.9-3.4×，防对称破缺漂移（2609.06003）；Ask-Before-Act 学习人机协作阈值稀疏提问（11% 步骤），任务成功 +17.9% / 烦恼 -31%（2609.05961）。⑤ Games & Game Theory (3)：Postponed-Information Selection — 信息释放滞后鲁棒的均衡精炼，多项式可解 + 严格缩小均衡集（2609.05897）；emergent tool-use 因果分析 — 公共知识失败是主因，干预下互信息诊断预训练 AUROC 0.88（DeepMind/Cambridge，2609.06019）；Endogenous Audience 重复公共品博弈 — 发布成本做承诺装置，低成本全可见均衡（Barcelona/Kyoto，2609.06169）。Key Trends：周二新鲜 cs.IR 收成兑现；CTR/ads 从架构战转向因果结构；推理效率攻击 serving 仪式（路由预测 / KV 可再生 / embedding 打包）；MARL/博弈鲁棒性重新建立在信息结构（延迟/公共知识/不确定性通信）上；序列建模继续溢出推荐域（ICU 时序 / view 变换）。
- Updated: wiki/index.md（Synthesis 表按文件名顺序新增 arxiv-ai-search 2026-09-09 条目，置于 09-09 arxiv-daily 之后）
- New pages: wiki/synthesis/2026-09-09/arxiv-ai-search.md
- Contradictions: none

## [2026-09-09] synthesis | arxiv-paper-check (2026-09-09)
- Summary: wiki/synthesis/2026-09-09/arxiv-paper-check.md — arXiv Paper Check — AI & CTR（2026-09-09）。**last-24h 窗口（Tue 8 Sep 2026 mailing，ID 域 `2609.058xx–2609.0618x`）的精选 "most interesting" AI+CTR 综合**：本窗口内所有 CTR/推荐论文已被 09-09 兄弟 digest 收录（arxiv-daily 覆盖 Sep 1-7 mailing 含 UniCon；arxiv-ai-search 覆盖 Tue 8 Sep 含 FieldFormer/AdCreative-Diffusion/CSSA），故本篇不做全新挖掘，转为**主题策展 + 与本 wiki CTR scaling 全景（[[ctr-scaling-landscape]]）交叉链接**，逐条为每个 feature 标注其来源 digest。① CTR & Advertising 收获（4 篇，均兄弟已收录）：UniCon 统一 context-centric CTR（美团 +0.0139 AUC / +3.09% RPM / +2.07% CTR / +2.95% revenue，2609.03290）；FieldFormer field-aware 渐进交叉 — 学习稀疏 field-pair mask + 渐进感受野扩展，DCNv2 级 AUC @ ~1/6 FLOPs / 拓扑跨任务迁移（蚂蚁 2609.06031）；AdCreative-Diffusion CTR-grounded 创意生成，A/B +4.6% CTR（Meta/UvA 2609.05840）；CSSA 拍卖冲击作 IV 因果归因，MAE -41%（Google/EPFL 2609.06076）。组综合论点：CTR/ads 从架构战转向因果/数据生成结构（对应 [[ctr-scaling-landscape]] 之 structural/causal > parametric 论点）。② Serving-效率 × CTR infra（4 篇）：Koala-Bit kernel-aware 低比特 embedding 压缩（解耦输出 codebook 校准，3-bit 平均 PPL 0.3% 内 / embedding 内存 -70%，可移植到 CTR embedding 表，2609.06102）；MoE Scatter-Attention Predictor — 预测 top-k 路由跳过 router 前向，计算 -68% / 端任务退化 <1.2%（2609.06088）；MinMax-KV 可再生 hash-seeded KV 子空间，1M token 下 KV -12× / 内存顶与 ctx 无关（平行 MUSE/LONGER/SparseCTR 长序列线，2609.06117）；Choice-augmented 集合同选择打分直接优化位置预算约束回报，Outbrain +3.1-5.7%（Criteo 2609.05902）。③ 更广 AI 亮点（4 篇）：Intraview view-transformed 长尾推荐（尾 NDCG@20 +8.2-13.1% rel，CIKM'26，2609.06140）；Skill Graph Routing 工具技能图 91.8% vs 71.2% 成功率 / 20% 工具 churn 仅 +2.9%（2609.06128）；ICU discharge 连续时间序贯模型 -9.4% 再入院（2609.06155）；Stage-Gated Warmup 持续预训练 +4.5% over cosine（2609.06054）。Cross-cutting Themes：CTR/ads 前沿转向因果+数据生成结构；serving ceremony 成效率新战场（预测路由/可再生 KV/解码器感知 embedding 打包）；data efficiency 主导 post-training；序列建模持续溢出到决策/临床域。Method：dedup 边界 = 09-09 [[arxiv-daily]] + [[arxiv-ai-search]]；arXiv list 最新可访问日期 "7 Sep 2026"，Tue-8-Sep IDs 由兄弟 digest 抓取并 grep 验证；本报告无任何超出兄弟 harvest 的新 ID。
- Updated: wiki/index.md（Synthesis 表按文件名顺序新增 arxiv-paper-check 2026-09-09 条目，置于 09-09 arxiv-daily 之后）
- New pages: wiki/synthesis/2026-09-09/arxiv-paper-check.md
- Contradictions: none

## [2026-09-09] synthesis | conference-digest (2026-09-09)
- Summary: wiki/synthesis/2026-09-09/conference-digest.md — 2025/2026 顶级 ML/AI 会议全景（9 月更新）。07-27 [[conference-digest]] 的九月跟进版，venue-anchored，**刻意排除 09-09 兄弟 digest（arxiv-daily/arxiv-ai-search/arxiv-paper-check）已收录的 2609.xx 论文**。① ICML 2026（Seoul，6,634 篇）：native low-rank 预训练稳定方案 Spectron（MILA，2602.12429，谱范数因子归一化，低秩直接预训练匹配全秩质量）；Meta synthetic-data 版权法首次为 LLM4Rec 解锁 scaling law（2602.07298，层次化合成数据课程而非原始日志）；USTC reward-hacking-in-ranking 分析（pairwise DPO 更新不改变排序的 epsilon-insensitive 区域）；T-POP 测试时在线偏好反馈个性化（冻参学习每用户 reward）；LLM creatives 的 autobidding 拍卖（Stackelberg 平台-预算广告主）+ Uber model-monotonicity 形式化证明（更好的 pCTR 不一定 revenue/welfare 单调提升）。② AAAI 2026：TWiCE-Rec rationale-aware LLM 推荐器以协作信号 rank 为奖励做 RL（ojs.aaai 38590）。③ NeurIPS 2025 Best Papers（7 篇含 D&B）：Artificial Hivemind（语料同化的开环同质化数学/实证）；Gated Attention（sigmoid 门控消除 attention sink，Zihan Qiu et al.，已进 Qwen3-Next）；1000-Layer Self-Supervised RL（深度即新 scaling 轴，解锁长时距 goal-reaching）；Why Diffusion Models Don't Memorize（score-matching 噪声底限控制记忆，测度隐私）。④ ICLR 2026（Rio，5,355 篇/27.4%；审查危机审计：~45% 身份泄露、~21% AI 生成 review）：Common Corpus 2.5T 公开语料；Q-RAG；MedAgentGym；DIVA-GRPO；R-Horizon；Kimi-Dev；CLAUSE；FingerTip 20K。⑤ CVPR 2026（4,090）：storyboard 生成、Scone subject-driven 生成、SconeEval、FoleyDirector V2A。⑥ KDD 2026（济州岛）：FAT Field-Aware Transformer（2511.12081）— 结构化压缩 + field 级注意力挑战"HSTU 式 token 越长越好"的 CTR 教条。⑦ ACL 2026（San Diego，2,296 + 2,163 Findings）：Best Paper = resource-rational/default-knowledge encoding（MIT Futrell lab，rate-distortion 解释语言学规律化）；agents/reasoning 主导（OctoTools、Discover-and-Prove、Memory-R1 GRPO）。⑧ EMNLP 2025：Best Resource Autoformalization in the Wild；Outstanding 含 LingGym / Mind the Value-Action Gap / DiscoSG / Generative-or-Discriminative / CoT-faithfulness-by-unlearning / MiCRo；SURGE code-execution surrogate benchmark（免沙箱执行保真度代理）。⑨ SIGIR 2026（Melbourne，113 full + 45 short）：NeurPIU、MLLM Adaptive-PO seq-rec（Yu Wang）、DCGL、NeuCon-ICE、BEAR、tail-item fusion、LLM-EDT 跨域（Ziwei Liu）、TM-Bench 长尾基准。⑩ WWW 2026（Dubai）：ThinkRec System-2 LLM4Rec（thinking activation + instance-wise expert fusion，code 开源）；MATRAG 四智能体可解释 RAG 推荐（+12.8% HR / +15.3% NDCG / 87.4% 专家可信）；When Ads Become Profiles — LLM 对抗画像 435K FB 广告曝光重建党派/就业/教育属性，223× 便宜 / 52× 快于人类（隐私即个性化之逆）；IAM item-aware attention（Cellphones Prec@10 +71%）；GenAIR generative archetype 表示（LLM 生成原型 + 行为校准，模型无关）；LBM 分层自动出价 Think+Act / GQPO 离线 RL 免 rollout 抑制幻觉（Kuaishou+NTU，2603.05134）。⑪ CIKM 2025（Seoul）：美团 HSTU+DLRM 特征生成式推荐（保住传统特征解决 Gen-Rec 精度回退）；C-Former lifelong 序列聚类（query 作 centroid，语义距离端到端）；MicroLens 数据集；LangPTune（Joachims 组 user-profile-as-parameter）；DeepRec LLM↔TRM 多轮交互；Scenario-Wise Rec 基准；SELF；微信多模态 CTR。⑫ RecSys 2025：非参数图卷积重排（Ouyang，10.1145/3705328.3748058）；RecSys'26 明尼阿波利斯 9/27-10/1。Cross-venue Trends：LLM4Rec 从 generation 走向 thinking+RL；"压缩序列勿扩 token"赢下 CTR 架构共识；工业 Gen-Rec 保留 DLRM 特征；GRPO 系 RL 流入 bidding/agent/rec 各垂直；隐私=个性化之逆；CoT 保真度开始被测量而非假设。
...
## [2026-09-12] synthesis | arxiv-paper-check (2026-09-12)
- Summary: wiki/synthesis/2026-09-12/arxiv-paper-check.md — arXiv daily scan (AI + CTR focus). **Second pass over Fri, 11 Sep 2026 mailing** (no Sat/Sun announcement; today's "last-24h" window = Sep 11 mailing). Scanned cs.AI (171 entries), cs.IR (15 entries), cs.LG (171 entries). Zero new direct CTR papers; 2 CTR/ads-adjacent (Generative Marketing Mix Modeling for GEO/GEM; ICML'26 γ*-concept shift quantification). 16 papers across 6 themes. All 16 featured IDs grep-verified 0 hits in wiki/ (0 overlap with 09-11 arxiv-paper-check/arxiv-daily/game-rl-daily/conference-digest).
- ① Deep-Research & Scientific Reasoning Agents (3): Mr.LHDR (multimodal real-world long-horizon deep-research benchmark, hidden Node-Relation graphs avg 12.1 intermediate conclusions, best system only 43.1% OA, images removal −12.6 DACS; 2609.11318), Sci-MMR (multimodal evidence-grounded scientific reasoning, answer accuracy outruns evidence recovery by >20%, acquisition 57.2% of failures; 2609.11243), Magenta (training-free Lean 4 verification loop, 100% on AIME 2025/2026 + HMMT, all 6 IMO 2026 with K2-Horizon-7B; 2609.11319).
- ② Agent Reliability & Web (3): The Agent Incident Registry (source-linked incident catalog, missingness-aware labels, double-reviewed; 2609.11030), AgentZip sandbox memory compression (8.7x memory reduction, prefetching cuts slowdown 3.1x→1.40x; 2609.11294), terms.txt (robots.txt-style per-path/per-purpose consent + HTTP 402 compensation, +0.20–0.65 ms/request; 2609.11152).
- ③ LLM Efficiency & Serving (3): py-kvcache (NVMe KV-cache offload for vLLM, 2.0x faster than LMCache at 80k tok, break-even setup-dependent admission decision; 2609.11744), TF-IDF Weighted Cross-Entropy (token importance rebalancing, −14% LoRA / −58% full-ft substring memorization; 2609.11029), Phase-Decoupled Power Control for disaggregated B200 serving (+20.4% tokens/J vs Max-Q's +8.6%, MoE-scoped, −32.3% electricity over 3 days; 2609.11133).
- ④ Reasoning & Post-Training (3): Open Recipe for IMO Gold (NVIDIA, natural-language iterative generate/verify/refine, IMO 2026 30/42 gold threshold, open checkpoints + Nemotron-IMO-Bench; 2609.10712), Negative Self-Distillation (push student away from self-generated negative teacher, repulsion beats imitation of on-policy traces; 2609.11699), TASCO (stability-aware test-time adaptation via lightweight task prefix, Random + Sharpness-Aware perturbations; 2609.11393).
- ⑤ Ads / Marketing / CTR-Adjacent (2): Generative Marketing Mix Modeling (causal GEO/GEM — generative engine optimization/marketing — to business impact, identification conditions, simulated product-recommendation evals EN/JP; 2609.11915), General Quantification of Covariate and Concept Shifts (ICML'26, entropic OT, γ*-concept shifts, DataShifts algorithm with concentration bounds; 2609.11918).
- ⑥ Scaling Laws & Learning Dynamics (2): Memorization→Generalization Transition in Grokking (T_grok ∝ H^-0.27·D^-2.04·η^-0.50·λ^-0.64, data dominates capacity, phase boundary at λ≈1.0; 2609.10657).
- Key themes: Evidence-grounded agent evaluation is the new bottleneck (agents answer right but don't recover evidence); formal verification closes the reasoning loop (Magenta + Nemotron IMO); repulsion vs imitation in self-improvement; serving economics as admission/placement decisions; web-access governance formalized (terms.txt); memorization becomes a first-class training objective.
...
## [2026-09-13] synthesis | arxiv-ai-search (2026-09-13)
- Summary: wiki/synthesis/2026-09-13/arxiv-ai-search.md — arXiv AI Research Paper Search (Sun 2026-09-13; no weekend mailing → freshest window = **Fri 11 Sep 2026 mailing**, Wed 9–Thu 10 Sep submission wave, IDs ~2609.062xx–2609.119xx). Scanned `arxiv.org/list/{cat}/new?show=1000` for cs.AI/cs.LG/cs.CL/cs.IR/cs.GT/cs.MA/cs.CY/cs.NE/cs.SI; New + Cross submissions only (Replacement excluded). 376 unique new+cross IDs; 298 fresh (0 wiki hits at selection). **20 papers featured in full**, all grep-verified 0 hits in `wiki/` including same-day 09-13 siblings.
- Method: export.arxiv.org API rate-limited (HTTP 429 timeouts) → direct arxiv list pages + /abs/ extraction; dedup via `rg '<id>' wiki/` plus explicit exclusion vs 09-13 arxiv-daily / arxiv-paper-check / game-rl-daily covered-ID lists; scratch files in pre-approved temp dir.
- ① LLM Reasoning/Post-Training (3): SOLID solver-informed on-policy self-distillation for OR LMs — evaluator-free, majority-clustered solver artifacts as pseudo-reference, beats outcome-only group-relative training (2609.09957); GenV generative RMs for autoformalization — VPU failure mode formalized, verdict-heuristics proven chance-limited, Z3-oracle distilled into reference-free generative score, 0.961 AUROC + 11.3 acc pts, zero-shot across translators (2609.11085); NCP-ArchPreview — InternLM latent-space LM, Next Concept Prediction + NTP, 8.9B/5.73T Dolma-3 = largest latent-space LM, matches OLMo-3-7B final loss at 51.3% tokens, +2.45 macro-avg (+5.99 GSM8K), 17M-param VQ module = domain-adaptation interface (2609.10715)
- ② Alignment/Safety/Bias (2): Off-Target Response-Style Alignment in Korean 27B (Qwen3.8-27B) — style-only training shifts answer propensity (abstention/disclosure), seed ranges non-overlapping (means 0.82 pp vs −1.53 pp), constructive negative results (between-arm contrast ≠ preference change; rule-detector agreement 0.44–0.99) (2609.11291); WORLDVIEW — prompt-revision layer as causal cultural-bias source in DALL-E-3/Imagen-4/GPT-Image-1.5, 8,960 prompts / 15 languages / 31 pairings, US least-marked vs non-Western flattened+stereotyped, EMNLP'26 (2609.11532)
- ③ Interpretability (2): Distribution-aware language neuron identification — pairwise overlap over full activation distributions (incl. negative values), 4.9× on-target damage/neuron, EMNLP'26 (2609.10993); MUtE dual concept-erasure↔counterfactual framework — erasure functions induce deterministic dual mapping, translational-bias constraint, fairness + counterfactual texts (2609.11253)
- ④ Inference-Time Decoding (1): Routing by Reasoning Need — trajectory-aware per-example decoding control for diffusion VLMs (LLaDA-V), training-free, uses answer closure/commitment/revision-pressure signals, gains not length-driven, Findings of EMNLP'26 (2609.11315)
- ⑤ Scientific IR (1): ReGround reviewer-comment grounding (10,267 comments → 16,274 evidence in 3,656 papers, rebuttal-references as annotation source), whole-paper retrieval poor, evidence-type inference = bottleneck, EMNLP'26 (2609.11460)
- ⑥ Agents/MAS (6): Defining AI Agents compendium — 5 agenticness dims + Agent Compendium resource (2609.11018); AI agents run Pokhara town economy — 100 agents / 26 weeks / 2.44M decisions / 21.5B tokens, money stops circulating (MPC ≈ 0, ρ 0.964→0.752 by horizon), backing-LLM matters (p=0.0039), memory doesn't (2609.11108); Agent resilience + considerate participation under accumulating challenge (120 healthcare trajectories, 5 deployment dilemmas) (2609.10724); Reproducibility as codebase-timescale context engineering (Barba, GWU) (2609.11728); MAPLE memory-augmented continuing optimization agent + NLDO benchmark (15 trajectories / 180 updates, scalar quality 0.951) (2609.11636); BenchShield formal lifecycle-model reward-integrity instrumentation — static taint + runtime attribution, 456 adjudicated trajectories, recall 23-94→77-100%, 96% runtime hack-detection (2609.11028)
- ⑦ Cooperative AI/RL (2): Convention Gap — implicit-communication metric in Hanabi (predicted-vs-actual failure), +26.2pp human / −0.7pp AI / +16.4pp human-AI pairs, OBL check +1.6→+21.7pp, convention compatibility (not AI-AI score) predicts human effectiveness (2609.11489); G2QDR graph-guided quasimetric dense rewards — predicted pairwise connectivity → auxiliary dense rewards, plugs into any GCHRL (2609.10781)
- ⑧ Video (1): Vidu S2 real-time interactive/editable video — S2-Avatar 720p + dynamic references + S2-Editing real-time style/clothing/character/background replacement (2609.11638)
- ⑨ Benchmarks (1): MindTopo topological reasoning — 11,030 instances / 13 task types / 5 topological properties, 14 MLLMs, all better at reasoning than planning, generated rollouts don't preserve topology (2609.11900)
- Ads/CTR note: 0 direct CTR/ads papers this mailing (rec/ads finds covered by 09-12/09-13 siblings); all 20 featured IDs grep-verified absent from whole wiki
- Updated: wiki/index.md (Synthesis table added arxiv-ai-search 2026-09-13 entry)
- New pages: wiki/synthesis/2026-09-13/arxiv-ai-search.md
- Contradictions: none (selection orthogonal to same-day siblings; FOMC/cultural-bias framing consistent with existing pages)

## [2026-09-13] synthesis | conference-digest (fresh papers edition)
- Summary: wiki/synthesis/2026-09-13/conference-digest.md — 全会议/主题增量版 (ICML2026/ICLR2026/AAAI2026/NeurIPS2025/CVPR2026/KDD2026/ACL2026/EMNLP2025/WWW2026/SIGIR2026/CIKM2025/RecSys2025-2026 + 通用 arXiv 与 CTR/广告/推荐主线)。ID 与 09-10/09-11 conference-digest 全量版去重；所有 arXiv ID 经 09-13 实时 web 搜索/校验，个别标 unverified（KARL/OneRanker/STEPS venue）。
- 本期头条: ①生成式推荐进入单模型接管全链路时代 (Tencent GPR/OneRanker, Kuaishou OneMall/TAGR/HGenPush, Meituan EGA-V1 (CTR +5.2pct/RPM +13.6pct), Tencent CCFormer (CTR +3.57pct), ByteDance STEPS); ②Scaling 争论转向结构化牺牲 (Alibaba FAT field-wise 表达 vs 堆参 scaling, Kuaishou MARM cache-scaling law, ByteDance STCA 10K 线性复杂度, LoopCTR loop scaling, TokenMixer-Large 15B/7B); ③RL 后训练机理研究爆发 (Demystifying RLPT/UW, Mu-GRPO ~2x 加速, SIGNBALANCE 虚假优势, Progress Advantage 隐式 PRM, PostTrainBench, T³, GEPA); ④长程 Agent 评测基准 (AgencyBench ~1M token/轨迹, τ^τ-Bench 最强 23.9pct, InferenceBench 最优 8.08x, Long-Horizon-Terminal-Bench, ProBench 40.1pct, CausalGame 68.0pct); ⑤世界模型/视频生成主战场 (ByteDance VideoWorld 2 成功率 +70pct, Tencent VerseCrafter, Amazon DeltaWorld 1,024x token 压缩, Google DeepMind DiffusionGemma ~1,500 tok/s + Code World Models 9/10 对局)。
- Featured: 90+ 完整条目 (ICML 4 / ICLR 6 / NeurIPS 4 / EMNLP 4 / ACL 4 / CVPR 4 / AAAI 2 / KDD 5 / SIGIR 3 / WWW 2 / CIKM 3 / RecSys 2 / 通用 arXiv ~20 / CTR-广告 ~14) + 附录 runner-ups (Qwen-AgentWorld/TongUI/AgentSwift/AutoTool/ECLoop/SWE-Next/SSD/Sumi/OneLive/TRM/MDL/Congrats/KuaiLive-M3)。
- Updated: wiki/index.md (Synthesis 表顶部新增 conference-digest 2026-09-13 条目 + 主题摘要 + tags)
- New pages: wiki/synthesis/2026-09-13/conference-digest.md
- Contradictions: 无跨页冲突 (PostTrainBench 数字 v1 23.2pct vs ICML listing 27.9pct 已内联标注; KARL arXiv ID 未独立验证以 ACL Anthology 为准; Beyond ReAct 指标标 tentative; 线上指标均为论文自报未第三方复核)
## [2026-09-14] synthesis | arxiv-paper-check
- Summary: wiki/synthesis/2026-09-14/arxiv-paper-check.md — arXiv Paper Check (Mon 2026-09-14 mailing, Wed 10–Thu 11 Sep submission wave ~2609.11933–2609.13144). Scanned cs.AI (163 fresh≥2609.11900) / cs.IR (19) / cs.LG (177). **9 papers featured in full + 4 runner-ups, all grep-verified 0 hits in wiki/ incl. same-day 09-14 arxiv-daily dedup** (every ID rg-checked; 2609.12270/12375/12399/12556/12842 excluded → claimed by arxiv-daily).
- Method: arXiv API rate-limited (HTTP 429) → direct `arxiv.org/list/{cat}/new?show=500` pages; abstract extraction from list HTML; dedup via `rg '<id>' wiki/` + explicit exclusion of all 09-14 arxiv-daily and 09-11→09-13 sibling featured IDs; scratch in pre-approved temp dir.
- ① Ads/CTR (1): PinDCO Pinterest production DCO — CCFN per-component towers fused into creative-level score conditioned on ad-level prediction + exploration-exploitation data quality + Pixel-aware Adjustment Module (PAM) for waterfall-grid rendered-size effects (2609.11943)
- ② Agentic-Web Rec (2): PAMR position — next rec bottleneck = control over evidence acquisition/disclosure; user-side agent mediation, mediation-centered eval (2609.11942); Who Are We Recommending To? — delegation spectrum; agent is primary consumer in delegable contexts, human final judge in experiential (Spotify, 2609.11945)
- ③ IR/Memory (2): MemRetriever — agentic multi-step memory search (parallel/serial/reflect-denoise) + GRPO, stops when evidence sufficient (2609.11951); InitGen OPPO Xiaobu — joint candidate generation, weighted preference optimization (activity + downstream ranking weights) under truncated exposure (2609.11953)
- ④ Agentic SWE/Verification (2): Reality Is the Final Verifier — requirement-gap × model-gap framework, assurance-revision loop (Berkeley/Anyscale, 2609.12039); Harness or Model? — contamination-controlled 256-task suite, no average harness advantage, task-type strata repo −9.0pp / contest +23.7pp (post-hoc, p=0.003) (2609.11987)
- ⑤ Judges (1): Can We Trust LLM Judges — capability-dependent leniency (r≥0.83), label-free calibrated WMV from inter-judge agreement (2609.12002)
- ⑥ Distillation (1): RIVET — expert-augmented RL + verified trajectory internalization, +6.49pp after expert removal on RIVET-4B, local Python, no external LLM at deploy (2609.12578)
- Runner-ups: health-rec policies (2609.12679); hindsight-leakage audit in data discovery (2609.12766); When Does AI Augment Work (2609.12482)
- Updated: wiki/index.md (Synthesis table added arxiv-paper-check 2026-09-14 entry above same-day arxiv-daily)
- New pages: wiki/synthesis/2026-09-14/arxiv-paper-check.md
- Contradictions: none (selection orthogonal to 09-14 arxiv-daily by construction; all numbers author-reported)

## [2026-09-14] synthesis | conference-digest (2026-09-14, New Papers Edition)
- Summary: wiki/synthesis/2026-09-14/conference-digest.md — Conference & arXiv Digest across ICML/ICLR/NeurIPS/AAAI/KDD/CVPR/ACL/EMNLP/SIGIR/WWW/CIKM/RecSys + general arXiv. Web-search-driven incremental edition (parallel research), every featured ID grep-verified **0 hits** in wiki/.
- 17 new papers featured in full (title EN/ZH, authors, affiliation, venue, background/method/innovations/numbers, comparison, arXiv link):
  - CVPR 2026: GenieDrive 4D-occupancy physics-aware driving WM (+7.2% mIoU, −20.7% FVD, 2512.12751); RAYNOVA ray-space pure-AR multi-view WM (geometry-agnostic, nuScenes SOTA, 2602.20685)
  - KDD 2026: C²KV non-prefix KV reuse + compression co-training (up to 17× long-context inference, 2607.17715)
  - ACL 2026: UR² RL-unified RAG+reasoning (difficulty-aware curriculum + hybrid knowledge access, 2508.06165)
  - EMNLP 2025: SimulatorArena user-simulator eval proxies (909 human-annotated convos, ρ≈0.7, 2510.05444)
  - ICLR 2026: RACE Attention strictly linear-time (12M tokens/fwd-bwd on GH200, 2510.04008)
  - arXiv LLM post-training: Curriculum RL answers RLVR-capacity negative result (boundary-aware, pass@256 +9.8~+10.3pp, 2606.22317)
  - arXiv seq/long-ctx: Kalman Delta Networks uncertainty-aware associative memory (2609.07816); HSA-UltraLong 16M-token extrapolation (2511.23319)
  - arXiv diffusion LM: PlaidQ 4/1-step distilled continuous dLLM for code (2609.04531)
  - arXiv code/benchmarks: SWE-Bench Pro Verified anti-reward-hacking correction (2609.08149); TAM long-horizon procedural reasoning (ICD-10-CM EM 1%, 2609.13005)
  - arXiv judge validity: mJudge multilingual LLM-as-judge (2605.28710); Language Bias in LLM Evaluators (>90% pairwise acc but 43% acceptance gap, 2607.14480); FAPO auto prompt optimization of multi-step pipelines (+14.1pp vs GEPA, OpenAI-adjacent, unverified, 2606.19605)
  - arXiv video/WM: PV-VAE predictive-latent video VAE (+52% convergence, FVD −34.42, ByteDance, 2605.02134); PhiZero physical-language world model (IQ-Score 41.2 > Cosmos3 39.5, CASIA, 2607.28624)
- Cross-reference panorama (Section 2): re-verified already-covered papers by venue (Gated Attention, Mamba-3, FAT, CADET, EST, GR4AD, GenRec-JD, TGR, ReST, SequenceO1, TokenMixer-Large, DeltaTok/DeltaWorld, VideoWorld 2, Vision Banana, GenCeption, LBM, NMRL, DANet, GRACE, LLM-HYPER, DeepSeek-V4, Nemotron 3, SMET, PrEx, etc.) — not re-expanded per dedup convention
- Venue availability: AAAI 2026 no verifiable new target-lab paper this pass; RecSys 2025/SIGIR/WWW/CIKM no new additions (all already covered); no confirmed new OpenAI/Meta papers this pass (gaps stated honestly, no fabrication)
